<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Kemaskini_EOT.aspx.vb" Inherits="SMKB_Web_Portal.Kemaskini_EOT" %>
               ...
               <div class="container-fluid mt-3"> 
                    <ul class="nav nav-tabs" id="subTab" role="tablist">          
                     <li class="nav-item" role="presentation" onclick="subTabChange(event)" data-tab="ARH">
                      <a class="nav-link active" tabindex="-1" data-tab="ARH" aria-disabled="true">Maklumat Arahan Kerja</a>
                     </li>
                     <li class="nav-item" role="presentation" onclick="subTabChange(event)" data-tab="SEN">
                        <a class="nav-link" tabindex="-1" data-tab="SEN" aria-disabled="true">Permohonan Kerja Lebih Masa</a>
                     </li>        
                   </ul>
               </div>    
               <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
<script type="text/javascript">
        ...
        tbl2 = $("#tblData").DataTable({
            ...
            "ajax": {
             ...
             "rowCallback": function (row, data) {
                 ...
                 $(row).on("click", function () {
                     console.log(data);
                     rowClickHandler1(data.Tkh_Tuntut, nomohonStaf);
                 });
    ...
    async function rowClickHandler1(id1, id2) {
