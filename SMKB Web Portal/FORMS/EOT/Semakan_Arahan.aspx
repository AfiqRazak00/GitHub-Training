                                    ...
                                    <div class="form-group col-md-3">
                                        <label for="UploadSurat">Upload surat</label>
                                         <div class="form-inline">
                                          ...
                                          <%--  <input type="button" id="uploadButton" class="upload-button" value="Muatnaik" onclick="uploadFile()" />--%>
            ...
            if (file) {
                ...
                if (fileSize <= maxSize) {
                    ...
                    if (fileExtension === 'pdf' || fileExtension === 'xlsx' || fileExtension === 'xls') {
                        ...
                        // Invalid file type
                        alert("Hanya fail PDF dan Excel dibenarkan untuk muatnaik.");
                    }
                } else {
                    // File size exceeds the allowed limit
                    alert("Saiz fail melebihi limit 3MB.");
                }
            } else {
                // No file selected
                alert("Sila fail untuk muatnaik.");
            }
        }
