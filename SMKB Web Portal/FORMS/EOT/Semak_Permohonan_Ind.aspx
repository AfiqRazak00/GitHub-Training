<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Semak_Permohonan_Ind.aspx.vb" Inherits="SMKB_Web_Portal.Semak_Permohonan_Ind" %>
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                           ...
                           <div class="form-row"> 
                                <div class="form-group col-md-4">
                                        <label for="txtNomohonOT" class="input-group__label">No. Mohon :  </label>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        tbl = $("#tblDataSenarai_trans").DataTable({
            ...
            "ajax": {
                "url": "Transaksi_EOTs.asmx/LoadSemakanPermohonanInd",
                method: 'POST',
            ...
            "columns": [
                {
                    ...
                    render: function (data, type, row, meta) {
                        ...
                        var link = `<td style="width: 10%" >
                                                <label id="lblNoMohon" name="lblNoMohon" class="lblNoMohon" value="${data}" style="color: blue;" <a id="lnk" class="lblNoMohon" href="#">${data}</a></label>
