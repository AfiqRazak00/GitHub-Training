<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Permohonan_EOT.aspx.vb" Inherits="SMKB_Web_Portal.Permohonan_EOT" %>
            ...
            <div class="container-fluid  mt-3"> 
                  <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item active" role="presentation">
                        <a class="nav-link active" data-toggle="tab" tabindex="-1" id="tab-pemohon" href="#home">Maklumat Arahan Kerja</a></li>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link"  data-toggle="tab" tabindex="-1" id="tab-permohonan" href="#menu1">Permohonan Kerja Lebih Masa</a></li>
        ...
        <br>
         <div class="row">
            <dv class="col-md-12">                    
                    <div class="form-row">
                            ...
                            <input type="text" class="form-control" id="lblPTJ2" readonly="readonly" style="width:450px" > 
                             ...
                             <div class="form-group col-md-3">
                                 <asp:TextBox ID="txtNoArahan" runat="server" Width="50%" class="input-group__input" name="No Arahan" placeholder="&nbsp;" ReadOnly="true"></asp:TextBox>
                                 <label for="NoArahan" class="input-group__label">No Arahan</label>                                                                                                                                                            
                            </div>  
                            <div class="form-group col-md-3">
                                <input type="text" class="input-group__input" id="txtNoSurat" runat="server" name="No Surat " placeholder="&nbsp;" style="width:50%" maxlength="30" readonly/> 
                                <label for="NoSurat" class="input-group__label">No Surat</label>                                                                         
                            </div>
                                                                 
                        <div class="form-group col-md-3">
                             <input type="text" class="input-group__input" id="txtTkhMula"  name="Tarikh Mula Kerja" placeholder="&nbsp;" runat="server" style="width:50%" readonly /> 
                         ...
                         <div class="form-group col-md-3">
                            <input type="text" class="input-group__input" id="txtTkhTamat" name="Tarikh Tamat Kerja"  placeholder="&nbsp;" runat="server" style="width:50%" readonly />
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-3">
                             <asp:TextBox ID="txtLokasi" runat="server"   CssClass="input-group__input" style="width:300px"  name="Lokasi" placeholder="&nbsp;"  Rows="2" TextMode="MultiLine" MaxLength="50" ReadOnly="true" ></asp:TextBox>                    
                            <label for="Lokasi"  class="input-group__label">Lokasi</label>                                                                            
                        </div>
                                
                        <div class="form-group col-md-3">
                             <asp:TextBox ID="txtButirKerja" runat="server"   style="width:300px" CssClass="input-group__input" Rows="2" name="Penerangan Kerja" placeholder="&nbsp;" TextMode="MultiLine" ReadOnly="true"></asp:TextBox>
                            <label for="Penerangan"  class="input-group__label">Penerangan Kerja</label>                                                       
                        </div>                                
                        <div class="form-group col-md-3">
                            <input type="text"  style="width:300px" Class="input-group__input" id="ddlPengesah"  name="Pegawai Pengesah" placeholder="&nbsp;"  ReadOnly="readonly" /> 
                        ...
                        <div class="form-group col-md-3">
                            <input type="text" Class="input-group__input"  id="lblKetuaPej" name="Ketua Jabatan" placeholder="&nbsp;"  style="width:300px" readonly="readonly" />
                    ...
                    <div class="form-row"> 
                        ...
                        <div class="form-group col-md-1">
                         ...
                         <div class="form-group col-md-3">
                             <asp:TextBox ID="txtNoMohon" runat="server" Width="50%" CssClass="input-group__input" ReadOnly="true" name="No Mohon" placeholder="&nbsp;"></asp:TextBox>
   ...
   <div id="menu1" class="tab-pane fade in " role="tabpanel">     
       <asp:Panel ID="Panel2" runat="server" >
         ...
         <div class="row">
             ...
             <div class="col-md-12"> 
                  <div class="form-row">
                    <div class="form-group col-md-1">
                        <select class="input-group__select ui search dropdown TahunTuntut" name="Tahun Tuntut" id="ddlTahunTuntut"  placeholder="&nbsp;"  style="width:100px">
                               
                        </select>
                        <label for="TahunTuntut" class="input-group__label">Tahun Tuntut</label>                                                  
                    </div>
                    <div class="form-group col-md-1">
                         <select class="input-group__select ui search dropdown TahunTuntut" name="Bulan Tuntut"  placeholder="&nbsp;" id="ddlBulanTuntut"  style="width:100px">
                    ...
                    <div class="form-group col-md-2">
                        <input type="date" class="input-group__input" id="txtTkhTuntut" runat="server" style="width:150px" name="Tarikh Tuntut"  placeholder="&nbsp;"/> 
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtTkhTuntut" CssClass="text-danger" ErrorMessage="*Sila pilih Tarikh Mula" ValidationGroup="Semak" Display="Dynamic"/>
                        ...
                        <div class="form-group col-md-1">
                             <input type="text" class="input-group__input" id="txtJamMula"  runat="server"  style="text-align: right; width:100px" name="Jam Mula"  placeholder="&nbsp;" /> 
                        ...
                        <div class="form-group col-md-1">
                             <input type="text" class="input-group__input" id="txtJamTamat" runat="server" style="text-align: right; width:100px" name="Jam Tamat"  placeholder="&nbsp;" />   
                        ...
                        <div class="form-group col-md-1">
                            <input type="text" class="input-group__input" id="lblJamTuntut" name="Jam Tuntut" runat="server" style="text-align: right; width:100px" readonly  placeholder="&nbsp;" />                           
                            <label for="JamTuntut" class="input-group__label">Jam Tuntut</label>                              
                        </div>
                        <div class="form-group col-md-1">
                             <input type="text" class="input-group__input" id="lblAmnTuntut" runat="server" style="text-align: right; width:100px" name="Amaun Tuntut"  placeholder="&nbsp;"  readonly />   
    ...
    <script type="text/javascript">
       ...
       $('.btnSimpan').click(async function () {
        ...
        async function ajaxSaveEOT(EOT_MOHON) {
        ...
        async function ajaxHantarEOT(EOT_MOHON) {
        ...
        async function ajaxKiraAmtEOT(EOT_MOHON) {
        ...
        async function setValueToRow_HdrArahan(orderDetail) {
         ...
         $('#<%=txtNoSurat.ClientID%>').val(orderDetail.No_Surat)
            ...
            var fileUrl = "~/UPLOAD/DOCUMENT/EOT/AR/" + strFileName;
           ...
           // $('#<%'=uploadedFileNameLabel.ClientID%>').append(fileLink);

          <%--  var textBoxClientId = '<%= uploadedFileNameLabel.ClientID %>';
            $('#' + textBoxClientId).empty(); // Clear any existing content
            $('#' + textBoxClientId).append(fileLink);--%>
