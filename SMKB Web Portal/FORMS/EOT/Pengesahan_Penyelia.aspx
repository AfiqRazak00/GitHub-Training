    ...
    $('.btnSimpan').click(async function () {
        ...
        var newArahan = {
            MohonEOT: {
                    ...
                    Tahun: $('#<%=txtTahuntuntut.ClientID%>').val(),
                    Bulan: $('#<%=txtBulantuntut.ClientID%>').val(),
                    Tujuan: $('#<%=txtTujuan.ClientID%>').val(),
                    Catatan: $('#<%=txtCatatan.ClientID%>').val(),
                    No_Staf_Sah: $('#<%=txtNoStafSah.ClientID%>').val(),
                    OT_Ptj: $('#<%=txtOTPtj.ClientID%>').val(),
                    No_Staf_Lulus: $('#<%=txtNoStafLulus.ClientID%>').val(),
