Public Class Pengesahan_Terima
    ...
    'End Class
End Class
Public Class DataEot
    Public Property Jammulaterima As String
    Public Property Jamtamatterima As String
    Public Property Jumjamterima As String
    Public Property Amaunterima As String
    Public Property Turutan As String
    Public Property ID As String

    Public Property StatusMohon As String
    Public Property UlasanTerima As String
