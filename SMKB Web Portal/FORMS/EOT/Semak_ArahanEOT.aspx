                            ...
                            <tr  class="table-list">
                                <td>
                                   <select class="ui search dropdown COA-list" name="ddlCOA" id="ddlCOA" style="width:300px"></select>
                                    ...
                                    <label id="lblvot" name="lblvot" class="label-vot-list" style="visibility: hidden"></label>
                ...
                <div class="col-md-12">                    
                                <div class="form-row">
                                      ...
                                      <div class="form-group col-md-4">
                                           ...
                                           <input type="text" class="input-group__input input-readonly" id="txtNoSurat" runat="server" Width="100%" maxlength="30" readonly name="No Surat"  placeholder="&nbsp;"/>                                          
                                    ...
                                    <div class="form-group col-md-4">
                                         <input type="date" class="input-group__input" id="txtTkhMula"  runat="server"   Width="100%"  />
                                    ...
                                    <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="txtTkhMula" ControlToCompare="txtTkhTamat" Operator="LessThanEqual" Type="Date" CssClass="text-danger" ErrorMessage="** Tarikh Mula Tidak Boleh Besar Dari Tarikh Tamat" ValidationGroup="Semak" Display="Dynamic"></asp:CompareValidator>
                                      ...
                                      <div class="form-group col-md-4">
                                         <input type="date" class="input-group__input" id="txtTkhTamat"  runat="server" Width="100%" /> 
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                          <asp:TextBox ID="txtLokasi" runat="server"   CssClass="input-group__input" Width="100%" Rows="2" TextMode="MultiLine" MaxLength="50" name="Lokasi"  placeholder="&nbsp;"></asp:TextBox>   
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <asp:TextBox ID="txtButirKerja" runat="server"   Width="100%" class="input-group__input" Rows="2" TextMode="MultiLine" name="Penerangan Kerja"  placeholder="&nbsp;"></asp:TextBox>
                                    ...
                                    <div class="form-group col-md-4">
                                         <select class="input-group__select ui search dropdown  Pengesah" id="ddlPengesah" Width="100%" name="Pegawai Pengesah"  placeholder="&nbsp;"></select>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                      <%--  <label for="kodModul">Ketua Jabatan</label>  --%>                                  
                                            ...
                                            <select class="input-group__select ui search dropdown KetuaJabatan"id="ddlKetuaJabatan" Width="100%" name="Ketua Jabatan"  placeholder="&nbsp;"></select> 
                                    ...
                                    <div class="form-group col-md-4">
                                        <asp:TextBox ID="txtNoArahan" runat="server" Width="100%" CssClass="input-group__input input-readonly" ReadOnly="true" name="No Arahan"  placeholder="&nbsp;"></asp:TextBox>
...
<script type="text/javascript">
                ...
                "columns": [
                    ...
                    { "data": "MS01_Nama" },
                    {
                        ...
                        render: function (data, type, row, meta) {
                            ...
                            var link = `<button id="btnView3" runat="server"  data-id = "${data}" class="btn btnView3" type="button" style="color: blue" >
 ...
 //   var tableID_SenAK = "#tblDataSenAK_trans";
    ...
    async function rowClickHandler(id) {
        ...
        async function AjaxGetRecordHdrEot(id) {
            ...
            try {
                ...
                const response = await fetch('Transaksi_EOTs.asmx/LoadRecordBySemakanNoArahan', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
    ...
    async function setValueToRow_HdrArahan(orderDetail) {
        ...
        <%--$('#<%=txtTkhMula%>').val(dateStrFromSQl(orderDetail.Tkh_Mula))--%>
        ...
        var fileUrl = "~/UPLOAD/EOT/" + strFileName; // Replace with the actual file URL
    ...
    $(tblDataSenAK_trans).on('click', '.btnView3', async function () {
     ...
     //   var curTR = $(this).closest("tr");
      // var id = $(this).closest('tr').find("td > .data-id");
    ...
    async function DelRecord(id, id1) {
        ...
        await AjaxGetRecDelDtlEot(id, id1)
