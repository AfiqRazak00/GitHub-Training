<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="PENILAIAN_HARGA_UNIVERSITI.aspx.vb" Inherits="SMKB_Web_Portal.PENILAIAN_HARGA_UNIVERSITI" %>
    ...
    <script type="text/javascript">
        ...
        $('#btnSimpanInfo').off('click').on('click', async function () {
            ...
            $('#confirmSaveButton1').off('click').on('click', async function () {
                ...
                var result = JSON.parse(await ajaxSavePerolehan_Mesyuarat_Hdr_harga(newPerolehan_Mesyuarat_Hdr));
                ...
                var kodSubmanu = "020702"
                var NameSubMenu = "Penilaian Harga"
        ...
        async function ajaxSavePerolehan_Mesyuarat_Hdr_harga(Perolehan_Mesyuarat_Header) {

            return new Promise((resolve, reject) => {
                $.ajax({
                    url: '<%= ResolveClientUrl("~/FORMS/PEROLEHAN/mesyuaratWS.asmx/SavePerolehan_Mesyuarat_Hdr_harga") %>',
                    method: 'POST',
        ...
        async function ajaxSavePerolehan_Mesyuarat_Dtl(Perolehan_Mesyuarat_Detail) {
            ...
            return new Promise((resolve, reject) => {
                $.ajax({
                    url: '<%= ResolveClientUrl("~/FORMS/PEROLEHAN/mesyuaratWS.asmx/SavePerolehan_Mesyuarat_Dtl_Harga") %>',
                    method: 'POST',
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            $(document).ready(async function () {
                ...
                async function getDataTable() {
                    return new Promise((resolve, reject) => {
                        $.ajax({
                            url: '<%= ResolveClientUrl("~/FORMS/PEROLEHAN/mesyuaratWS.asmx/LoadSenarai_Sebut_Harga_PenHarga") %>',
                            type: "POST",
        ...
        $(document).ready(function () {
            ...
            $('#JawatankuasaData').dropdown({
                ...
                fullTextSearch: true,
                apiSettings: {
                    url: '<%= ResolveClientUrl("~/FORMS/PEROLEHAN/mesyuaratWS.asmx/Get_Jawatan_Kuasa_Harga?q={query}") %>',
                    method: 'POST',
                    dataType: "json",
                    contentType: 'application/json; charset=utf-8',
                    cache: false,
