<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="PERLANTIKAN_VENDOR_UNIVERSITI.aspx.vb" Inherits="SMKB_Web_Portal.PERLANTIKAN_VENDOR_UNIVERSITI" %>
    ...
    <script type="text/javascript">
        ...
        $('#btnSimpanInfo').off('click').on('click', async function () {
            ...
            $('#confirmSaveButton1').off('click').on('click', async function () {
                ...
                var kodSubmanu = "020902"
                var NameSubMenu = "Perlantikan Vendor"
        ...
        async function ajaxSavePerolehan_Mesyuarat_Hdr(Perolehan_Mesyuarat_Header) {
            ...
            return new Promise((resolve, reject) => {
                $.ajax({
                    url: '<%= ResolveClientUrl("~/FORMS/PEROLEHAN/mesyuaratWS.asmx/SavePerolehan_Mesyuarat_Hdr_Lantik") %>',
                method: 'POST',
        ...
        async function ajaxSavePerolehan_Mesyuarat_Dtl(Perolehan_Mesyuarat_Detail) {
            ...
            return new Promise((resolve, reject) => {
                $.ajax({
                    url: '<%= ResolveClientUrl("~/FORMS/PEROLEHAN/mesyuaratWS.asmx/SavePerolehan_Mesyuarat_Dtl_Lantik") %>',
                method: 'POST',
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            $(document).ready(async function () {
                ...
                async function getDataTable() {
                    return new Promise((resolve, reject) => {
                        $.ajax({
                            url: '<%= ResolveClientUrl("~/FORMS/PEROLEHAN/mesyuaratWS.asmx/LoadSenarai_Sebut_Harga_Lantik") %>',
                            type: "POST",
        ...
        $(document).ready(function () {
            ...
            $('#JawatankuasaData').dropdown({
                ...
                fullTextSearch: true,
                apiSettings: {
                    url: '<%= ResolveClientUrl("~/FORMS/PEROLEHAN/mesyuaratWS.asmx/Get_Jawatan_Kuasa_Lantik?q={query}") %>',
                method: 'POST',
                dataType: "json",
                contentType: 'application/json; charset=utf-8',
                cache: false,
