<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Pembelian_Tempatan_Print.aspx.vb" Inherits="SMKB_Web_Portal.Pembelian_Tempatan_Print" %>
    ...
    <form id="form1" runat="server">
        <div id="masterdiv" class="container">
                                ...
                                <div style="width: 100%; display: flex;">
                                    <div style="width: 100%; display: flex;">
                                        ...
                                        <div style="width: 70%; border-bottom: 2px solid; border-top: 2px solid;">
                                            <h4 class="text-center" style="font-weight: 900; padding-top: 15px; padding-bottom: 10px;">PESANAN BELIAN UTeM</h4>
                    ...
                    <tbody>
                        ...
                        <tr style="padding-top: 50px">
                            <td colspan="7" style="border-top: 0.5px solid #fff; width: 70%; border: 1px solid" colspan="2">
                                <p class="mb-2" style="margin-bottom: 20px;">Sila Bekalkan / laksanakan perkhidmatan yang dinyatakan di atas bersama pesanan belian ini, nota hantaran dan invois syarikat kepada :</p>
                                ...
                                <p class="mt-2" style="margin-top: 20px;">Pesanan Belian ini akan dibatalkan jika bekalan perkhidmatan diterima selepas tarikh akhir bekalan/ perkhidmatan di atas.</p>
                            </td>
                        ...
                        <tr>
                            <td colspan="9" style="border: none;">
                                ...
                                <h4 class="mb-5" style="font-weight: 700; text-align: center;">PEMBAYARAN TIDAK AKAN DIBUAT JIKA PERAKUAN MUTU TIDAK DIPENUHKAN ATAU JIKA PESANAN BELIAN TIDAK DIKEMBALIKAN</h4>
                        ...
                        <tr>
                            <td colspan="9" style="border: none;">
                                ...
                                <p class="mb-5">Saya memperakui bahawa *Bekalan / *Perkhidmatan yang dibutirkan di atas telah *diterima / *dilaksanakan dengan muaskan dan saya juga memperakui amaun dan butiran yang dinyayakan dalam <strong>Pesanan Belian</strong> ini adalah sama dengan amaun yang dinyatakan dalam <strong>invois pembekal</strong> </p>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="border-top: 0.5px solid #fff; width: 70%; border: 1px solid" colspan="2">
                                    <p class="mb-2" style="margin-bottom: 20px;">Sila Bekalkan / laksanakan perkhidmatan yang dinyatakan di atas bersama pesanan belia ini, nota hantaran dan invois syarikat kepada :</p>
                                    <p class="" style="font-weight: 700; line-height: 0.5" id="txtNama"></p>
                                    <p class="" style="font-weight: 700; line-height: 0.5;" id="TxtVoIP"></p>
                                    <p class="" style="font-weight: 700; line-height: 0.5;" id="txtPerjabat"></p>
            ...
            <script type="text/javascript">
                ...
                var Id_Pembelian = sessionStorage.getItem('Id_Pembelian');

                // Check if the value exists
                if (Id_Pembelian !== null) {
                    // Value exists, do something with it
                    console.log("Id_Pembelian:", Id_Pembelian);
                } else {
                ...
                $(document).ready(function () {
                    $.ajax({
                        type: "POST",
                        url: '<%= ResolveClientUrl("~/FORMS/PEROLEHAN/PermohonanPoWS.asmx/LoadPerolehan_Pembelian_print_Dtl") %>',
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        data: JSON.stringify({ IdPembelian: Id_Pembelian }), // Convert the data to a JSON string
                        success: function (data) {
                            ...
                            var AlamatSykt = jsonData[0].Almt_Semasa_1 + ' ' + jsonData[0].Almt_Semasa_2;
                            var AlamatSykt2 = jsonData[0].Poskod_Semasa + ', ' + jsonData[0].Bandar_name + ', ' + jsonData[0].Negeri_name;
                            ...
                            document.getElementById('txtNo_Pesanan').textContent = jsonData[0].Id_Pembelian;
                            ...
                            var tarikhPesanan = new Date(jsonData[0].Tarikh_Tamat);
                ...
                $(document).ready(function () {
                    ...
                    tbl = $("#tblDataSenarai_Pesanan").DataTable({
                        ...
                        "ajax":
                        {
                            "url": '<%= ResolveClientUrl("~/FORMS/PEROLEHAN/PermohonanPoWS.asmx/LoadPerolehan_Pembelian_print") %>',
                            type: 'POST',
                            data: function (d) {
                                return "{ IdPembelian: '" + Id_Pembelian + "'}"
                            },
                            "contentType": "application/json; charset=utf-8",
                            "dataType": "json",
