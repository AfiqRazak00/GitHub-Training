<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Pembatalan_PB.aspx.vb" Inherits="SMKB_Web_Portal.Pembatalan_PB" %>
            ...
            <div>
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalCenterTitle">Senarai Pesanan Belian</h5>
            ...
            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl" role="document">
                <div class="modal-content">
                        ...
                        <div class="card">
                            <div class="m-2">
                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div>
                                            <div class="form-row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <select class="input-group__select ui search dropdown JenTransaksi" name="txtVendo" id="txtVendo" placeholder="&nbsp;" style="background-color: #f0f0f0" disabled>
                                                        </select>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <input class="input-group__input " id="txtTarikh_Mula_Perolehan" type="date" placeholder="&nbsp;" name="txtTarikh_Mula_Perolehan" readonly style="background-color: #f0f0f0" />
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <input class="input-group__input " id="txtTempoh" type="number" placeholder="&nbsp;" name="txtTempoh" readonly style="background-color: #f0f0f0" />
                                    ...
                                    <div class="col-md-3">
                                        <div>
                                            <div class="form-row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <select class="input-group__select ui search dropdown JenTransaksi" name="txtJenis_tempoh" id="txtJenis_tempoh" placeholder="&nbsp;" style="background-color: #f0f0f0" disabled>
                                                        </select>
                                            ...
                                            <table id="tblDataPerolehanDtl" class="table table-striped" style="width: 99%">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th scope="col">Inclusive GST? Kadar: 0%</th>
                                                        <th scope="col">Harga GST (RM)</th>
                                                        <th scope="col">Jum. Harga (Tampa GST) (RM)</th>
                                                        <th scope="col">Jum. Harga (Termasuk GST) (RM)</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                </tbody>
                            ...
                            <div class="card m-2 pb-3 pt-3">

                                <div class="col-md-12">
                                    <h5 class="m-2">Lampiran</h5>
                                    <div class="transaction-table table-responsive">
                            ...
                            <div class="m-2">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <select class="input-group__select ui search dropdown JenTransaksi" name="Pelulus PO" id="txtPelulus_PO3" placeholder="&nbsp;" style="background-color: #f0f0f0" disabled>
                                            </select>
                    ...
                    <div class="modal-footer modal-footer--sticky" style="padding: 0px!important">
                        <button type="button" class="btn btn-setsemula btnTidakLulus" data-toggle="tooltip" data-placement="bottom">Batal Pesanan Belian</button>
                        <%--<button type="button" class="btn btn-success btnBatalPtPermohonan" data-toggle="tooltip" data-placement="bottom">Batal Pembelian dan Permohonan</button>--%>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        <!-- jumlah anggaran harga kena add function tarik value duit from db and format value tu dalam bentuk duit -->
                                        <label>Harga Seunit (Tanpa GST) (RM)</label>
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">RM</div>
                                            </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            tblPerolehanDtl = $("#tblDataPerolehanDtl").DataTable({
                ...
                "columns": [
                    ...
                    { "data": "Harga_Seunit", "title": " Harga Seunit (Tampa GST) (RM)" },
                    { "data": "Flag_SST", "title": " Inclusive GST? Kadar: 0%" },
                    { "data": "Jumlah_Harga", "title": " Harga GST (RM)" },
                    { "data": "Jumlah_Harga", "title": " Jum. Harga (Tampa GST) (RM)" },
                    { "data": "Jumlah_Harga_Bercukai", "title": " Jum. Harga (Termasuk GST) (RM)" },
                ],
                "columnDefs": [
                    {
                        "targets": 0,
            ...
            $("#tblDataPerolehanDtl").off('click', '.editBtn').on("click", ".editBtn", function (event) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (jsonData[0].Kod_Negara_Pembuat.trim() !== '') {
                        ...
                        $('#txtFlag_sst').val(jsonData[0].Flag_SST),
                            ...
                            $('#txtHarga_Seunit_Tanpa_GST_update').val(jsonData[0].Kadar_Harga),
            ...
            $('#confirmSaveButtonUpdate10').off('click').on('click', async function () {
                ...
                var newPembelianPoHdr = {
                    pembelianPoHeder: {
                        ...
                        ddlId_Pembelian: $("#txtIdPembelian").val() || '',
                        ddlNo_Mohon: $('#txtNo_Perolehan').val() || '',
        ...
        $(document).ready(function () {
            ...
            tblNJ = $("#tblDataNaskah_Jualan").DataTable({
                ...
                "ajax":
                {
                    "url": '<%= ResolveClientUrl("~/FORMS/PEROLEHAN/PermohonanPoWS.asmx/LoadPesanan_Pembelian_batal") %>',
                    type: 'POST',
                    data: function (d) {
        ...
        function loadMaklumatIklan() {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $("#txtNo_Perolehan").val(jsonData[0].No_Mohon);
            ...
            $(document).ready(function () {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $("#txtNo_Perolehan3").val(jsonData[0].No_Mohon);
        ...
        $('.btnTidakLulus').off('click').on('click', async function () {
        ...
        async function ajaxUpdateHantar_Pesanan_belian_Hdr(pembelianPoHeder, rowDataArray) {
            ...
            return new Promise((resolve, reject) => {
                ...
                $.ajax({
                    url: '<%= ResolveClientUrl("~/FORMS/PEROLEHAN/PermohonanPoWS.asmx/UpdateHantar_Pesanan_belian_Hdr_batal") %>',
                    //url: 'PermohonanPoWS.asmx/UpdatePO_BajetSpesifikasi',
                    method: 'POST',
                    data: JSON.stringify({
                        "pembelianPoHeder": pembelianPoHeder.pembelianPoHeder,
