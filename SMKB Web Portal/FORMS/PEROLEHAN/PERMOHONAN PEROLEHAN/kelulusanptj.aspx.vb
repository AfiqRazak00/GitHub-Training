...
Public Class kelulusanptj
    ...
    '    Dim fullName As String = "Muhammad Farid Bin Abd Razak"
    '    Dim email As String = "muhammadfarid@utem.edu.my"

    '    'Send the New password to the user's email
    '    Dim subject As String = "UTeM - Sistem Maklumat Kewangan Bersepadu"
    '    Dim body As String = "Sokongan Permohonan - Bendahari Zon " &
    '                 "<br><br>" &
    '                 vbCrLf & "Assalamualaikum Dan Salam Sejahtera " & fullName & "," &
    '                 "<br><br>" &
    '                 vbCrLf & "Permohoanan perolahan telah disokong oleh Bendahari Zon. " &
    '                 "<br><br>" &
    '                 vbCrLf & "Sila klik di link ini untuk menyemak status permohonan jurnal melalui <a href=""https://devmis.utem.edu.my/iutem/"">https://devmis.utem.edu.my/iutem/</a>" &
    '                 "<br>" &
    '                 "<br><br>" &
