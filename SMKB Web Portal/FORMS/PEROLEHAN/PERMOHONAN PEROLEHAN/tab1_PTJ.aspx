<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="tab1_PTJ.aspx.vb" Inherits="SMKB_Web_Portal.tab1_PTJ" %>
    ...
    <contenttemplate>
        ...
        <div id="PermohonanTab" class="tabcontent" style="display: block">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="bajet-tab" data-toggle="tab" data-target="#bajet-dan-spesifikasi" type="button" role="tab">Maklumat Bajet</button>
                </li>
                <%--<li class="nav-item" role="presentation">
                    <button class="nav-link btnSearchAm" id="spesifikasiAm-tab" data-toggle="tab" data-target="#spesifikasi-am" type="button" role="tab">Maklumat Spesifikasi Am</button>
                </li>--%>
                <%--<li class="nav-item" role="presentation">
            ...
            <div class="tab-content" id="myTabContent">
                    ...
                    <div id="divpendaftaraninv" runat="server" visible="true">
                        <div class="modal-body">
                            <div>
                                ...
                                <input type="hidden" id="tahapPerolehan" value="ptj" />
                ...
                <div class="tab-pane fade" id="bajet-dan-spesifikasi" role="tabpanel">
                    ...
                    <div id="divTab3" runat="server" visible="true">
                        <div class="modal-body">
                            <div>
                                <h5>Maklumat Bajet dan Spesifikasi</h5>
                                <hr />
                                <div class="row">
                                    <div class="form-group col-md-8">
                    ...
                    <div class="modal-body">
                        <div>
                            ...
                            <br />
                                <div class="col-md-12">
                                    <div class="transaction-table table-responsive">
                                        <table id="tblDataPerolehanDtlRingkasan" class="table table-striped" style="width: 99%">
                                            <thead>
                                                <tr>
                                                    <th scope="col">Id_Mohon_Dtl</th>
                                                    <th scope="col">Bil</th>
...
<%--                            penutup --%>
        ...
        <script type="text/javascript">
            ...
            var jumlahSebenar = '0.00';

            var errorMessageJumlah = '';
            var currencyPageTotal = '0.00'
            ...
            function updateJumlah() {
                ...
                var jumlahTotal = parseFloat(cleanedValue);

                jumlahSebenar = (jumlahTotal) * 1 + (currencyPageTotal) * 1;

                console.log('jumlahSebenar', jumlahSebenar)
            ...
            $(document).ready(function () {
                tbl = $("#tblDataPerolehanDtl").DataTable({
                    ...
                    footerCallback: function (row, data, start, end, display) {
                        ...
                        currencyPageTotal = pageTotal.toFixed(2);

                        // Check if pageTotal is not over than 50000
                        //if (pageTotal > 50000) {
                        //    // Display a warning or take necessary action
                        //    errorMessage +=  "Warning: Page total exceeds 50000"
                        //}
            ...
            $('.btnTambah').off('click').on('click', async function () {
                ...
                $('#confirmSaveButton3').off('click').on('click', async function () {
                    ...
                    if (jumlahSebenar > 50000) {
                        // Display a warning or take necessary action
                        errorMessageJumlah = "Jumlah Permohonan Melebihi RM50,000.00"
            ...
            async function LoadRingkasan() {
                ...
                getBidangKod4();
                showKaedahPerolehan();
                tblRingkasanDataPerolehan.ajax.reload();
            ...
            function callData() {
                ...
                if (currencyPageTotal > 50000) {
                    errorMessage += "Jumlah Permohonan Melebihi RM50,000.00. Sila Ubah Jumlah Permohonan di Tab 2. <br/>";
                }

                //if (tblLvlLength === 0) {
                //    errorMessage += "Sila lengkapkan pada tab 3. (Maklumat Spesifikasi).<br/>";
                //}
                ...
                if (ddlkategoriPOValue === "K" && tab5DataLength === 0 || tab3DataLength === 0) {
                    btnHantar.disabled = true;
                } else {
                    btnHantar.disabled = false;
                }
            ...
            $(document).ready(async function () {
                ...
                tbl5 = $("#tblSenaraiPerolehan").DataTable({
                    ...
                    "ajax": {
                        "url": '<%= ResolveClientUrl("~/FORMS/PEROLEHAN/PermohonanPoWS.asmx/Load_SenaraiPerolehanPtj") %>',
                        method: 'POST',
                        "contentType": "application/json; charset=utf-8",
                        "dataType": "json",
                        "dataSrc": function (json) {
            ...
            var tblRingkasanDataPerolehan = null;

            tblRingkasanDataPerolehan = $("#tblDataPerolehanDtlRingkasan").DataTable({
                "responsive": true,
                "searching": false,
                "info": false,
                "paging": false,
