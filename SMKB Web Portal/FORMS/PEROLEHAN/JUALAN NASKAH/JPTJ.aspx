...
<asp:Content ID="Content1" ContentPlaceHolderID="FormContents" runat="server">
                                ...
                                <div class="">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="child-container-checkbox" style="display: none; margin-left: 15px; margin-top: -15px;">
                                                <div class="form-row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <input class="input-group__input " id="txtTarikh_Mula_Iklan" type="date" placeholder="&nbsp;" name="txtTarikh_Mula_Iklan" style="background-color: white" />
    ...
    <script type="text/javascript">
        ...
        $('.btnSearchDT').off('click').on('click', async function () {
            ...
            category_filter = $('#categoryFilter').val(); // Retrieve category_filter value here
            console.log("category_filter=", category_filter); // Log the value
        ...
        $(document).ready(function () {
            ...
            tblNJ = $("#tblDataNaskah_Jualan").DataTable({
                ...
                "ajax":
                {
                    "url": '<%= ResolveClientUrl("~/FORMS/PEROLEHAN/PermohonanPoWS.asmx/LoadNaskah_JualanDS") %>',
                    type: 'POST',
                    data: function (d) {
