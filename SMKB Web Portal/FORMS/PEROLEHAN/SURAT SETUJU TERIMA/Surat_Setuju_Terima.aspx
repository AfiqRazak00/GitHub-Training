<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Surat_Setuju_Terima.aspx.vb" Inherits="SMKB_Web_Portal.Surat_Setuju_Terima" %>
                    ...
                    <div >
                        <div class=" " >
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalCenterTitle">Surat Setuju Terima</h5>
                            </div>
              ...
              "ajax": {
                  ...
                  "rowCallback": function (row, data) {
                      ...
                      $(row).on("click", function () {
                          ...
                          window.open('<%=ResolveClientUrl("~/FORMS/PEROLEHAN/SURAT SETUJU TERIMA/PrintReport/SST_Print.aspx")%>', '_blank');
