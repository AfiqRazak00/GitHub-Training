<%@ Page Title="" Language="vb" Async="true" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="PertanyaanTuntutan.aspx.vb" Inherits="SMKB_Web_Portal.PertanyaanTuntutan" %>
                ...
                <div>
                    <div class="modal-body">
                        <div class="modal-header">
                            <h5 class="modal-title">Senarai Tuntutan</h5>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="transaction-table table-responsive">
                                    <table id="tblDataSenarai" class="table table-striped">
                                        <thead>
                                            <tr style="width: 100%">
                                                <th scope="col" style="width: 10%">No. Tuntutan</th>
                                                <th scope="col" style="width: 5%">Jenis Tuntutan</th>
                                                <th scope="col" style="width: 5%">Tahun Tuntut</th>
                                                <th scope="col" style="width: 5%">Bulan Tuntut</th>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            tbl = $("#tblDataSenarai").DataTable({
                ...
                "ajax":
                {
                    "url": "PertanyaanAC_WS.asmx/LoadOrderRecord_PertanyaanTuntutan",
                    type: 'POST',
                    data: function (d) {
