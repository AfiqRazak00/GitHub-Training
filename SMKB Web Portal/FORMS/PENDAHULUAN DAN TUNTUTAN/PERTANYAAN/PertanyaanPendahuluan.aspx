<%@ Page Title="" Language="vb" Async="true" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="PertanyaanPendahuluan.aspx.vb" Inherits="SMKB_Web_Portal.PertanyaanPendahuluan" %>
                ...
                <div>
                    <div class="modal-body">
                        <div class="modal-header">
                            <h5 class="modal-title">Senarai Pendahuluan</h5>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="transaction-table table-responsive">
                                    <table id="tblDataSenarai" class="table table-striped">
                                        <thead>
                                            <tr style="width: 100%">
                                                <th scope="col" style="width: 10%">No. Pendahuluan</th>
                                                <th scope="col" style="width: 5%">Jenis Tugas</th>
                                                <th scope="col" style="width: 15%">Jenis Pendahuluan</th>
                                                <th scope="col" style="width: 10%">Jenis Perjalanan</th>
                                                <th scope="col" style="width: 20%">Tujuan</th>
                                                <th scope="col" style="width: 10%">Tarikh Mohon</th>
                                                <th scope="col" style="width: 10%">Jumlah Mohon (RM)</th>
                                                <th scope="col" style="width: 10%">Jumlah Lulus (RM)</th>
                                                <th scope="col" style="width: 15%">Nama Pemohon</th>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            tbl = $("#tblDataSenarai").DataTable({
                ...
                "ajax":
                {
                    "url": "PertanyaanAC_WS.asmx/LoadOrderRecord_PertanyaanPendahuluan",
                    type: 'POST',
                    data: function (d) {
