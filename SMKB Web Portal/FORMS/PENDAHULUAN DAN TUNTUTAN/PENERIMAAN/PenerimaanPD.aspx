   ...
   <script type="text/javascript">
       ...
       $(document).ready(function () {
           ...
           tbl = $("#tblDataSenarai").DataTable({
               ...
               "ajax": {
                   "url": "PenerimaanPD_WS_New.asmx/LoadOrderRecordPD",
                   type: 'POST',
       ...
       $('.lbtnSimpan').click(async function () {
           ...
           $('#modalSenarai').modal('toggle');
           var jumLulus = $('#jumSemua').val().replace('/,/g', '');
       ...
       async function ajaxSavePelulus(id) {
           ...
           return new Promise((resolve, reject) => {
               $.ajax({
                   url: 'PenerimaanPD_WS.asmx/SaveRecordPenerimaan',
                   method: 'POST',
       ...
       function loadRecordPelulus(nomohon) {
           ...
           fetch('PenerimaanPD_WS.asmx/GetDataPelulus', {
               method: 'POST',
               headers: {
          ...
          //$('#penerimaan').modal('hide');
           ...
           var UpdateData = {
               Terimaan: {
                   ...
                   jumlahMohon: $('#jumSemua').val().replace('/,/g', ''),
       ...
       function getDataPeribadi() {
           ...
           console.log(nostaf)
            ...
            fetch('PenerimaanPD_WS_New.asmx/GetUserInfo', {
                method: 'POST',
                headers: {
                    'Content-Type': "application/json"
                },
             ...
             function getHadMinPendahuluan() {
                 ...
                 //Cara Pertama          
                   fetch('PenerimaanPD_WS.asmx/GetHadMin', {
                     method: 'POST',
                     headers: {
                         'Content-Type': "application/json"
                     },
       ...
       async function initDropdownCOA(id) {
           ...
           $('#' + id).dropdown({
               ...
               apiSettings: {
                   url: 'PenerimaanPD_WS.asmx/GetVotCOA?q={query}',
                   method: 'POST',
                   dataType: "json",
                   contentType: 'application/json; charset=utf-8',
                   cache: false,
       ...
       $(document).ready(function () {
           ...
           //    kiraElaunMakan();
           //})
           generateDropdown("ddlTugas", "PenerimaanPD_WS.asmx/GetJenisTugas", null, kiraElaunMakan)
           generateDropdown("ddlPenginapan", "PenerimaanPD_WS.asmx/GetPenginapan", null, kiraElaunMakan)
           generateDropdown("ddlTempat", "PenerimaanPD_WS.asmx/GetTempat", null, kiraElaunMakan)
           generateDropdown("ddlBayar", "PenerimaanPD_WS.asmx/GetKaedahBayar")
           generateDropdown("ddlJnsJalan", "PenerimaanPD_WS.asmx/GetJenisJalan", null, kiraElaunMakan)
       });
