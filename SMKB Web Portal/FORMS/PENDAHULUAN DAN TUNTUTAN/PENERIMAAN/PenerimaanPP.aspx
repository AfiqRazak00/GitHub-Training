                    ...
                    <table  class="table table-striped" id="tblData2" style="width: 100%">
                        ...
                        <tbody id="tableID2">
                            <tr style="display: none; width: 100%" class="table-list">
                                ...
                                <td style="width: 20%">
                                    <input id="txtAnggaran" name="txtAnggaran"  type="text" class="list-anggaran form-control" style="text-align: right" />
                                </td>                          
                                <td style="width: 10%">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        tbl = $("#tblDataSenarai").DataTable({
            ...
            "ajax": {
                "url": "PenerimaanPP_WS.asmx/LoadOrderRecordPP",
                type: 'POST',
    ...
    $('.lbtnSimpan').click(async function () {
        ...
        $('#modalSenarai').modal('toggle');
        var jumLulus = $('#totalKt').val().replace('/,/g', '');
    ...
    $('.btnSavePelulus').click(async function () {
        ...
        var UpdateData = {
            Terimaan: {
                ...
                jumlahMohon: $('#totalKt').val().replace('/,/g',''),
    ...
    function getDataPeribadiPemohon(pemohon) {
        ...
        fetch('PenerimaanPP_WS.asmx/GetUserInfo', {
            method: 'POST',
            headers: {
