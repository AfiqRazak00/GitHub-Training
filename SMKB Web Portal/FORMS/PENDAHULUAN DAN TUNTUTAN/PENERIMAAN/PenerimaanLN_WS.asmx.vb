...
Public Class PenerimaanLN_WS
    ...
    Public Function GetDataPelbagai(ByVal id As String) As String
        ...
        '    If row.Item("statusData") = "PERMOHONAN" Then
        '        Dim rekod As DataRow = dt.AsEnumerable().Where(Function(x) x.Item("No_Tuntutan") = row.Item("No_Tuntutan") And x.Item("Jns_Dtl_Tuntutan") = row.Item("Jns_Dtl_Tuntutan") And x.Item("No_Item") = row.Item("No_Item") And x.Item("StatusData") = "PENERIMAAN").FirstOrDefault()
        '        If rekod IsNot Nothing Then
        '            dt.Rows.Remove(rekod)
        '        End If
        '    End If
        'Next
