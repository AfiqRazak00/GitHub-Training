<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="PenerimaanLN.aspx.vb" Inherits="SMKB_Web_Portal.PenerimaanLN" %>
            ...
            <div class="col-md-12"> 
                <div class="form-row">
                    <div class="form-group col-md-3">
                        ...
                        <label class="input-group__label" for="Kump_wang">Kumpulan Wang</label>              
                    </div>               
                    <div class="form-group col-md-3">
            ...
            <table class="table table-striped" id="tblSewaHotel" style="width: 100%;">
                <thead>
                    <tr style="width: 100%; text-align: center;">
                        ...
                        <th scope="col" style="width: 15%;vertical-align:middle">Dokumen Bukti</th> 
...
<button id="btnSimpanHotel" type="button" class="btn btn-secondary btnSimpanHotel" data-toggle="tooltip" data-placement="bottom" title="Draft">Simpan</button>
   ...
   <div class="col-md-12">
        <div class="transaction-table table-responsive">
        <div>
            <h8>Terimaan Bayaran Sewa Hotel </h8>         
        </div>   
            <table class="table table-striped" id="tblSewaHotelTerima" style="width: 100%;">
                <thead>
                    <tr style="width: 100%; text-align: center;">
                ...
                <tbody id="tblSewaHotelDataTerima">
                   
                <tr class="table-list" width: 100%" style="display:none;">
                    <td>
                    <input type="text" class="form-control input-md-txtBiltblHotel-listT" id="txtBiltblHotelT" style="background-color:#f3f3f3;font-size:small" >
                    <label class="lblBiltblHotel-list" id="lblBiltblHotelT" name="bilhotel"></label>
                    </td>
                    <td>                                                      
                    <select class="ui search dropdown ddlJenisTugastblHotel-list" name="ddlJenisTugastblHotel" id="ddlJenisTugastblHotelT"></select>
                    <input type="hidden" class="hidBil" value="" />                                     
                    <label id="lblJenisTugastblHotelT" name="lblJenisTugastblHotel" class="label-JenisTugastblHotel-listT" style="text-align: center;visibility: hidden"></label>
                    <label id="HidJenisTugastblHotelT" name="HidJenisTugastblHotel" class="Hid-JenisTugastblHotel-listT" style="visibility: hidden"></label>
                    </td>
                    ...
                    <td>
                    <input type="text" class="form-control input-md resittblHotel-listT" id="resittblHotelT" style="font-size:small" >
                    <label class="lblresittblHotel-listT" id="lblresittblHotelT" name="lblresittblHotelT"></label>
                    </td>

                     <td>
                     <input type="text" class="form-control input-md haritblHotel-listT" id="haritblHotelT" style="font-size:small" >
                     <label class="lblharitblHotel-list" id="lblharitblHotelT" name="lblharitblHotelT"></label>
                     </td>
                    
                    <td>
                    <input type="text" class="form-control input-md elauntblHotel-listT" id="elauntblHotelT" disabled="disabled" style="background-color:#f3f3f3;font-size:small;text-align: right; font-weight: bold">
                    <label class="lblelauntblHotel-listT" id="lblelauntblHotelT" name="lblelauntblHotelT"></label>
                    </td>

                    <td>
                    <input type="text" class="form-control input-md amauntblHotel-listT" id="amauntblHotelT" style="background-color:#f3f3f3;font-size:small;text-align: right; font-weight: bold">
                    <label class="lblamauntblHotel-listT" id="lblamauntblHotelT" name="lblamauntblHotelT"></label>
                    </td> 
                    
                    <td>                        
                     <div class="input-group col-md-8">    
                     <div class="form-inline">
                        <input type="file" id="fileInputHotelT" class="fileInputHotelT" style="width:250px" />
                         <a href ="#" class="tempFileHotelT" target="_blank"></a>                                           
                        <span id="uploadResitHotelT" style="display: inline;"></span>
                        <span id="">&nbsp</span>
                        <span id="progressContainerT3"></span>
                        <input type ="hidden" id="txtNamaFileHotelT" />
                        <input type="hidden" class="form-control"  id="hidFolderHotelT" style="width:200px" readonly="readonly" /> 
                        <input type="hidden" class="form-control"  id="hidFileNameHotelT" style="width:200px" readonly="readonly" /> 
                        </div>         
                    </div>
                    </td>
                    <td> 
                             <button id="Button1" runat="server" class="btn btnSimpanHotelT"  type="button" style="color: blue">
    <i class="fa fa-floppy-o"></i></button>
                         <%--<input type="button" class="btn btn-secondary btnSimpanTH" onclick="return SimpanTH(this);" id="btnSimpanTH" value="Simpan" />--%>
                        <button id="Button2" runat="server" class="btn btnDeleteHotelT" type="button" style="color: red">
    <i class="fa fa-trash"></i>
</button>
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="form-control underline-input" id="totaltblHotelT" name="totaltblHotelT" style="text-align: right; font-weight: bold" width="8%" value="0.00" readonly /></td>
                        <td colspan="1"></td>
                    </tr>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        tbl = $("#tblDataSenarai").DataTable({
            ...
            "ajax": {
                "url": "PenerimaanLN_WS.asmx/LoadOrderRecord_PermohonanSendiri",
                type: 'POST',
        ...
        tblList = $("#tblListPend").DataTable({   //tbl load senarai permohonan PP
            "responsive": true,
            "searching": true,
            "sPaginationType": "full_numbers",
            "oLanguage": {
            ...
            "ajax": {
                "url": "PenerimaanLN_WS.asmx/LoadRecord_PermohonanPP",
                type: 'POST',
                "contentType": "application/json; charset=utf-8",
                "dataType": "json",
                "dataSrc": function (json) {
    ...
    async function getDataPeribadi() {
        //Cara Pertama
        console.log("load info pemohon 2587")
        //var nostaf = $('#ddlStaf').val()
        var nostaf = '<%=Session("ssusrID")%>'

        const response = await fetch('PenerimaanLN_WS.asmx/GetUserInfo', {
            method: 'POST',
            headers: {
        ...
        await setDataPeribadi(data.d);

    }

    async function setDataPeribadi(data) {
        console.log(data)
    ...
    async function rowClickHandler(orderDetail) {
        ...
        $('#modalSenarai').modal('toggle')
        await getDataPeribadiPemohon(orderDetail.Nopemohon)
    ...
    function getDataPeribadiPemohon(pemohon) {
        ...
        fetch('PenerimaanLN_WS.asmx/GetUserInfo', {
            method: 'POST',
            headers: {
    ...
    async function AjaxGetDataPerjalanan(id) {
        ...
        try {
            ...
            const response = await fetch('PenerimaanLN_WS.asmx/LoadListPerjalanan', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    async function SetDataPerjalananRows(totalClone, objOrder) {
        ...
        while (counter <= totalClone) {
            ...
            generateDropdown_list("#" + newId_JnsTugas, "PenerimaanLN_WS.asmx/GetJenisTugas", null)
            generateDropdown_list("#" + newId_JnsNegara, "PenerimaanLN_WS.asmx/GetJenisNegara", null)
    ...
    async function totalElaunMakan(id) {
        ...
        fetch('PenerimaanLN_WS.asmx/GetTotalElaunMakan', {
            method: 'POST',
            headers: {
                'Content-Type': "application/json"
            },
    ...
    async function AjaxGetDataElaunMakan(id) {
        ...
        try {
            ...
            const response = await fetch('PenerimaanLN_WS.asmx/GetDataElaunMakan', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    $tblElaunMakan = $("#tblElaunMakan").DataTable({   //tbl load senarai permohonan PP
        ...
        "ajax": {
            "url": "PenerimaanLN_WS.asmx/GetDataElaunMakan",
            type: 'POST',
            "contentType": "application/json; charset=utf-8",
            "dataType": "json",
            "dataSrc": function (json) {
    ...
    async function SetDataElaunLojing(totalClone, objOrder) {
        ...
        while (counter <= totalClone) {
            ...
            generateDropdown_list("#" + newId_jnstugasLojing, "PenerimaanLN_WS.asmx/GetJenisTugasTblSewaHotel", null)
    ...
    async function AjaxRecordElaunLojing(id) {
        ...
        try {
            ...
            const response = await fetch('PenerimaanLN_WS.asmx/GetDataElaunLojing', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    async function AjaxRecordSewaHotel(id) {
        ...
        try {
            ...
            const response = await fetch('PenerimaanLN_WS.asmx/GetDataSewaHotel', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    async function SetDataSewaHotel(totalClone, objOrder) {
        ...
        while (counter <= totalClone) {
            ...
            generateDropdown_list("#" + newId_jnstugasHotel, "PenerimaanLN_WS.asmx/GetJenisTugasTblSewaHotel", null)
    ...
    async function GetAmaunFromDB(jnsTugas, jnsNegara) {
        ...
        try {
            ...
            const response = await fetch('PenerimaanLN_WS.asmx/kiraElaunHotel', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    async function AjaxGetDataPelbagai(id) {
        try {
            ...
            const response = await fetch('PenerimaanLN_WS.asmx/GetDataPelbagai', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    async function SetDataPelbagaiRows(totalClone, objOrder) {
        ...
        while (counter <= totalClone) {
            ...
            //if (objOrder !== null && objOrder !== undefined) {
            //    if (obj[counter - 1].statusData === "PERMOHONAN") {
            //        var objPenerimaan = obj.filter(x => x.No_Tuntutan == obj[counter - 1].No_Tuntutan && x.Jns_Dtl_Tuntutan == obj[counter - 1].Jns_Dtl_Tuntutan && x.No_Item == obj[counter - 1].No_Item && x.StatusData === "PENERIMAAN");
            //        if (objPenerimaan !== null) {
            //            continue;
            //        }
            //    }
            //}
            ...
            generateDropdown_list("#" + newId_jenisBP, "PenerimaanLN_WS.asmx/GetJenisPelbagai", null)
    ...
    async function AjaxGetDataSumbangan(id) {
        ...
        try {
            ...
            const response = await fetch('PenerimaanLN_WS.asmx/GetDatSumbangan', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    async function SetDataSumbanganRows(totalClone, objOrder) {
        ...
        while (counter <= totalClone) {
            ...
            if (objOrder !== null && objOrder !== undefined) {
                ...
                total += parseFloat(jumlahSumbang.val());
            ...
            generateDropdown_list("#" + newId_JnsTabung, "PenerimaanLN_WS.asmx/GetJenisSumbangan")
    ...
    async function AjaxDataPengesahan(id) {
        ...
        try {
            ...
            const response = await fetch('PenerimaanLN_WS.asmx/LoadListPengesahan', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    function getDataPengesahan() {
        ...
        fetch('PenerimaanLN_WS.asmx/GetDataPengesahanLN', {
            method: 'POST',
            headers: {
                'Content-Type': "application/json"
            },
    ...
    function loadRecordPelulus(nomohon) {
        ...
        fetch('PenerimaanLN_WS.asmx/GetDataPelulus', {
            method: 'POST',
            headers: {
                'Content-Type': "application/json"
            },
   ...
   function setDataPelulus(data) {
    ...
    async function ajaxSavePelulus(id) {
        ...
        return new Promise((resolve, reject) => {
            $.ajax({
                url: 'PenerimaanLN_WS.asmx/SaveRecordSokong',
                method: 'POST',
