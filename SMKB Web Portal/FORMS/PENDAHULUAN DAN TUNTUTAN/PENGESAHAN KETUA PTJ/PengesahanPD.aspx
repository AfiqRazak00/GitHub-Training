                    ...
                    <table  id="tblData"  class="table table-striped"><%-- class="table table-bordered"--%>
                        ...
                        <tbody id="tableID">
                            <tr  class="table-list">
                                ...
                                <td>
                                    <label id="HidlblKo" name="HidlblKo" class="Hid-ko-list"></label> - 
                                    <label id="lblKo" name="lblKo" class="label-ko-list" style="text-align: center"></label>
                                </td>
                                <td>                    
                                    <label id="HidlblPTj" name="HidlblPTj" class="Hid-ptj-list"></label> -                 
                                    <label id="lblPTj" name="lblPTj" class="label-ptj-list" style="text-align: left"></label>
                                </td>
                                <td>
                                    <label id="HidlblKp" name="HidlblKp" class="Hid-kp-list"></label> - 
                    ...
                    <div class="col-sm-12"> 
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="form-group col-md-3 form-inline">                                       
                                <input type="checkbox" name="checkfield" id="chkDN" value="false" disabled/>&nbsp;&nbsp;
    ...
    <script type="text/javascript">
       ...
       function setDataPelulus(data) {
        ...
        $('.btnSavePelulus').click(async function () {
            ...
            //$('#modalSenarai, #penerimaan').modal('hide');
                ...
                },
                {
                    ...
                    "render": function (data, type, row, meta) {
                        if (isSet(data)) {
                            ...
                            return '<div class="file-upload-container"><input name="fileHantar' + meta.row + '" type="file" id="fileInput' + meta.row + '" accept=".pdf" class="file-input codx selected"><a class="file-name-label" id="fileNameLabel' + meta.row + '" href="' + path + '" target="_blank" rel="noopener noreferrer"><i class="far fa-eye fa-lg"></i> ' + data + '</a></div>';
                        } else {
                            return '<div class="file-upload-container"><input name="fileHantar' + meta.row + '" type="file" id="fileInput' + meta.row + '" accept=".pdf" class="file-input"><a class="file-name-label codx" id="fileNameLabel' + meta.row + '" href=""></a></div>';
                        }
                    },
        ...
        function getHadMinPendahuluan() {
            ...
            fetch('PengesahanPD_WS.asmx/GetHadMin', {
             ...
             async function setValueToRow_HdrPermohonan(orderDetail) {  //ni tuk set value bila klik pada gridview permohonan
                 ...
                 $('#jumSemua').val(formatNumber(orderDetail[0].Jum_Mohon))
             ...
             async function rowClickHandler(orderDetail) {
                 ...
                 //faiz
                 $('#modalSenarai .input-group__select select').each(function () {
                     $(this).parent().addClass('disabled');
                     $(this).parent().css("background-color", "#f0f0f0");
                 });
                 $('#modalSenarai .input-group__input').each(function () {
                     $(this).prop('disabled', true).prop('readonly', true);
                 });
                 $('#modalSah .input-group__input').each(function () {
                     $(this).prop('disabled', true).prop('readonly', true);
                 });
                ...
                // uploadedFileNameLabel.appendChild(fileLink);
                 ...
                 var result = await ajaxPost('<%= ResolveClientUrl("~/FORMS/PENDAHULUAN DAN TUNTUTAN/PERMOHONAN PENDAHULUAN/Pendahuluan_WS.asmx/LoadUploadDokumen") %>', { noPendahuluan: orderDetail.No_Pendahuluan }, false);
