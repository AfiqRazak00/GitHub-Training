...
<asp:Content ID="Content1" ContentPlaceHolderID="FormContents" runat="server">
    ...
    <div class="modal fade" id="modalSenarai" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="panel panel-default">
                        ...
                        <div class="container">
                            <div class="form-row">
                                <div class="btn btn-primary btn-change" data-toggle="modal" data-target="#myPersonal"><small class="font-weight-bold">Maklumat Pegawai</small></div>
                                <div class="col-sm-12">
                        ...
                        <div class="tab-content">
                            ...
                            <div id="menu1" class="tab-pane fade show active" role="tabpanel" aria-labelledby="tab-permohonan">
                                <asp:Panel ID="Panel2" runat="server">
                                    ...
                                    <div class="col-md-12">
                                        <table id="tblData" class="table table-striped">
                                            ...
                                            <tbody id="tableID">
                                                <tr class="table-list">
                                                    <td>
                                                        <select class="input-group__select ui search dropdown COA-list" name="ddlCOA" id="ddlCOA"></select>
                                                    ...
                                                    <td>
                                                        <label id="HidlblKo" name="HidlblKo" class="Hid-ko-list"></label> - <label id="lblKo" name="lblKo" class="label-ko-list" style="text-align: center"></label>
                                                    </td>
                                                    <td>
                                                        <label id="HidlblPTj" name="HidlblPTj" class="Hid-ptj-list"></label> - <label id="lblPTj" name="lblPTj" class="label-ptj-list" style="text-align: left"></label>
                                                    </td>
                                                    <td>
                                                        <label id="HidlblKp" name="HidlblKp" class="Hid-kp-list"></label> - <label id="lblKp" name="lblKp" class="label-kp-list" style="text-align: center"></label>
                                                    </td>
                                                    <td>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="date" class="input-group__input form-control" id="tkh_Adv">
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label for="kodModul">Kaedah Pembayaran</label>
                                                <br />
                                                <select class="input-group__select ui search dropdown bayar-list" name="ddlBayar" id="ddlBayar" style="left: 0px; top: 0px"></select>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label for="kodModul">Peruntukan Program</label><br />
                                                <textarea rows="2" cols="30" id="txtPeruntukan" class="input-group__input form-control" maxlength="500"></textarea>
                                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                <label for="date-input">Tarikh Mula</label>
                                                <br />
                                                <input type="date" class="input-group__input form-control" id="tkhMula">
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label for="date-input2">Tarikh Tamat</label>
                                                <br />
                                                <input type="date" class="input-group__input form-control" id="tkhTamat">
                                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <textarea rows="2" cols="30" id="txtTujuan" class="input-group__input form-control" maxlength="500"></textarea>
                                            </div>

                                            <div class="form-group col-md-4">
                                                <label for="date-input2">Tempat Program Diadakan</label>
                                                <br />
                                                <textarea rows="2" cols="30" id="txtTempat" class="input-group__input form-control" maxlength="500"></textarea>
                                            </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-8">
                                                <label for="date-input2">
                                                    Sila Nyatakan Mengapa Pembelian Barang/Perkhidmatan Tersebut
                                                    <br />
                            ...
                            <div id="menu2" class="tab-pane fade" aria-labelledby="tab-Keperluan" role="tabpanel">
                                <asp:Panel ID="keperluan" runat="server">
                                        ...
                                        Peringatan : 
                                        <br />
                                        &nbsp; 1) Anggaran Perbelanjaan Adalah Berdasarkan Kertas Kerja Yang Telah Diluluskan
                                        <br />
                                        &nbsp; 2) Perbelanjaan Luar Jangka Tidak Dibenarkan Didalam Pendahuluan Pelbagai 
                                        </p>
                                        ...
                                        <table class="table table-striped" id="tblData2" style="width: 100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 25%" scope="col">Kadar Harga (RM)</th>
                                                    <th style="width: 25%" scope="col">Anggaran (RM)</th>
                                                </tr>
                                            </thead>
                                            <tbody id="tableID2">
                                                <tr style="display: none; width: 100%" class="table-list">
                                                    <td style="width: 30%">
                                                        <input type="text" id="txtKeperluan" class="input-group__input txtKeperluan form-control" /><%-- //style="visibility: hidden"--%>
                                                        <label id="hidItem" name="hidItem" class="hidItemNO"></label>
                                                    </td>
                                                    <td style="width: 20%">
                                                        <input id="Kuantiti" name="Kuantiti" type="number" class="input-group__input list-kuantiti form-control" style="text-align: right" />
                                                    </td>

                                                    <td style="width: 25%">
                                                        <input id="txtKadarHarga" name="txtKadarHarga" type="text" class="input-group__input list-kadarHarga form-control" style="text-align: right" />
                                                    </td>
                                                    <td style="width: 25%">
                                                        <input id="txtAnggaran" name="txtAnggaran" type="text" class="input-group__input list-anggaran form-control" style="text-align: right" />
                                                    </td>
                                                </tr>
                                            </tbody>
                                            <tfoot>
                            ...
                            <div id="menu3" class="tab-pane fade" aria-labelledby="tab-Pengesahan" role="tabpanel">
                                <asp:Panel ID="Panel3" runat="server">
                                    ...
                                    <input type="checkbox" id="chckSah" value="chckSah" disabled/>&nbsp;&nbsp;<b>Saya mengaku bahawa :</b>
                                    <br />
                                    <br />
                                    <ul>
                                    ...
                                    <p>
                                        ...
                                        <u>Senarai Semak</u>
                                        <br />
                                        Sila pastikan dokumen sokongan tersebut dihantar bersama borang permohonan Pendahuluan Pelbagai.
                                        <br />
                                    </p>
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            <label for="kodModul">1) Surat Kelulusan program dari Pihak Berkuasa Meluluskan (tertakluk kepada peraturan semasa)</label>
                                            <br />
        ...
        <%--tutup class-document--%>
    </div>
    <%--tutup modal-idSenarai--%>
    ...
    <div id="modalSah" class="modal fade hide" role="dialog">
        <div class="modal-dialog modal-lg" role="dialog">
            ...
            <div class="modal-content">
                    ...
                    <asp:Panel ID="Panel1" runat="server">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <label class="input-group__label" for="Catatan">Catatan <span class="star codx" style="color: red">*</span></label>
                            </div>
                ...
                <div class="modal-footer">
                    <button type="button" runat="server" class="btn btn-secondary btnSavePelulus">Simpan</button>
                </div>
            </div>
    ...
    function loadRecordPelulus(nomohon) {
       ...
       function setDataPelulus(data) {
           ...
           //faiz
           $('#namaPengesah').val('<%=Session("ssusrName")%>');
           $('#jwtnPengesah').val('<%=Session("ssusrPost")%>');
    ...
    function rowClickHandler(orderDetail) {
        ...
        //faiz
        $('.input-group__select select').each(function () {
        ...
        $('#txtCatatan').prop('disabled', false).prop('readonly', false);
        ...
        $(ddl).dropdown('set selected', orderDetail.Kod_Kump_Wang);
        selectObj.append("<option value = '" + orderDetail.Kod_Kump_Wang + "'>" + orderDetail.Kod_Kump_Wang + ' - ' + orderDetail.colKW + "</option>")
...
<%--         $(document).ready(function () {
    ...
    //faiz
    $('#tblData2').on('input', '.list-kadarHarga, .list-kuantiti', function () {
        var parentTr = $(this).closest('.table-list');
        var kdrHarga = parentTr.find('.list-kadarHarga').val().replace(/,/g, '') || '0.00';
        var kuantiti = parentTr.find('.list-kuantiti').val().replace(/,/g, '') || '0.00';
        var total = parseFloat(kdrHarga) * parseFloat(kuantiti);
        parentTr.find('.list-anggaran').val(formatNumber(total));
    ...
    function calcSumRow() {
        // Calculate sum
        var sum = 0.00;
        $('.list-anggaran').each(function () {
            var data = $(this).val().replace(/,/g, '') || '0.00';
            var value = parseFloat(data);
            sum += value;
        });

        $("#totalKt").val(formatNumber(sum));
    }
    ...
    $('#btnSimpanTblData2').click(async function () {
        ...
        $('#totalKt').val(formatNumber(totalKt));
    ...
    async function SetDataKeperluanKepadaRows(totalClone, objOrder) {
        ...
        while (counter <= totalClone) {
            ...
            kadarHargaTextbox.val(formatNumber(obj[counter - 1].Kadar_Harga));
            anggaranTextbox.val(formatNumber(obj[counter - 1].Jumlah_anggaran));
        ...
        $('#totalKt').val(formatNumber(total))  //total harga
    }
    ...
    $('.btnHantar').click(async function () {
        ...
        $('.radioBtnClass').change(function () {
            if ($('.radioBtnClass:checked').length > 0) {
                ...
                console.log("No radio button with class radioBtnClass is checked.");
            }
        });
        ...
        $('.btnSavePelulus').click(async function () {
            ...
            var mohonID = $('#noPermohonan').val();
            var stafID = '<%=Session("ssusrID")%>';

            if (card_type == '13' && !isSet(catatan)) {
            ...
            if (!confirm("Anda pasti ingin menyimpan rekod ini?")) {
                $('#modalSah').modal('hide');
                return;
            } else {
                $('#modalSah').modal('hide');
