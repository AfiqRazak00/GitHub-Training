       ...
       <asp:Panel ID="Panel2" runat="server">
           ...
           <div class="row">
             <div class="col-md-12"> 
                 <div class="form-row">
                    <div class="form-group col-md-12">
                        <textarea rows="3" cols="30" ID="txtSebab"class="input-group__input form-control" placeholder="&nbsp;" MaxLength="500"></textarea>
                            ...
                            <table  class="table table-striped" id="tblData2" style="width: 100%">
                                ...
                                <tbody id="tableID2">
                                    <tr style="display: none; width: 100%" class="table-list">
                                        ...
                                        <td style="width: 20%">
                                            <input id="Kuantiti" name="Kuantiti"  type="number" class="list-kuantiti form-control" style="text-align: right"/>
                                        </td>

                                        <td style="width: 20%">
                                            <input id="txtKadarHarga" name="txtKadarHarga" type="text" class="list-kadarHarga form-control" style="text-align: right" />
                                        </td>
                                        <td style="width: 20%">
                                            <input id="txtAnggaran" name="txtAnggaran"  type="text" class="list-anggaran form-control" style="text-align: right" disabled readonly/>
                                        </td>                          
                                        <td style="width: 10%">
     ...
     <asp:Panel ID="Panel3" runat="server">           
        ...
        <br />
                ...
                <div class="form-row">
                    ...
                    <div class="input-group col-md-3">
                        <div class="form-inline">
                            <input type="file" id="fileInputSurat" class="input-group__input choose-button" />
                            <label for="UploadSurat" class="input-group__label">Muatnaik Surat</label>
                            <input type="button" id="uploadBtnSurat" class="btn btn-primary mt-1" value="Muatnaik" onclick="uploadFileSurat()" />
         ...
         <div class="row">
             <div class="col-md-12">
                 <div class="form-row">
                     <div class="form-group col-md-5">
                         <label for="kodModul">2)Perincian bajet (berdasarkan kertas kerja)</label>
                     </div>
                     <div class="form-group col-md-3">
                         <div class="form-inline">
                             <input type="file" id="fileBajet" class="input-group__input choose-button" />
                             <label for="UploadSurat" class="input-group__label">Muatnaik Dokumen</label>
                             <input type="button" id="uploadBtnBajet" class="btn btn-primary mt-1" value="Muatnaik" onclick="uploadFileBajet()" />
                        ...
                        <%-- <div class="form-inline">
                             <input type="file" id="fileBajet" style="width: 350px" /><br />
        ...
        <div class="row">
                <div class="col-md-12"> 
                    <div class="form-row">
                        <div class="form-group col-md-12" align="right">
                            <button type="button" class="btn btn-secondary btnHantar" id="btnHantar">Simpan dan Hantar</button>
                        </div>
                    </div>
                </div>
         </div>  
    ...
    <div class="modal-dialog" role="document">
     ...
     <script type="text/javascript">
         ...
         $('#txtKadarHarga').on('keypress', function () {
             var total
             total = parseFloat($('#txtKadarHarga').val().replace(/,/g, '')) * parseFloat($('#Kuantiti').val())
             $('#txtAnggaran').val(formatNumber(total));
             console.log(total);
         });
         ...
         $('#btnSimpanTblData2').click(async function () {
                 ...
                 if (index > 0) {
                     ...
                     if ($(obj).find('.txtKeperluan').val() !== "") {
                         var orderItem = {
                             ...
                             txtKadarHarga: $(obj).find('.list-kadarHarga').val().replace(/,/g, ''),
                             txtAnggaran: $(obj).find('.list-anggaran').val().replace(/,/g, ''),
                         };
             ...
             $('#totalKt').val(formatNumber(result.Payload.Jumlah));
         ...
         $('.btnHantar').click(async function () {
             ...
             if (check_surat === "") {
                 $("#lblMessageModal").html("Sila upload Surat Kelulusan Program.");
                 $("#MessageModal").modal('show');
                 return false;
             }

             if (check_suratBajet === "") {
                 $("#lblMessageModal").html("Sila upload Perincian Bajet.");
                 $("#MessageModal").modal('show');
                 return false;
             }
             ...
             if (isChecked !== true) {
                 $("#lblMessageModal").html("Sila tick pada kotak perakuan.");
                 $("#MessageModal").modal('show');
                  return false;
             }
            ...
            msg = "Anda pasti ingin menyimpan rekod ini?"
             ...
             if (recordSimpan.Status) {
                 $("#lblMessageModal").html(recordSimpan.Message);
                 $("#MessageModal").modal('show');
             } else {
                 $("#lblMessageModal").html(recordSimpan.Message);
                 $("#MessageModal").modal('show');
