...
Public Class Pelbagai_WS
    ...
    Private Function GetRecord_SenaraiSendiri(category_filter As String, tkhMula As DateTime, tkhTamat As DateTime, staffP As String) As DataTable
        ...
        Dim query As String = "
                                SELECT a.No_Pendahuluan, a.Tujuan, a.Tempat_Perjalanan, a.PTj, FORMAT(a.Tarikh_Mula, 'yyyy-MM-dd') as Tarikh_Mula, FORMAT(a.Tarikh_Tamat, 'yyyy-MM-dd') as Tarikh_Tamat, a.Status, 
                                ...
                                a.Kod_PTJ, (SELECT b.Pejabat FROM VPejabat as b WHERE b.kodpejabat = left(a.Kod_PTJ,2)) as ButiranPTJ  ,
    ...
    Private Function GetHdrPermohonan(id As String) As DataTable
        ...
        Dim query As String = "
                                SELECT a.No_Pendahuluan, a.Tujuan,  FORMAT(a.Tarikh_Mula, 'yyyy-MM-dd') as Tarikh_Mula, FORMAT(a.Tarikh_Tamat, 'yyyy-MM-dd') as Tarikh_Tamat, a.Status, 
