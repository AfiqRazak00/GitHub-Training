<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="TuntutanBatal.aspx.vb" Inherits="SMKB_Web_Portal.TuntutanBatal" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            tbl = $("#tblDataSenarai").DataTable({
                ...
                "ajax": {
                    "url": "TuntutanBatal_WS.asmx/LoadOrderRecord_PermohonanSendiri",
                    type: 'POST',
        ...
        function loadInfoBatal(nostaf) {
            ...
            console.log(nostaf)
             fetch('TuntutanBatal_WS.asmx/GetUserInfo', {
                 method: 'POST',
                 headers: {
        ...
        async function ajaxBatal(id) {
            ...
            return new Promise((resolve, reject) => {
                $.ajax({
                    url: 'TuntutanBatal_WS.asmx/SaveBatalPermohonan',
                    method: 'POST',
