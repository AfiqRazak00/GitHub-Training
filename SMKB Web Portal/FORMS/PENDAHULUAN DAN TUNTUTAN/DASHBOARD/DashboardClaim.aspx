<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="DashboardClaim.aspx.vb" Inherits="SMKB_Web_Portal.DashboardClaim" %>
...
<%--                <div class="modal-content" >--%>
                    ...
                    <div class="form-row justify-content-center">
                        <div class="col-md-4 card-deck">
                            <div class="card bg-info text-center">
                                <p class="card-text text-white font-weight-bold">Jumlah Pendahuluan yang Dilulus</p>
                                <span  style="font-size:20px;font-weight:bold" class="bg-white jumLulus"></span>
                            </div>
                        </div>
                        <div class="col-md-4 card-deck">
                            <div class="card bg-success text-center">
                                <p class="card-text text-white font-weight-bold">Jumlah Tuntutan yang Dilulus</p>
                   ...
                   <div class="col-lg-4 col-md-6 mb-4" style="display:none">
                    ...
                    <div class="col-lg-6 col-md-6 mb-4">
                        <div class="card shadow">
                            ...
                            <div
                                class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold " style="color: darkslategrey; font-size: 14px">Jumlah Pemohonan Pendahuluan Mengikut PTJ bagi Tahun
                    ...
                    <div class="col-lg-6 col-md-6 mb-4">
                        <div class="card shadow">
                            ...
                            <div
                                class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold " style="color: darkslategrey; font-size: 14px">Jumlah Pemohonan Tuntutan Mengikut PTJ bagi Tahun
      
                                <label id="lblTahun1_"></label>

                                </h6>
                            </div>
                            <!-- Card Body -->
                            <div class="card-body">
                                <div id="bar2_" class="chart-bar pt-4 pb-2 chart-container" style="width: 100%; height: 300px;">
                                    <canvas id="lineChart_1" style="width: 100%; height: 100%;"></canvas>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script type="text/javascript">
            ...
            $('.btnPapar').click(async function () {
                ...
                $.ajax({
                    url: 'DashboardClaim_WS.asmx/LoadOTLulusDB',
                    method: 'POST',
                    dataType: 'JSON',
                    ...
                    success: function (data) {
                       ...
                       // TotalTerima = data[0].JumOTTerima;
                        var formattedData_1 = parseFloat(data[0].JUMLAH_KESELURUHAN).toLocaleString('en-MY', { style: 'currency', currency: 'MYR', minimumFractionDigits: 2 });
                ...
                $.ajax({
                    url: 'DashboardClaim_WS.asmx/LoadOTBlmLulusDB',
                    method: 'POST',
                    dataType: 'JSON',
                    contentType: "application/json; charset=utf-8",
                    data: JSON.stringify({ Tahun: Tahun }),
                    success: function (data) {
                        ...
                        console.log(parseFloat(data[0].JumOTBelumTerima))
                        // TotalBlTerima = data[0].JumOTBelumTerima;
                        if (isNaN(parseFloat(data[0].JumOTBelumTerima))) {
                            $('.jumBLulus').html("0.00");
                        } else {
                ...
                $.ajax({
                    url: 'DashboardClaim_WS.asmx/LoadlinechtJumMohonOPTJ',
                    method: 'POST',
                    dataType: 'JSON',
                    contentType: "application/json; charset=utf-8",
                    data: JSON.stringify({ Tahun: Tahun }),
                    success: function (data) {
                        ...
                        chartData2.forEach(function (item) {
                            ...
                            valuesPTJ.push(parseFloat(item.jumlah_mohon));
                        });
                ...
                $.ajax({
                    url: 'DashboardClaim_WS.asmx/LoadlinechtJumMohonOPTJ_1',
                    method: 'POST',
                    dataType: 'JSON',
                    contentType: "application/json; charset=utf-8",
                    data: JSON.stringify({ Tahun: Tahun }),
                    success: function (data) {
                        ...
                        $chartPtj = createBarChartPTJ_1(categorizePTJ, valuesPTJ);
            ...
            function createBarChartPTJ_1(categorizePTJ, valuesPTJ) {
                var ctx2 = document.getElementById('lineChart_1').getContext('2d');
                return new Chart(ctx2, {
                    type: 'line',
                    data: {
                        labels: categorizePTJ,
