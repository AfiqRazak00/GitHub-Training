                    ...
                    <table id="tblListMaster" class="table table-striped" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" style="width:100px">Amaun Pelarasan (RM)</th>
         ...
         <div class="modal-dialog" role="document">
             <div class="modal-content">
                 ...
                 <div class="modal-body">
                     ...
                     <label id="lblModalMessaage">Default Value</label>
                 </div>
                 <div class="modal-footer">
...
<script type="text/javascript">
    ...
    $('#tblListStaf').on('click', '.btnView', function () {
        ...
        if ($('#<%=ddlMonths.ClientID%>').val() == '')
        {

            $("#lblModalMessaage").text("Sila masukkan bulan");
            SaveSucces();
            return;
        }
        if ($('#<%=ddlyear.ClientID%>').val() == '') {

            $("#lblModalMessaage").text("Sila masukkan tahun");
            SaveSucces();
            return;
        }
        ...
        ListMaster(id, $('#<%=ddlMonths.ClientID%>').val(), $('#<%=ddlyear.ClientID%>').val());
    ...
    function ListMaster(vNostaf,bulan,tahun) {
        ...
        tbl = $("#tblListMaster").DataTable({
            ...
            "ajax": {
                "url": "Transaksi_WS.asmx/LoadListLejar",
                method: 'POST',
                "contentType": "application/json; charset=utf-8",
                "dataType": "json",
                data: function () {
                    return JSON.stringify({ nostaf: vNostaf, bulan: bulan, tahun: tahun })
                },
                "dataSrc": function (json) {
                    //var data = JSON.parse(json.d);
                    //console.log(data.Payload);
