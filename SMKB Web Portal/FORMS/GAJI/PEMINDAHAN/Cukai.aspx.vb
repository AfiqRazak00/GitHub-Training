...
Public Class Cukai
    ...
    Protected Sub btnExport_Click(sender As Object, e As EventArgs)
        ...
        DBCon.Open()
        cmd2 = New SqlCommand("select isnull(sum(z.pcb),0) as pcb,isnull(sum(z.cp38),0) as cp,isnull(sum(z.bilpcb),0) as bilpcb,isnull(sum(z.bilcp),0) as bilcp,(select no_cukai from SMKB_Gaji_No_Majikan) as nocukai from (
