...
<asp:Content ID="Content1" ContentPlaceHolderID="FormContents" runat="server">
    ...
    <script type="text/javascript">
        ...
        function testJv() {
            ...
            document.getElementById('MainContent_FormContents_HiddenButton').click();
            //show_loader();
        }
        //function tutup_loader() {

        //    document.getElementById('MainContent_FormContents_CloseButton').click();
        //    close_loader();
        //}
    </script>
...
<div class="modal fade"  id="SpinModal" tabindex="-1" role="dialog">
    ...
    <%--<asp:Button  ID="CloseButton" runat="server" Text="Button" style="display:none" OnClick="CloseButton_Click"/>--%>
        <script type="text/javascript">
