<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Pencen.aspx.vb" Inherits="SMKB_Web_Portal.Pencen" %>
<asp:Content ID="Content1" ContentPlaceHolderID="FormContents" runat="server">
    ...
    $(function () {
        $('#<%= gvPencen.ClientID%>').prepend($("<thead></thead>").append($("#<%= gvPencen.ClientID%>").find("tr:first"))).DataTable({
            "responsive": true,
...
<div id="PermohonanTab" class="tabcontent" style="display: block">
    ...
    <div class="table-title">
        <h6>Senarai Pencen</h6>
        <hr>
        <div class="btn btn-primary"  onclick="ShowPopup('1')">
            <i class="fa fa-plus"></i>Tambah Pencen              
        </div>&nbsp;&nbsp;
        
    </div>
           <br/>
        <div class="box-body" align="center" >               
            <asp:GridView ID="gvPencen" CssClass="table table-bordered table-striped grid" Width="100%" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Pencen_Maj" HeaderText="Majikan (%)">
                        <ItemStyle Width="20%" HorizontalAlign="center" />
                    </asp:BoundField>
                    <asp:BoundField DataField="Pencen_Pek" HeaderText="Pekerja (%)">
                        <ItemStyle Width="20%" HorizontalAlign="center" />
                    </asp:BoundField>
            ...
            <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="eMCTitle">Tambah Pencen</h5>
