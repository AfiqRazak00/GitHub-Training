<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Pindahan_Kod.aspx.vb" Inherits="SMKB_Web_Portal.Pindahan_Kod" %>
<asp:Content ID="Content1" ContentPlaceHolderID="FormContents" runat="server">
    ...
    $(function () {
        $('#<%= gvPindah.ClientID%>').prepend($("<thead></thead>").append($("#<%= gvPindah.ClientID%>").find("tr:first"))).DataTable({
            "responsive": true,
...
<div id="PermohonanTab" class="tabcontent" style="display: block">
    ...
    <div class="table-title">
        <h6>Senarai Pindahan Kod</h6>
        <hr>
        <div class="btn btn-primary"  onclick="ShowPopup('1')">
            <i class="fa fa-plus"></i>Tambah Kod              
        </div>&nbsp;&nbsp;
        
    </div>
          <br/> 
        <div class="box-body" align="center" >               
            <asp:GridView ID="gvPindah" CssClass="table table-bordered table-striped grid" Width="100%" runat="server"
                    AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" >                                    
                <Columns>
                    <asp:BoundField DataField="kod_smsm" HeaderText="Kod SMSM">
                        <ItemStyle Width="10%" HorizontalAlign="center" />
                    </asp:BoundField>
                    <asp:BoundField DataField="kod_smkb" HeaderText="Kod SMKB">
            ...
            <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="eMCTitle">Tambah Pindahan Kod</h5>
                                ...
                                <div class="col-md-6">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                              <asp:DropDownList ID="ddlKatSMSM" runat="server" CssClass="input-group__select ui search dropdown" Width="70px">

                                              </asp:DropDownList>
                                             <label class="input-group__label" for="Kod SMSM">Kod SMSM</label>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <asp:DropDownList ID="ddlKatSMKB" runat="server" CssClass="input-group__select ui search dropdown" Width="70px">

                                             </asp:DropDownList>
                                            <label class="input-group__label" for="Kod SMKB">Kod SMKB</label>
                                        </div>
