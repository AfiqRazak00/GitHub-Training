...
<div id="PermohonanTab" class="tabcontent" style="display: block">
    <div class="table-title">
        <h6><U><B>Senarai Transaksi Mengikut Jenis</B></U></h6>
        <hr>
                                ...
                                <div class="col-md-6">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <asp:TextBox runat="server" ID="txtJenis" CssClass="input-group__input" Style="width: 100%;text-transform:uppercase;" MaxLength="1" ></asp:TextBox>
                                            <label class="input-group__label" for="Jenis Transaksi">Jenis Transaksi</label>
                                            <asp:RequiredFieldValidator ID="rqdJenis" runat="server" ControlToValidate="txtJenis" CssClass="text-danger" ErrorMessage="*Sila Masukkan Jenis Transaksi" ValidationGroup="Semak" Display="Dynamic"/>

                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <asp:TextBox runat="server" ID="txtButir" CssClass="input-group__input" Style="width: 100%;text-transform:uppercase;" MaxLength="20" ></asp:TextBox>
                                            <label class="input-group__label" for="Butiran">Butiran</label>
                                        </div>

                                        <div class="form-group col-md-6">
                                            <asp:TextBox runat="server" ID="txtDaripada" CssClass="input-group__input" Style="width: 100%;text-transform:uppercase;" MaxLength="5" ></asp:TextBox>
                                            <label class="input-group__label" for="Daripada">Daripada</label>
                                        </div>
                                    </div>
                                </div>
