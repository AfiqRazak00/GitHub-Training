...
Public Class Proses_Gaji
    ...
    Private Sub fBindPTJ()
        Try
            ...
            strsql = $"select KodPejabat AS kod, Pejabat as butiran, Singkatan,KodPejabat + ' - ' + Pejabat as butirptj from MS_Pejabat WHERE Status = 1 and KodPejabat not in ('50','-') order by KodPejabat"
