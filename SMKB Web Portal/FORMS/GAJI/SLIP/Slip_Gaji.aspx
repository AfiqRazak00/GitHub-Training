...
<div id="PermohonanTab" class="tabcontent" style="display: block">
        <!-- Modal -->
           ...
           <div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-2 order-md-1">
                                            <div class="form-group">
                                               ...
                                               <select id="ddlMonths" runat="server" class="ui search dropdown input-group__input">
                                        ...
                                        <div class="col-md-2 order-md-1">
                                            <div class="form-group">
                                                ...
                                                <select id="ddlyear" runat="server" class="ui search dropdown input-group__input">
                                                    <option value="">-- Sila Pilih --</option>
               ...
               <button id="btnPrint" runat="server" class="btn btnPrint" onclick="CreatePDFfromHTML()" type="button" >
                   ...
                   <div class="form-row">
                        ...
                        <table id="tblListstaf" style="width:97%;padding:5px"  cellspacing="0px" cellpadding="0px" border="0" >
                            <tr style="padding:5px" > 
                                ...
                                <td style="width:9%;font-size:12px;"><b>NO. STAF </b></td>
                            ...
                            <tr > 
                                ...
                                <td id="lblbank"  style="text-align:left;font-weight:bold;width:33%;font-size:12px;"></td>
                            </tr>
                            <tr > 
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                $(document).on("click", ".btnSearch", function (e) {
                    ...
                    document.getElementById('invoice-box').style.display = 'inline-block';
                    //alert('Boem');
...
<%--                                window.location.href = '<%=ResolveClientUrl("~/reportbaru4.aspx")%>';--%>
            ...
            function setInfoStaf(data) {
                ...
                document.getElementById('lblbank').innerHTML = ': ' + data[0].bank;
