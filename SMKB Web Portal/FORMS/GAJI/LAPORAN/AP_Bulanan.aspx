<%@ Page Language="vb" AutoEventWireup="false"  MasterPageFile="~/NestedMasterPage2.master" CodeBehind="AP_Bulanan.aspx.vb" Inherits="SMKB_Web_Portal.AP_Bulanan" %>
            ...
            <div>
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalCenterTitle">Laporan AP Bulanan</h5>
                        ...
                        <div class="col-md-12">
                            <div class="transaction-table table-responsive">
                                <table id="tblDataSenarai_trans_rpt" class="table table-striped" style="width: 100%">
                                    <thead>
                                        <tr>
                                            <th scope="col" style="text-align: center; width: 10%;">Kw</th>
                                            <th scope="col" style="text-align: center; width: 10%;">Ptj</th>
                                            <th scope="col" style="text-align: center; width: 10%;">Vot</th>
                                            <th scope="col" style="text-align: center; width: 15%;">Status</th>
                                            <th scope="col" style="text-align: center; width: 25%;">Butiran</th>
                                            <th scope="col" style="text-align: center; width: 15%;">Debit</th>
                                            <th scope="col" style="text-align: center; width: 15%;">Kredit</th>
                                        </tr>
                                    </thead>
    ...
    <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                tbl = $("#tblDataSenarai_trans_rpt").DataTable({
                    ...
                    buttons: [
                        'csv', 'excel', {
                            ...
                            action: function (e, dt, button, config) {
                                window.open('<%=ResolveClientUrl("~/FORMS/GAJI/LAPORAN/PrintReport/reportAPBulanan.aspx")%>', '_blank');
                    ...
                    "ajax": {
                        "url": "Laporan_WS.asmx/LoadRecord_APBulanan",
                        type: 'POST',
                        data: function (d) {
                            return "{ bulan: '" + $('#<%=ddlMonths.ClientID%>').val() + "', tahun: '" + $('#<%=ddlyear.ClientID%>').val() + "'}"
                        },
                    ...
                    "columns": [
                        { "data": "Kod_Kump_Wang", "className": "center-align" },
                        { "data": "Kod_PTJ", "className": "center-align" },
                        { "data": "Kod_Vot", "className": "center-align" },
