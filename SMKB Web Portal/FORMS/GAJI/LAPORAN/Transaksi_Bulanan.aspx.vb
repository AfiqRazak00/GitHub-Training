...
Public Class Transaksi_Bulanan
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            Dim tarafPerkhidmatan As DataTable = GetTarafPerkhidmatan()
            ' Bind the data to the dropdown list
            tarafPkhdFilter.DataSource = tarafPerkhidmatan
            tarafPkhdFilter.DataBind()
        End If
    End Sub
    ...
    Private Function GetPtjList() As DataTable
        ...
        select concat(KodPejabat,'0000') as KodPejabat , Pejabat from {DBStaf}MS_PEJABAT where Status = 1;"
    ...
    Private Function GetTarafPerkhidmatan() As DataTable
        ' Create a connection to your database
        'Dim connectionString As String = "server=qa12.utem.edu.my;database=DbKewanganV4;uid=Smkb;pwd=smkb*pwd;"
        Dim connection As New SqlConnection(strCon)

        ' Create a SQL query to fetch the month data
        Dim query As String = $"SELECT '%' AS KodTarafKhidmat, 'KESELURUHAN' AS TarafKhidmat UNION ALL
                               SELECT KodTarafKhidmat,TarafKhidmat FROM {DBStaf}MS_TarafKhidmat;"
