    <%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Transaksi_Elaun_Bulanan_VOT.aspx.vb" Inherits="SMKB_Web_Portal.Transaksi_Elaun_Bulanan_VOT" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="FormContents" runat="server">
            ...
            <div>
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalCenterTitle">Laporan Transaksi Elaun Bulanan (VOT)</h5>
    ...
    <script type="text/javascript">
        ...
        function beginSearch() {
            ...
            $.ajax({
                url: "Laporan_WS.asmx/LoadRecord_TransaksiElaunBulananVot",
                type: "POST",
                data: JSON.stringify({
                        ...
                        buttons: ['csv', 'excel'
                            <%--{
                                ...
                                action: function (e, dt, button, config) {
                                    window.open('<%= ResolveClientUrl("~/FORMS/GAJI/LAPORAN/PrintReport/reportTransaksiElaunVot.aspx") %>', '_blank');
                                }
                            }--%>
                        ],
