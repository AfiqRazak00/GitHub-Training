<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="reportStafKontrak.aspx.vb" Inherits="SMKB_Web_Portal.reportStafKontrak" %>

<%@ Register Src="~/FORMS/GAJI/LAPORAN/PrintReport/TableStafKontrak.ascx" TagPrefix="Vot" TagName="Table" %>
        ...
        <div id="masterdiv" class="container">
           ...
           <div id="headerreport" class="header" style ="">
                <table>
                    <tr>
                        ...
                        <td style="width: 30%; text-align: right">
                            ...
                            <span class="ptarikh">Laporan Staf Kontrak</span><br />
                    ...
                    <tr>
                        ...
                        <td style="text-align: center">
                            <br/>
                            <p class="pheader3"><strong>Laporan Staf Kontrak</strong></p>
                            <p class="pheader3">Warganegara :
                                <asp:Label runat="server" ID="selectedWarga"></asp:Label></p>
                            <p class="pheader3">
                                Bagi 
                                <%--<asp:Label runat="server" ID="bulan"></asp:Label>--%>
                                <asp:Label runat="server" ID="tahun">Tahun</asp:Label>
                            </p>
                        </td>
            ...
            <div class="vot-table-content">
                <Vot:Table runat="server" ID="TableStafKontrak" CustomClass="TableStafKontrak" />
            </div>
          <%--  <table>
                <tr></tr>
                <tr>
