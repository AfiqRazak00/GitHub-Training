<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="reportTransaksiElaunRingkasan.aspx.vb" Inherits="SMKB_Web_Portal.reportTransaksiElaunRingkasan" %>
<%@ Register Src="~/FORMS/GAJI/LAPORAN/PrintReport/TableTransaksiElaunRingkasan.ascx" TagPrefix="Vot" TagName="Table" %>
...
<head>
    ...
    <style>
        ...
        @page {
            size: A3 landscape; /* or letter, legal, etc. */
    ...
    <form id="form1" runat="server">
         <div id="masterdiv" class="container">
                ...
                <table> 
                    <tr>
                        ...
                        <td style="width: 30%; text-align: right">
                            ...
                            <span class="ptarikh">Laporan Elaun Bulanan</span><br />
                    ...
                    <tr>
                        ...
                        <td style="text-align:center">
                            <br/>
                            <p class="pheader3"><strong>Laporan Ringkasan Transaksi Elaun Bulanan</strong></p>
            ...
            <div class="vot-table-content">
                 <Vot:Table runat="server" ID="TableTransaksiElaunBulanan" CustomClass="TableTransaksiElaunBulanan" />
            </div>
            <script>
