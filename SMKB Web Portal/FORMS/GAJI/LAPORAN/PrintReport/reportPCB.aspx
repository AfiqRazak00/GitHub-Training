<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="reportPCB.aspx.vb" Inherits="SMKB_Web_Portal.reportPCB" %>

<%@ Register Src="~/FORMS/GAJI/LAPORAN/PrintReport/TablePCB.ascx" TagPrefix="Vot" TagName="Table" %>
...
<head>
    ...
    <style>
        ...
        @page {
            size: landscape A3; /*or letter, legal, etc. */
...
<body>
    ...
    <div id="masterdiv" class="container">
            ...
            <table>
                <tr>
                    ...
                    <td style="width: 30%; text-align: right">
                        ...
                        <span class="ptarikh">Laporan Pengiraan PCB</span><br />
                ...
                <tr>
                    ...
                    <td style="text-align: center" colspan="3">
                        <br />
                        <p class="pheader3"><strong>Laporan Pengiraan PCB</strong></p>
        ...
        <%--<div class="content">--%>
            <Vot:Table runat="server" ID="TablePCB" CustomClass="TablePCB" />
        </div>
        <br />
