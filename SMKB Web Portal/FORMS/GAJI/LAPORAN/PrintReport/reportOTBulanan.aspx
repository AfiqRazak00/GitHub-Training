<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="reportOTBulanan.aspx.vb" Inherits="SMKB_Web_Portal.reportOTBulanan" %>

<%@ Register Src="~/FORMS/GAJI/LAPORAN/PrintReport/TableOTBulanan.ascx" TagPrefix="Vot" TagName="Table" %>
        ...
        <div id="masterdiv" class="container">
           ...
           <div id="headerreport" class="header" style ="">
                <table>
                    <tr>
                        ...
                        <td style="width: 30%; text-align: right">
                            ...
                            <span class="ptarikh">Laporan Transaksi OT Bulanan</span><br />
                    ...
                    <tr>
                        ...
                        <td style="text-align: center">
                            <br/>
                            <p class="pheader3"><strong>Laporan Transaksi OT Bulanan</strong></p>
            ...
            <div class="vot-table-content">
                <Vot:Table runat="server" ID="tblTransaksiOTBulananan" CustomClass="tblTransaksiOTBulananan" />
            </div>
            <table>
                <tr></tr>
                <tr>
