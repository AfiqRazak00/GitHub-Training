<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="reportPCBTerperinci.aspx.vb" Inherits="SMKB_Web_Portal.reportPCBTerperinci" %>

<%@ Register Src="~/FORMS/GAJI/LAPORAN/PrintReport/TablePCBTerperinci.ascx" TagPrefix="Vot" TagName="Table" %>
...
<body>
    ...
    <div id="masterdiv" class="container">
            ...
            <table>
                <tr>
                    ...
                    <td style="width: 30%; text-align: right">
                        ...
                        <span class="ptarikh">Laporan Pengiraan PCB Terperinci</span><br />
                ...
                <tr>
                    ...
                    <td style="text-align: center" colspan="3">
                        <br />
                        <p class="pheader3"><strong>Laporan Pengiraan PCB Terperinci</strong></p>
        ...
        <%--<div class="content">--%>
            <Vot:Table runat="server" ID="TablePCBTerperinci" CustomClass="TablePCBTerperinci" />
        </div>
        <br />
