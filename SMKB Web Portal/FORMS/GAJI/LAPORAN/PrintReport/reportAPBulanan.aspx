<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="reportAPBulanan.aspx.vb" Inherits="SMKB_Web_Portal.reportAPBulanan" %>
<%@ Register Src="~/FORMS/GAJI/LAPORAN/PrintReport/TableAPBulanan.ascx" TagPrefix="Vot" TagName="Table" %>
    ...
    <form id="form1" runat="server">
         <div id="masterdiv" class="container">
                ...
                <table> 
                    <tr>
                        ...
                        <td style="width: 30%; text-align: right">
                            ...
                            <span class="ptarikh">Laporan AP Bulanan</span><br />
                    ...
                    <tr>
                        ...
                        <td style="text-align:center">
                            <br/>
                            <p class="pheader3"><strong>Laporan AP Bulanan</strong></p>
            ...
            <div class="vot-table-content">
                 <Vot:Table runat="server" ID="TableAPBulanan" CustomClass="TableAPBulanan" />
            </div>
