<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="reportTransaksiElaunVot.aspx.vb" Inherits="SMKB_Web_Portal.reportTransaksiElaunVot" %>
<%@ Register Src="~/FORMS/GAJI/LAPORAN/PrintReport/TableTransaksiElaunVot.ascx" TagPrefix="Vot" TagName="Table" %>
    ...
    <form id="form1" runat="server">
         <div id="masterdiv" class="container">
                ...
                <table> 
                    <tr>
                        ...
                        <td style="width: 30%; text-align: right">
                            ...
                            <span class="ptarikh">Laporan Transaksi Elaun Bulanan (VOT)</span><br />
                    ...
                    <tr>
                        ...
                        <td style="text-align:center">
                            <br/>
                            <p class="pheader3"><strong>Laporan Transaksi Elaun Bulanan (VOT)</strong></p>
            ...
            <div class="vot-table-content">
                 <Vot:Table runat="server" ID="TableTransaksiElaunBulananVot" CustomClass="TableTransaksiElaunBulananVot" />
            </div>
            <script>
