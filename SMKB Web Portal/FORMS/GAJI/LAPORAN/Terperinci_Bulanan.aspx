<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Terperinci_Bulanan.aspx.vb" Inherits="SMKB_Web_Portal.Terperinci_Bulanan" %>
            ...
            <div>
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalCenterTitle">Laporan Terperinci Bulanan</h5>
                        ...
                        <div class="col-md-12">
                            <div class="transaction-table table-responsive">
                                <table id="tblDataSenarai_trans_rpt" class="table table-striped" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th scope="col" style="text-align: center; width: 10%;">Kod</th>
                                            <th scope="col" style="text-align: center; width: 10%;">Jenis</th>
                                            <th scope="col" style="text-align: center; width: 50%;">Butiran</th>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            tbl = $("#tblDataSenarai_trans_rpt").DataTable({
                ...
                buttons: [
                    'csv', 'excel', 
                    {
                        ...
                        action: function (e, dt, button, config) {
                            window.open('<%= ResolveClientUrl("~/FORMS/GAJI/LAPORAN/PrintReport/reportTerperinci.aspx") %>', '_blank');
                        }
                    }
                ],
                ...
                "ajax": {
                    "url": "Laporan_WS.asmx/LoadRecord_Terperinci",
                    type: 'POST',
                    data: function (d) {
