...
Public Class Order_Penyata
    ...
    Public Sub New(IdPenyata_ As String, Bank_ As String, Tarikh_ As String, Jumlah_ As String, lOrderDetails_ As List(Of OrderDetail_Penyata))
...
Public Class OrderDetail_Penyata
