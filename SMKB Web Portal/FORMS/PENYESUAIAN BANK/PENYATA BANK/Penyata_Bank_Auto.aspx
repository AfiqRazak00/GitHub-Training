<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Penyata_Bank_Auto.aspx.vb" Inherits="SMKB_Web_Portal.Penyata_Bank_Auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="FormContents" runat="server">
    ...
    <div id="PermohonanTab" class="tabcontent" style="display: block">
        ...
        <div class="modal-body">
            <div class="table-title">
                <h6>Kemasukan Penyata Bank Secara Manual</h6>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                         <input class="input-group__input " id="lblIdPenyesuaian" type="text" placeholder="&nbsp;" name="lblIdPenyesuaian" readonly style="background-color: #f0f0f0" />
        ...
        <div class="modal-dialog modal-dialog-centered modal-l" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">Tambah Penyata Bank Secara Manual                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <script>
        ...
        async function setValueToRow_Transaksi(row, orderDetail) {
            ...
            txtTarikh.val(orderDetail.Tarikh);
