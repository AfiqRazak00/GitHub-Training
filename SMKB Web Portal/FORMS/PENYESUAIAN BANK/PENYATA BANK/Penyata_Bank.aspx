<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Penyata_Bank.aspx.vb" Inherits="SMKB_Web_Portal.Penyata_Bank" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="FormContents" runat="server">
    ...
    <div id="PermohonanTab" class="tabcontent" style="display: block">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <label class="input-group__label" for="Baki b/b Penyata(RM)">Baki (RM)</label>
                                    </div>
                                </div>

                                <div class="form-row">
                                    <p style="margin-bottom:unset">Nama Fail Penyata:</p>
                                    <div class="col-md-6">
                                    <div class="card">
                                        <div class="form-group" style="margin-top: 10px; margin-left: 10px">
                                            <input type="file" id="uploadDokumen" class="form-control-file" />
                                            <small class="form-text text-muted">Jenis fail yang dibenarkan: .CSV sahaja (Saiz Maksimum: 5MB)</small>
                                        </div>
                                        <button  id="savedokumen">Muat Naik</button>
                                    </div>
                                </div>
                                </div>
                            </div>
                                    ...
                                    <table class="table table-striped" id="tblData">
                                        <thead>
                                            <tr style="text-align:center ">
                                                ...
                                                <th scope="col">W.Masuk (RM)</th>
                                                <th scope="col">W.Keluar (RM)</th>
                                                <th scope="col">Baki (RM)</th>
                                        ...
                                        <tbody id="tableID"  >
                                            <tr style="display: none; width: 100%" >
                                                ...
                                                <td style="width: 20%">
                                                    <input type="text" name="Rujukan" id="Rujukan" class="form-control underline-input Rujukan" />
                                                </td>
                                                <td style="width: 32%">
                                                    <input type="text" name="Perkara" id="Perkara" class="form-control underline-input Perkara" />
                                                </td>
                                                <td style="width: 10%">
                                                    <input type="number" name="Debit" id="Debit" class="form-control underline-input Debit" style="text-align: right"  value="0.00"/>
                                                </td>
                                                <td style="width: 10%">
                                                    <input type="number" name="Kredit" id="Kredit" class="form-control underline-input Kredit"  style="text-align: right"  value="0.00"/>
                                                </td>
                                                <td style="width: 10%">
                                                    <input type="number" name="Baki" id="Baki" class="form-control underline-input Baki" readonly style="text-align: right"  />
                                                </td>
                                                <td style="width: 5%">
                                                    <button id="lbtnPadam" runat="server" class="btn btnDelete" type="button" style="color: red;">
      ...
      <%--                                      <tr>
                                            ...
                                            <tr>
                                                ...
                                                <th colspan="3" style="text-align: right; font-size: large">Baki Akhir (RM)</th>
                                                <td tyle="text-align:center">
                                                    <input class="form-control underline-input" id="totalBakiAkhir" name="totalBakiAkhir" style="text-align: right; font-size: large; font-weight: bold" value="0.00" readonly />
                                                </td>
                                                <td colspan="3"></td>
                                            </tr>
                                        </tfoot>
                    ...
                    <div class="modal-footer modal-footer--sticky" style="padding: 0px!important">
                        ...
                        <button type="button" class="btn btn-success btnSimpanDtl" data-toggle="tooltip" data-placement="bottom">Simpan</button>
        ...
        <div class="modal-dialog modal-dialog-centered modal-l" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success btnSimpan" data-toggle="tooltip" data-placement="bottom" title="Simpan">Simpan</button>
    ...
    <script>
        ...
        $('.btnSimpanDtl').click(async function () {
        ...
        $('.btnYa_Dtl').click(async function () {
            ...
            $('.txtTarikh').each(function (index, obj) {

                if (index > 0) {
                    var tcell = $(obj).closest("td");
                    //alert("ce;; "+tcell)
                    var orderDetail = {                    
                        Tarikh: $('.txtTarikh').eq(index).val(),
                        Rujukan: $('.Rujukan').eq(index).val(),
                        Butiran: $('.Perkara').eq(index).val(),
        ...
        async function readLastDebitRow() {
            try {
                // Assuming your DataTable instance is initialized and stored in a variable called 'dataTable'
                var $allRows = $('#tblData tbody tr');
                var debitAmount = 0.00;
                $allRows.each(function (ind, obj) {
                    var curAmaun = $(obj).find("td > .Baki").val();
                    //console.log('baki amount:', debitAmount);
                    if (curAmaun !== "") {
                        debitAmount = curAmaun;
                        //console.log('Last baki amount:', debitAmount);
                    }
                })

                $('#totalBakiAkhir').val(debitAmount);
                // You can perform further processing or return the value as needed
                return debitAmount;
            } catch (error) {
                console.error('Error reading last debit row:', error);
                return null;
            }
        }
        ...
        $(tableID).on('keyup', '.Debit , .Kredit', async function () {
            ...
            var curTR = $('#tblData').find(this).closest("tr");

            var rowCount = $('#tblData tbody tr').length;
            console.log("Number of rows:", rowCount);

            var firstRowData = $('#tblData tbody tr:first').find('td').map(function () {
                return $(this).text();
            }).get();
        ...
        async function ajaxSaveOrder_Dtl(order) {
            ...
            return new Promise((resolve, reject) => {
                $.ajax({
                    url: 'PenyataBank_WS.asmx/SaveOrders_Dtl',
                    method: 'POST',
                    data: JSON.stringify(order),
                    dataType: 'json',
                    contentType: 'application/json; charset=utf-8',
