...
Public Class Order_Penyesuaian

    Public Property IdPenyata As String
    Public Property Bank As String
    Public Property Tarikh As String
    Public Property Jumlah As String
    Public Property OrderDetails As List(Of OrderDetail_Penyesuaian)

    Public Sub New()

    End Sub

    Public Sub New(IdPenyata_ As String, Bank_ As String, Tarikh_ As String, Jumlah_ As String, lOrderDetails_ As List(Of OrderDetail_Penyesuaian))
...
Public Class OrderDetail_Penyesuaian
