...
Public Class CetakSuratPeringatan
    ...
    Private Function LoadBil(nobil As String) As DataTable
        ...
        dt.Columns.Add("Jumlah", GetType(Decimal)) ' Make sure "Jumlah" is of type Decimal for correct formatting
        ...
        Try
            ...
            If dt.Rows.Count > 0 Then
                ...
                ' Format "Jumlah" column with thousands separators
                dt.Columns("Jumlah").ExtendedProperties.Add("Format", "#,##0.00")

                For Each row As DataRow In dt.Rows
                    row("Jumlah") = String.Format("{0:#,##0.00}", row("Jumlah"))
                Next
            End If
