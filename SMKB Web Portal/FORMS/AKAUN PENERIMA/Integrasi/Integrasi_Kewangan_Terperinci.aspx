<%@ Page Title="" Language="vb" Async="true" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Integrasi_Kewangan_Terperinci.aspx.vb" Inherits="SMKB_Web_Portal.Integrasi_Kewangan_Terperinci" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            tbl = $("#tblDataSenarai").DataTable({
                ...
                "ajax": {
                    "url": "Integrasi.asmx/Load_MaklumatOrder",
                    "method": 'POST',
        ...
        async function AjaxGetRecordHdrJurnal(id) {
            ...
            try {
                ...
                const response = await fetch('Integrasi.asmx/LoadHdrOrder', {
                    method: 'POST',
                    headers: {
        ...
        async function AjaxGetRecordJurnal(id) {
            ...
            try {
                ...
                const response = await fetch('Integrasi.asmx/LoadDtlOrder', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
        ...
        async function setValueToRow_HdrJurnal(orderDetail) {
            ...
            $('#tkhTamat').val(orderDetail.TkhMula)
            if (orderDetail.JnsUrusniaga == '1') {
                $('#txtUrusniaga').val("PINJAMAN")
            } else {
                $('#txtUrusniaga').val("PENDAHULUAN")
            }
            $('#txtTujuan').val(orderDetail.Pengirim_Mohon)
            ...
            $(ddlUrusniaga).dropdown('set selected', orderDetail.JnsUrusniaga);
            selectObj_JenisTransaksi.append("<option value = '" + orderDetail.JnsUrusniaga + "'>" + orderDetail.JnsUrusniaga + "</option>")
