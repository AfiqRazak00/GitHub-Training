                ...
                <div>
                    <div class="modal-body">
                        <div class="modal-header">
                            <h5 class="modal-title">Senarai Kelulusan Pelarasan Bil</h5>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="transaction-table table-responsive">
                                    <table id="tblDataSenarai" class="table table-striped">
                                        <thead>
                                            <tr style="width: 100%">
                                                <th scope="col" style="width: 10%">No. Pelarasan</th>
            ...
            <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                ...
                <div class="modal-content">
                    <div class="modal-header modal-header--sticky">
                        <h5 class="modal-title" id="ModalCenterTitle">Maklumat Bil Pelarasan</h5>
                            ...
                            <div class="col-md-12">
                                <div class="form-row">
                                    <div class="form-group col-md-3">
                                        <input type="text" class="form-control input-group__input" id="nopelarasan" name="nopelarasan" readonly />
                                        <label class="input-group__label" for="nopelarasan">No. Pelarasan</label>
                                    </div>
                                    <div class="form-group col-md-3">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            tbl = $("#tblDataSenarai").DataTable({
                ...
                "ajax": {
                    "url": "PelarasanWS.asmx/LoadRecord_SenaraiLulusPelarasan",
                    "method": 'POST',
                ...
                "rowCallback": function (row, data) {
                    ...
                    $(row).on("click", function () {
                        rowClickHandler(data.No_Pelarasan);
                    });
                },
                ...
                "columns": [
                    ...
                    { "data": "Tujuan" },
                    {
                        ...
                        render: function (data, type, row, meta) {
                            ...
                            var Jumlah = data.toLocaleString('en-MY', { style: 'currency', currency: 'MYR', minimumFractionDigits: 2 });
                            return Jumlah;
                        }
                    }
                ],
        ...
        function getInvoisHdr(ID_Rujukan) {
            return new Promise(function (resolve, reject) {
                $.ajax({
                    url: 'PelarasanWS.asmx/getFullInvoisData',
                    method: "POST",
                    data: JSON.stringify({
        ...
        function fillInvoisHdr(inv) {
            ...
            $("#nopelarasan").val(inv.No_Pelarasan)
        ...
        async function ajaxSaveOrder(order) {
            return new Promise(function (resolve, reject) {
                let url = 'PelarasanWS.asmx/SaveLulus'
                $.ajax({
                    url: url,
                    method: "POST",
                    data: JSON.stringify({
        ...
        async function ajaxRejectOrder(order) {
            return new Promise(function (resolve, reject) {
                let url = 'PelarasanWS.asmx/RejectLulus'
                $.ajax({
                    url: url,
                    method: "POST",
                    data: JSON.stringify({
