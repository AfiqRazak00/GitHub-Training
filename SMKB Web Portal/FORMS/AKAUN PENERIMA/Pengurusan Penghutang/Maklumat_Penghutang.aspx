                ...
                <%--<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>--%>
                    ...
                    <script type="text/javascript">
                        ...
                        $('#ddlNoMatrikPH').dropdown({
                            ...
                            fullTextSearch: true,
                            apiSettings: {
                                url: 'PenghutangWS.asmx/GetPelajarPHValue?q={query}',
                                method: 'POST',
                                dataType: "json",
                                contentType: 'application/json; charset=utf-8',
                                cache: false,
                        ...
                        $('#ddlNoMatrikPH').on('change', async function () {
                            if (!isReset) {
                                ...
                                // make ajax call to get data from server
                                var pelajarUG = GetPelajarPHValue(selectedValue);
                        ...
                        // get data from server for $('#ddlNoMatrikUG') dropdown when row is selected
                        function GetPelajarPHValue(kod, callback) {
                            return new Promise(function (resolve, reject) {
                                $.ajax({
                                    url: 'PenghutangWS.asmx/GetPelajarPHValue',
                                    method: 'POST',
                                    contentType: 'application/json; charset=utf-8',
                                    data: JSON.stringify({ q: kod }),
                                    success: function (data) {
