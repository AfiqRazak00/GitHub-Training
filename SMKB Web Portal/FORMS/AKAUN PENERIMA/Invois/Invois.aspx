                                ...
                                <div class="">
                                    <div class="form-row">
                                        <div class="form-group col-md-3">
                                            <select id="ddlKategoriPenghutang" class="ui search dropdown input-group__select" name="ddlKategoriPenghutang"></select>
                                        ...
                                        <div class="form-group col-md-3">
                                            <textarea class="input-group__input form-control" placeholder="" name="txtTujuan" id="txtTujuan" maxlength="350" rows="1"></textarea>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-1">
                                            <input type="number" class="input-group__input" placeholder="" id="biltempoh" name="biltempoh" onchange="handleInputChange('',this.value,'','')" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-3">
                                            <input type="text" class="form-control input-group__input" placeholder="" id="txtnorujukan" name="txtnoinv"/>
                                                ...
                                                <table class="table table-striped" id="tblData" style="width: 100%;">
                                                    <thead>
                                                        <tr style="width: 100%; text-align: center">
                                                            ...
                                                            <th scope="col" style="width: 8%">Jumlah (RM)</th>
                                                            <th scope="col" style="width: 2%">Tindakan</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody id="tableID">
                                                        <tr style="display: none; width: 100%">
                                                            ...
                                                            <td>
                                                                <input type="text"
                                                                    ...
                                                                    style="text-align: center" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"/>
                                                            </td>
                                                            <td>
                                                                <input type="text"
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <div class="float-right">
                                                        ...
                                                        <button type="button" class="btn btn-secondary btnSimpan">Simpan Draf</button>
                                                        <button type="button" class="btn btn-success btnHantar">Simpan dan Hantar</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            showModalButton.addEventListener('mouseleave', () => {
                ...
                <script type="text/javascript">
                    ...
                    $('.btnYaBil').click(async function () {
                        ...
                        $('.vot-carian-list').each(function (index, obj) {
                            if (index > 0) {
                                ...
                                var orderDetail = {
                                    ...
                                    amount: $('.amount').eq(index).val().replace(/,/g, ''),
                        ...
                        //var API = JSON.parse(await ARController.Add_Order_Bil(newOrder))
                    ...
                    $('input[type=radio][name=inlineRadioOptions]').change(function () {
                        ...
                        if (this.value == '1') {
                            ...
                            $('#biltempoh').prop('disabled', false);
                            $('#ddlTermBayar').prop('disabled', false);
                        }
                            ...
                            $('#biltempoh').prop('disabled', true);
                            $('#ddlTermBayar').prop('disabled', true);
                        }
                    });
                    ...
                    $(tableID).on('keyup', '.quantity, .price, .amount, .diskaun, .cukai', async function () {
                        ...
                        var totalPrice = NumDefault(quantity.val()) * NumDefault(price.val().replace(/,/g, ''))
                        ...
                        amount.val(formatPrice(totalPrice));
                        JUMcukai.val(total_cukai);
                        JUMdiskaun.val(total_diskaun);
                        amountwocukai.val(amountxcukai);
                        calculateGrandTotal();
                        ...
                        //    //$(row.node()).find('input[name="price"]').val(formatPrice(totalPrice));
                        //    debugger;
                        //    if (keyName == "price" ) {

                        //        formatPriceKeyUp(this)
                        //    }
                        //    if (keyName == "cukai" || keyName == "diskaun") {
                        //        formatPriceKeyUp(this)
                        //    }
                    ...
                    async function calculateGrandTotal() {
                        ...
                        $('.amount').each(function (index, obj) {
                            curTotal += parseFloat(NumDefault($(obj).val().replace(/,/g, '')));
                        });
                        $('.JUMcukai').each(function (index, obj) {
                            curCukai += parseFloat(NumDefault($(obj).val().replace(/,/g, '')));
                        });

                        $('.JUMdiskaun').each(function (index, obj) {
                            curDiskaun += parseFloat(NumDefault($(obj).val().replace(/,/g, '')));
                        });

                        $('.amountwocukai').each(function (index, obj) {
                            curwoCukai += parseFloat(NumDefault($(obj).val().replace(/,/g, '')));
                        });
                    ...
                    async function setValueToRow_Transaksi(row, orderDetail) {
                        ...
                        var totalPrice = NumDefault(quantity.val().replace(/,/g, '')) * NumDefault(kdr_hrga.val().replace(/,/g, ''))
                        console.log("totalPrice", totalPrice)
                        var amauncukai = NumDefault(cukai.val()) / 100
                        console.log("amauncukai", amauncukai)
                        var total_cukai = totalPrice * amauncukai
                    ...
                    async function initCarianVot(id) {
                        ...
                        $('#' + id).dropdown({
                            ...
                            onChange: function (value, text, $selectedItem) {
                                ...
                                //curTR.find('td:eq(' + 1 + ')').html('<span class="spn-dtl"  title="' + $($selectedItem).data("coltambah2") + '">' + $($selectedItem).data("coltambah6") + '</span>') //kw
                                //curTR.find('td:eq(' + 2 + ')').html('<span class="spn-dtl"  title="' + $($selectedItem).data("coltambah3") + '">' + $($selectedItem).data("coltambah7") + '</span>') //ko
                                //curTR.find('td:eq(' + 3 + ')').html('<span class="spn-dtl"  title="' + $($selectedItem).data("coltambah4") + '">' + $($selectedItem).data("coltambah8") + '</span>') //kp 
                                //curTR.find('td:eq(' + 4 + ')').html('<span class="spn-dtl" title="' + $($selectedItem).data("coltambah1") + '">' + $($selectedItem).data("coltambah5") + '</span>') //ptj
