...
Public Class Order_Resit
    ...
    Public Property MklmtBayaran As List(Of OrderDetail_MklmtBayaran)
...
Public Class OrderDetail_MklmtBayaran
    Public Property NoDok As String
    Public Property KodBank As String
    Public Property NoRujukan As String
    Public Property TKhBayar As String
    Public Property JumBayar As String
    Public Property CwgnBank As String
    Public Property JenCek As String
End Class
