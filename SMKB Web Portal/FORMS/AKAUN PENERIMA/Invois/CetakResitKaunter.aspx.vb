...
Public Class CetakResitKaunter
    Inherits System.Web.UI.Page
    Dim dbconn As New DBKewConn

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Dim noResit As String = Request.QueryString("bilid")
        Dim noDok As String = ""
        ...
        If noResit <> "" Then
            ...
            Using dt = ds.Tables(0)
                If dt.Rows.Count > 0 Then
                    ...
                    txtJumlah.InnerText = dt.Rows(0)("Total_Jumlah_Bayar").ToString
                    'txtJumlahCukai.InnerText = dt.Rows(0)("Total_Cukai").ToString

                    Dim totalJumlahBayar As Decimal = Convert.ToDecimal(dt.Rows(0)("Kredit"))
                    Dim PercentageCukai As Decimal = Convert.ToDecimal(dt.Rows(0)("Total_Cukai")) / 100

                    Dim totalCukai As Decimal = Math.Round(PercentageCukai * totalJumlahBayar, 2)

                    'If discount Then based On the total price
                    Dim PercentageDiskaun As Decimal = Convert.ToDecimal(dt.Rows(0)("Total_Diskaun")) / 100
                        Dim TotalDiskaun As Decimal = Math.Round(PercentageDiskaun * totalJumlahBayar, 2)

                        txtJumlahDiskaun.InnerText = TotalDiskaun.ToString

                        txtJumlahCukai.InnerText = totalCukai.ToString

                        txtJumlahDiskaun.InnerText = dt.Rows(0)("Total_Diskaun").ToString
