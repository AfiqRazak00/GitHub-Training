    ...
    <contenttemplate>
        ...
        <div id="PermohonanTab" class="tabcontent" style="display: block">
            ...
            <div class="container-fluid mt-3">
                <ul class="nav nav-tabs" id="subTab" role="tablist">
                    <li class="nav-item" role="presentation" onclick="subTabChange(event)" style="cursor: pointer">
                        <a class="nav-link active" aria-current="page" data-tab="T">Transaksi</a>
                    </li>
                    <li class="nav-item" role="presentation" onclick="subTabChange(event)" style="cursor: pointer">
                        <a class="nav-link " tabindex="-1" data-tab="MB" aria-disabled="true">Maklumat Bayaran</a>
                    </li>
                </ul>
            </div>
            <br />
            <div class="modal-body ">
                <div class="row">
                    <div class="col-md-12">
                        <div id="divtransaksi" class="transaction-table table-responsive">
                            <table class="table table-striped" id="tblData" style="width: 100%;">
                                <thead>
                                    <tr style="width: 100%; text-align: center">
                                        ...
                                        <th scope="col" style="width: 7%; display: none">Debit </th>
                                        <th scope="col" style="width: 7%">Jumlah </th>
                                        <th scope="col" style="width: 3%">Tindakan</th>
                                    </tr>
                                </thead>
                                <tbody id="tableID" style="overflow: auto; height: 50px">
                                    <tr style="display: none; width: 100%; overflow: auto">
                                        ...
                                        <td>
                                            <input type="text"
                                                ...
                                                style="text-align: center;" oninput="validateInput(event)" />
                                        </td>
                                        <td>
                                            <input type="text"
                                        ...
                                        <td style="display: none">
                                            <input class="form-control underline-input debit"
                                                id="debit" name="debit"
                                                style="text-align: right; display: none" placeholder="0.00" readonly />
                                        </td>
                                        <td>
                        ...
                        <div id="divbayaran" style="display: none">
                            <table class="table table-striped" id="tblDataTxn" style="width: 100%;">
                                <thead>
                                    <tr style="width: 100%; text-align: center">
                                        <th scope="col" style="width: 20%">Bank</th>
                                        <th scope="col" style="width: 20%">No. Rujukan</th>
                                        <th scope="col" style="width: 10%">Tarikh</th>
                                        <th scope="col" style="width: 10%">Jumlah</th>
                                        <th scope="col" style="width: 25%">Cawangan</th>
                                        <th scope="col" style="width: 10%">Jenis Cek</th>
                                ...
                                <tbody id="">
                                    <tr style="display: none;">
                                        <td>
                                            <select class="ui search dropdown bank-carian-list" name="ddlBankTxn" id="ddlBankTxn">
                                            </select>
                                        </td>
                                        <td>
                                            <input type="text" class="form-control txtNoRujukanTxn" id="txtNoRujukanTxn" name="txtNoRujukanTxn" />
                                        </td>
                                        <td>
                                            <input type="date" class="form-control txtTkhTxn" id="txtTkhTxn" name="txtTkhTxn" />
                                        </td>
                                        <td>
                                            <input type="text" class="form-control txtJumlahTxn" id="txtJumlahTxn" name="txtJumlahTxn" style="text-align: center" placeholder="0.00" />
                                        </td>
                                        <td>
                                            <textarea class="form-control txtCwgnTxn" type="text" id="txtCwgnTxn" name="txtCwgnTxn" rows="1"></textarea>
                                        </td>
                                        <td>
                                            <select class="ui search dropdown cek-carian-list" name="JnsCek" id="JnsCek">
                                            </select>
                                        </td>
                                        <td class="tindakan">
                                            <button class="btn btnDeleteTxn">
                                                <i class="fa fa-trash" style="color: red;"></i>
                                            </button>
                                        </td>
                                    </tr>
                        ...
                        <div id="divBayaranTunaiTele" style="display: none;">
                            <table class="" style="width: 30%; border: none">

                                <tr style="border-top: none">
                                    <td class="pr-2" style="text-align: Left; font-size: large">Jumlah Bayaran(RM)
                                    </td>
                                    <td style="text-align: Left">
                                        <input class="form-control underline-input" id="jumBayaran"
                                            name="total"
                                ...
                                <tr style="border-top: none">
                                    <td class="pr-2" style="text-align: Left; font-size: large">Wang Terima(RM)
                                    </td>
                                    <td style="text-align: Left">
                                        <input class="form-control underline-input" id="jumTerimaan"
                                            name="total"
                                            style="text-align: Left; font-size: medium; font-weight: bold"
                                            placeholder="0.00" readonly />
                                    </td>
                                ...
                                <tr style="border-top: none">
                                    <td class="pr-2" style="text-align: Left; font-size: large">
                                        <label id="lblNoEft" style="font-weight: normal;">No. ETF</label>
                                    </td>
                                    <td style="text-align: Left">
                                        <input class="form-control underline-input" id="noEtf"
                                            name="total"
                                            style="text-align: Left; font-size: medium; font-weight: bold"
                                            placeholder="" />
                                    </td>
                        ...
                        <%--<div id="divBayaranTunaiTele" style="display: none;">
                            <div>
                              ...
                              <input id="jumBayaran" nama="jumBayaran" />
                                <span style="font-family: roboto!important; font-size: 18px!important"><b>Jumlah Bayaran :RM <span id="jumBayaran" style="margin-right: 5px">0.00</span></b></span>
                            </div>
                            <div>--%>
                                <%-- <label> Jumlah Terimaan : </label>
                              <input id="jumTerimaan" nama="jumTerimaan" />
                                <%--<span style="font-family: roboto!important; font-size: 18px!important"><b>Jumlah Terimaan :RM <span id="jumTerimaan" style="margin-right: 5px">0.00</span></b></span>
                            </div>
                            <div>
                                <label id="lblNoEft" name="lblNoEft">No. ETF : </label>
                                <input id="noEtf" nama="noEtf" />
                            </div>
                        </div>--%>

                        <%--<div id="divBayaranPinTele" style="display: none">
                            <table class="table table-striped" id="tblDataTxnTele" style="width: 100%;">
                                <thead>
                                    <tr style="width: 100%; text-align: center">
                                        <th scope="col" style="width: 20%">Bank</th>
                                        <th scope="col" style="width: 20%">Bank</th>
                                ...
                                <tbody id="">
                                    <tr style="display: none;">
                                        <td>
                                            <input type="text" class="form-control txtJumlahTunai" id="txtJumlahTunai" name="txtJumlahTunai" style="text-align: center" placeholder="0.00" />
                                        </td>
                                        <td>
                                            <input type="text" class="form-control txtJumTunaiDibayar" id="txtJumTunaiDibayar" name="txtJumTunaiDibayar" style="text-align: center" placeholder="0.00" />
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <div class="btn-group float-left">
                                        ...
                                        <div id="btnAddRowTxn" style="display: none">
                                            <button type="button"
                                                class="btn btn-warning btnAddRowTxn" data-val="1"
                                                value="1">
                                                <b>+ Tambah</b></button>
                                            <button type="button" id="btntxn"
                                                class="btn btn-warning dropdown-toggle dropdown-toggle-split btnAddRowTxn"
                                                data-toggle="dropdown" aria-haspopup="true"
                                                aria-expanded="false" style="display: none">
                                                <span class="sr-only btnAddRowTxn">Toggle Dropdown</span>
                                            </button>
                                            <div class="dropdown-menu btnAddRowTxn" style="display: none">
                                                <a class="dropdown-item btnAddRowTxn five"
                                                    value="5" data-val="5" id="btnAddTxn5">Tambah
                                                    5</a>
                                                <a class="dropdown-item btnAddRowTxn" value="10"
                                                    data-val="10">Tambah 10</a>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="modal fade" id="permohonan" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalCenterTitle">Senarai Resit</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                                    ...
                                    <div class="container w-full">
                                        ...
                                        <div class="form-group d-flex align-items-center w-full">
                                            <div class="col-4 d-flex justify-content-end">
                                                <label for="txtNoPenghutang" class="form-label">
                                                    No.
                                                        Akaun:
                                                </label>
                                            </div>
                                        ...
                                        <div class="form-group d-flex align-items-center">
                                            <div class="col-4 d-flex justify-content-end">
                                                <label for="ddlAddKategoriPenghutang"
                                                    ...
                                                    Kategori Penghutang: <span class="text-danger">*</span>
                                                </label>
                                            </div>
                                            <div class="col-6">
                                                <select id="ddlAddKategoriPenghutang"
                                                    class="ui search dropdown"
                                                    name="ddlAddKategoriPenghutang">
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group d-flex align-items-center"
                                        ...
                                        <div class="form-group d-none align-items-center"
                                            id="sectionStaf">
                                            <div class="col-4 d-flex justify-content-end">
                                                <label for="ddlNoStaf" class="form-label">
                                                    No. Staf: <span class="text-danger">*</span>
                                                </label>
                                            </div>
                                            <div class="col-6">
                                        ...
                                        <div class="form-group d-none align-items-center"
                                            id="sectionPelajarUG">
                                            <div class="col-4 d-flex justify-content-end">
                                                <label for="ddlNoMatrikUG" class="form-label">
                                                    No. Matrik: <span class="text-danger">*</span>
                                                </label>
                                            </div>
                                            <div class="col-6">
                                        ...
                                        <div class="form-group d-none align-items-center"
                                            id="sectionPelajarPG">
                                            <div class="col-4 d-flex justify-content-end">
                                                <label for="ddlNoMatrikPG" class="form-label">
                                                    No. Matrik: <span class="text-danger">*</span>
                                                </label>
                                            </div>
                                            <div class="col-6">
                                        ...
                                        <div class="form-group d-none align-items-center"
                                            id="sectionPelajarPH">
                                            <div class="col-4 d-flex justify-content-end">
                                                <label for="ddlNoMatrikPH" class="form-label">
                                                    No.
                                                        Matrik:</label>
                                            </div>
                                            <div class="col-6">
                                        ...
                                        <div class="form-group d-none align-items-center"
                                            id="sectionStafBank">
                                            <div class="col-4 d-flex justify-content-end">
                                                <label for="txtStafBankName" class="form-label">
                                                    Nama
                                                        Bank:
                                                </label>
                                            </div>
                                        ...
                                        <div class="form-group d-flex align-items-center">
                                            <div class="col-4 d-flex justify-content-end">
                                                <label for="txtNoAkaunBank" class="form-label">
                                                    No. Akaun
                                                        Bank:</label>
                                            </div>
                                            <div class="col-6">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group d-flex w-full">
                                ...
                                <div class="border rounded col-8" role="textbox" contenteditable="true" id="txtMesej">
                                    ...
                                    <br>
                                    <p>
                                        E-mel ini adalah pemakluman mengenai Bil Tuntutan yang didaftarkan atas nama Encik / Puan
                                            (<span id="lblEmailBilTuntutan" class="font-weight-bold"></span>),
                                    </p>
                                    <br>
                                    <p>
                                        Sila jelaskan bayaran sebelum tarikh tamat. Sila abaikan e-emel ini jika bayaran telah
                                            dibuat.
                                    </p>
                                    <br>
                                    <p>
                                        Sekiranya terdapat sebarang pertanyaan, sila hubungi kami di talian +606-3316871 [Waktu
                                            Operasi 8:00 pagi hingga 5:00 petang, Isnin hingga Jumaat]
                                    </p>
                                    <br>
                                    <br>
                                    <br>
            ...
            <script>
                ...
                function showFormTab() {
                    ...
                    if (tab == "T") {
                        ...
                        $("#divtransaksi").show()
                        $("#divbayaran").hide()
                        $("#divBayaranTunai").hide()
                        $("#divBayaranTunaiTele").hide()
                        $("#btnAddRowTxn").hide()
                        $("#btnAddRow").show()
                    }
                    if (tab == "MB") {
                        ...
                        if ($('#ddlMod').val() === "01") {
                            ...
                            $("#divbayaran").hide()
                            $("#divBayaranTunai").hide()
                            $("#divBayaranTunaiTele").show()
                            $("#lblNoEft").hide()
                            $("#noEtf").hide()
                            $("#btnAddRowTxn").hide()
                            $("#btnAddRow").hide()
                        } else if ($('#ddlMod').val() === "05") {
                            $("#divtransaksi").hide()
                            $("#divbayaran").hide()
                            $("#divBayaranTunaiTele").show()
                            $("#lblNoEft").show()
            ...
            <script type="text/javascript">
                ...
                $(document).ready(function () {
                    tbl = $("#tblDataSenarai").DataTable({
                        ...
                        "ajax": {
                            "url": "InvoisWS.asmx/LoadOrderRecord_SenaraiTransaksiResit",
                            "method": 'POST',
                ...
                $('.btnCetak').click(async function () {
                    ...
                    var txtbil = $('#txtnoinv').val();
                    console.log(txtbil);
                    window.open('<%=ResolveClientUrl("~/FORMS/AKAUN PENERIMA/Invois/CetakResitKaunter.aspx")%>?bilid=' + txtbil, '_blank', params);
                ...
                $('#ddlBankUTeM').dropdown({
                    ...
                    fullTextSearch: true,
                    apiSettings: {
                        url: 'InvoisWS.asmx/GetKodBankList?q={query}',
                        method: 'POST',
                        dataType: "json",
                        contentType: 'application/json; charset=utf-8',
                        cache: false,
                ...
                $('.btnYaBil').click(async function () {
                    ...
                    // Maklumat bayaran Properties in Array
                    //var newMklmtBayaran = {
                    //}
                ...
                $('.btnYaSubmitBil').click(async function () {
                    ...
                    var newOrder = {
                        order: {
                            ...
                            bankutem: $('#ddlBankUTeM').val(),
                            OrderDetails: [],
                            MklmtBayaran: []
                        }
                    }

                    /*harga = parseFloat($('.price').val().replace(/,/g, ''));*/
                    ...
                    $('.vot-carian-list').each(function (index, obj) {
                        if (index > 0) {
                            ...
                            var orderDetail = {
                                ...
                                details: $('.details').eq(index).val(),
                                quantity: $('.quantity').eq(index).val(),
                                price: parseFloat($('.price').eq(index).val().replace(/,/g, '')),
                    ...
                    JumTerimaan = parseFloat($('#jumTerimaan').val().replace(/,/g, ''));
                    ...
                    if (newOrder.order.modterima === "01") {
                        maklumatBayaran.TkhBayar = getCurrentDate();
                        maklumatBayaran.JumBayar = JumTerimaan.toFixed(2);
                        newOrder.order.MklmtBayaran.push(maklumatBayaran);
                    } else if (newOrder.order.modterima === "05") {
                        maklumatBayaran.TkhBayar = getCurrentDate();
                        maklumatBayaran.JumBayar = JumTerimaan.toFixed(2);
                        maklumatBayaran.NoRujukan = $('#noEtf').val();
                        newOrder.order.MklmtBayaran.push(maklumatBayaran);
                    } else {
                        // Maklumat Bayaran properties
                        $('.bank-carian-list').each(function (index, obj) {
                            if (index > 0) {
                                var tcell = $(obj).closest("td");
                                var mklmtBayaran = {
                                    NoDok: $('#txtnoinv').val(),
                                    Kodbank: $(obj).dropdown("get value"),
                                    NoRujukan: $('.txtNoRujukanTxn').eq(index).val(),
                                    TKhBayar: $('.txtTkhTxn').eq(index).val(),
                                    JumBayar: $('.txtJumlahTxn').eq(index).val(),
                                    CwgnBank: $('.txtCwgnTxn').eq(index).val(),
                                    JenCek: "",
                                    id: $(tcell).find('.data-id').val()
                                };

                                $('.cek-carian-list').each(function (index, obj) {
                                    if (index > 0) {
                                        var tcell = $(obj).closest("td");
                                        var JenisCek = {
                                            Cek: $(obj).dropdown("get value"),
                                            id: $(tcell).find('.data-id').val()
                                        };

                                        if (JenisCek.Cek !== null) {
                                            /*newOrder.order.MklmtBayaran[index - 1].JenCek = JenisCek.Cek;*/
                                            mklmtBayaran.JenCek = JenisCek.Cek;
                                        } else {
                                            return;
                                        }
                                ...
                                console.log($('#jumTerimaan').html());
                                console.log($('#ddlMod').val());

                                if (mklmtBayaran.kodbank === "" || mklmtBayaran.TkhBayar === "" || mklmtBayaran.JumBayar === "") {
                                    return;
                                }

                                acceptedRecord += 1;
                                newOrder.order.MklmtBayaran.push(mklmtBayaran);
                    ...
                    /*console.log(newOrder);*/
                    var result = await ajaxSubmitOrder(newOrder);
                    //alert(result.Message);
                    console.log(result)
                   // console.log(result.Message)
                    if (result.Status !== "5") {
                        ...
                        // open modal makluman and show message
                        $('#maklumanModalBil').modal('toggle');
                        $('#detailMaklumanBil').html("Transaksi berjaya.");
                        clearAllFields();
                        // refresh page after 2 seconds
                        setTimeout(function () {
                            tbl.ajax.reload();
                        ...
                        // open modal makluman and show message
                        $('#maklumanModalBil').modal('toggle');
                        $('#detailMaklumanBil').html("Transaksi disimpan.");
                    }
                    ////$('#orderid').val(result.Payload.OrderID)
                    /*loadExistingRecords();*/
                    await clearAllRows();
                ...
                async function clearAllRowsTxn() {
                    $('#tblDataTxn' + "> tbody > tr").each(function (index, obj) {
                        if (index > 0) {
                            obj.remove();
                        }
                    })
                    $('#ddlBankTxn').dropdown('clear');
                    $('#txtNoRujukanTxn').val("");
                    $('#txtTkhTxn').val("");
                    $('#txtJumlahTxn').val("0.00");
                    $('#txtCwgnTxn').val("");
                    $('#JnsCek').dropdown('clear');
                }
                ...
                $('.btnAddRowTxn').click(async function () {
                    var totalCloneTxn = $(this).data("val");

                    await AddRowtxn(totalCloneTxn);
                });
                ...
                $(tableID_Senarai).on('click', '.btnView', async function () {
                    ...
                    if (id !== "") {
                        ...
                        var recordTxn = await AjaxGetDtlTransaksi(id);
                        console.log(recordTxn);
                        //await clearAllRowsTxn();
                        //await AddRowTxn(null, recordTxn);
                    }
                ...
                async function rowClickHandler(id) {
                    ...
                    if (id !== "") {
                        ...
                        var recordTxn = await AjaxGetDtlTxn(id);
                        await clearAllRowsTxn();
                        await AddRowtxn(null, recordTxn);
                    }
                }
                ...
                async function setValueToRow_HdrJurnal(orderDetail) {
                    ...
                    var ddlMod = $('#ddlMod')
                    var ddlSearchMod = $('#ddlMod')
                    var ddlTextMod = $('#ddlMod')
                    var selectObj_ModBayaran = $('#ddlMod')
                    $(ddlMod).empty()
                    $(ddlMod).dropdown('set selected', orderDetail.Mod_Terima)
                    selectObj_ModBayaran.append("<option value = '" + orderDetail.Mod_Terima + "'>" + orderDetail.ButiranMod + "</option>");

                    var ddlBankUtem = $('#ddlBankUTeM')
                    var ddlSearchBank = $('#ddlBankUTeM')
                    var ddlTextModBank = $('#ddlBankUTeM')
                    var selectObj_BankUtem = $('#ddlBankUTeM')
                    $(ddlBankUtem).empty()
                    $(ddlBankUtem).dropdown('set selected', orderDetail.Kod_Bank);
                    selectObj_BankUtem.append("<option value = '" + orderDetail.Kod_Bank + "'>" + orderDetail.BankUtem + "</option>")
                ...
                async function AjaxGetRecordHdrJurnal(id) {
                    ...
                    try {
                        ...
                        const response = await fetch('InvoisWS.asmx/LoadHdrInvoisKaunter', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json'
                            },
                ...
                async function AjaxGetRecordJurnal(id) {
                    ...
                    try {
                        ...
                        const response = await fetch('InvoisWS.asmx/LoadRecordInvoiskaunter', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json'
                            },
                ...
                async function AjaxGetDtlTxn(id) {
                    try {

                        const response = await fetch('InvoisWS.asmx/LoadDtlTxn', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json'
                            },
                ...
                async function AddRow(totalClone, objOrder) {
                    ...
                    while (counter <= totalClone) {
                        ...
                        $(row).find(".vot-carian-list").attr("id", newCarianVot);
                        ...
                        //console.log("newCarianVot" + newCarianVot)
                ...
                async function AddRowtxn(totalCloneTxn, objOrder) {
                    //alert("haii")
                    var counter = 1;
                    var table = $('#tblDataTxn');

                    if (objOrder !== null && objOrder !== undefined) {
                        totalCloneTxn = objOrder.Payload.length;
                    }

                    totalItems = 0;

                    while (counter <= totalCloneTxn) {
                        //alert("counter" + counter + "totalCloneTxn " + totalCloneTxn)
                        curNumObject1 += 1;
                        var newbank = "ddlBankTxn" + curNumObject1;
                        var newcek = "JnsCek" + curNumObject1;
                        //console.log($(newBank));
                        var row = $('#tblDataTxn tbody>tr:first').clone();
                        /*var rows = $('#tblDataTxnTunai tbody>tr:first').clone();*/

                        $(row).find(".bank-carian-list").attr("id", newbank);
                        $(row).find(".cek-carian-list").attr("id", newcek);
                        ...
                        $('#tblDataTxn tbody').append(row);
                        /*$('#tblDataTxnTunai tbody').append(rows);*/
                        await initBank(newbank)
                        await initCek(newcek)
                        ...
                        if (objOrder !== null && objOrder !== undefined) {
                            ...
                            //await setValueToRow(row, objOrder.Payload.OrderDetails[counter - 1]);
                            if (counter <= objOrder.Payload.length) {
                                await setValueToRowTxn(row, objOrder.Payload[counter - 1]);
                ...
                async function setValueToRowTxn(row, detailTxn) {

                    /*console.log(detailTxn);*/
                    var ddlBank = $(row).find("td > .bank-carian-list");
                    var ddlSearch = $(row).find("td > .bank-carian-list > .search");
                    var ddlText = $(row).find("td > .bank-carian-list > .text");
                    var selectObj_Bank = $(row).find("td > .bank-carian-list > select");
                    $(ddlBank).dropdown('set selected', detailTxn.KodBank);
                    selectObj_Bank.append("<option value = '" + detailTxn.KodBank + "'>" + detailTxn.ButiranBank + "</option>")

                    var NoRujukan = $(row).find("td > .txtNoRujukanTxn");
                    NoRujukan.val(detailTxn.No_Rujukan);
                    var NoEtf = $('#noEtf');
                    NoEtf.val(detailTxn.No_Rujukan);
                    var Tarikh = $(row).find("td > .txtTkhTxn");
                    Tarikh.val(detailTxn.Tarikh);
                    var Jumlah = $(row).find("td > .txtJumlahTxn");
                    Jumlah.val(detailTxn.Jumlah);
                    var Cawangan = $(row).find("td > .txtCwgnTxn");
                    Cawangan.val(detailTxn.Cawangan_Bank);

                    var ddlCek = $(row).find("td > .cek-carian-list");
                    var ddlSearch = $(row).find("td > .cek-carian-list > .search");
                    var ddlText = $(row).find("td > .cek-carian-list > .text");
                    var selectObj_Cek = $(row).find("td > .cek-carian-list > select");
                    $(ddlCek).dropdown('set selected', detailTxn.KodCek);
                    selectObj_Cek.append("<option value = '" + detailTxn.KodCek + "'>" + detailTxn.JenCek + "</option>")
                ...
                async function initBank(id) {
                    $('#' + id).dropdown({
                        ...
                        onChange: function (value, text, $selectedItem) {
                            ...
                            var recordIDVotHd = curTR.find("td > .bank-carian-list");

                        },
                        apiSettings: {

                            url: 'InvoisWS.asmx/GetBankValue?q={query}',
                            method: 'POST',
                            dataType: "json",
                            contentType: 'application/json; charset=utf-8',
                            cache: false,
                ...
                async function initCek(id) {
                    $('#' + id).dropdown({
                        ...
                        onChange: function (value, text, $selectedItem) {
                            ...
                            var recordIDVotHd = curTR.find("td > .cek-carian-list");

                        },
                        apiSettings: {

                            url: 'InvoisWS.asmx/LoadJenisCekList?q={query}',
                            method: 'POST',
                            dataType: "json",
                            contentType: 'application/json; charset=utf-8',
                            cache: false,
                ...
                $('.btnHantar').click(async function () {
                    ...
                    if ($('#ddlKategoriPenghutang').val() == "" || $('#ddlUrusniaga').val() == "" || $('#ddlPenghutang').val() == "" || $('#txtTujuan').val() == "" || $('#tkhBil').val() == "" || $('#ddlBankUTeM').val() == "" || $('#ddlMod').val() == "") {
                        // open modal makluman and show message
                        $('#maklumanModalBil').modal('toggle');
