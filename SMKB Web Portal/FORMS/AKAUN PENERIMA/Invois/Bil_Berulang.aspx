...
<asp:Content ID="Content1" ContentPlaceHolderID="FormContents" runat="server">
    ...
    <contenttemplate>
                                    ...
                                    <table id="tblDataSenarai" class="table table-striped">
                                        <thead>
                                            <tr style="width: 100%">
                                                ...
                                                <th scope="col" style="width: 10%">Tarikh Bil</th>
                                        ...
                                        <tbody id=" " style="cursor: pointer; overflow: auto">
                                            <tr style="display: none" class="table-list">
                                                ...
                                                <td>
                                                    <label id="lblTkhBil" name="lblTkhBil" class="lblTkhBil"></label>
                                                </td>
                                                <td>
        ...
        <div class="modal fade" id="senaraiBilDijana" tabindex="-1" role="dialog"
            aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalCenterTitle">Senarai Bil Dijana</h5>
                    ...
                    <div class="search-filter">
                        <div class="form-row justify-content-center">
                            <div class="form-group row col-md-6">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <select id="categoryFilterBilJana" class="custom-select">
                                            <option value="" selected>Semua</option>
                                            <option value="1">Hari Ini</option>
                                            <option value="2">Semalam</option>
                                            <option value="3">7 Hari Lepas</option>
                                        ...
                                        <div class="input-group-append">
                                            <button id="Button1" runat="server" class="btn btn-outline btnSearchBilJana" type="button">
                                                <i class="fa fa-search"></i>
                                                Cari
                                            </button>
                                        </div>
                                ...
                                <div class="mt-4 d-none" id="divDatePickerBilDijana">
                                    <div class="d-flex flex-row justify-content-around align-items-center">
                                        <div class="form-group row">
                                            <label class="col-sm-3 col-form-label text-nowrap">Mula :</label>
                                            <div class="col-sm-9">
                                                <input type="date" id="txtTarikhStartBilJana" name="txtTarikhStartBilJana" class="form-control date-range-filter">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row ml-3">
                                            <label class="col-sm-3 col-form-label text-nowrap">Tamat :</label>
                                            <div class="col-sm-9">
                                                <input type="date" id="txtTarikhEndBilJana" name="txtTarikhEndBilJana" class="form-control date-range-filter">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="modal-body">
                            <div class="col-md-12">
                                <div class="transaction-table table-responsive">
                                    <table id="tblDataSenaraiBilDiJana" class="table table-striped" style="width: 99%">
                                        <thead>
                                            <tr style="width: 100%">
                                                <th scope="col" style="width: 10%">No. Bil</th>
                                                <th scope="col" style="width: 10%">Nama Penghutang</th>
                                ...
                                <div class="col-md-12">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <label class="input-group__label" for="txtNamaPenghutang">Penghutang</label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3">
                                            <input type="text" class="form-control input-group__input" id="tempoh" name="tempoh" readonly>
                                            <label class="input-group__label" for="tempoh">Tempoh</label>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <input type="text" class="form-control input-group__input" id="txtJenTempoh" name="txtJenTempoh" readonly>
                                            <input type="text" class="form-control input-group__input" id="lblJenTempoh" name="lblJenTempoh" readonly style="display: none">
                                            <label class="input-group__label" for="JenTempoh">Jenis Tempoh</label>
                                            <div style="display: none">
                                                <select id="ddlJenTempoh" class="ui search dropdown" name="ddlJenTempoh"></select>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-3">
    ...
    <script type="text/javascript">
        ...
        var tblBilJana = null
        var isClickedBilJana = false;
        $(document).ready(function () {

            tblBilJana = $("#tblDataSenaraiBilDiJana").DataTable({
                "responsive": true,
                "searching": true,
                ...
                "ajax": {
                    "url": "SenaraiBilBerulangWS.asmx/LoadOrderRecord_SenaraiBilDijana",
                    "method": 'POST',
                    ...
                    "data": function () {
                        ...
                        var startDate = $('#txtTarikhStartBilJana').val()
                        var endDate = $('#txtTarikhEndBilJana').val()
                        return JSON.stringify({
                            category_filterJana: $('#categoryFilterBilJana').val(),
                            isClickedJana: isClickedBilJana,
                            tkhMula: startDate,
                            tkhTamat: endDate
                        })
                        //akhir sini
                ...
                "columns": [
                    ...
                    { "data": "Penyedia" },
                    {
                        ...
                        render: function (data, type, row, meta) {
                            ...
                            var link = `<button id="btnCetak" runat="server" class="btn btnCetak" type="button" style="color: blue" data-dismiss="modal" data-id="${data}">
            ...
            $('#tblDataSenaraiBilDiJana').on('click', '.btnCetak', function () {
                var params = `scrollbars=no,resizable=no,status=no,location=no,toolbar=no,menubar=no,width=0,height=0,left=-1000,top=-1000`;
                var noBil = $(this).data('id');
                // Perform your action here, e.g., insert hits or trigger print
                window.open('<%=ResolveClientUrl("~/FORMS/AKAUN PENERIMA/Invois/CetakBil.aspx")%>?bilid=' + noBil, '_blank', params);
                // Add any other actions you need
            });

            $('.btnSearchBilJana').click(async function () {
                /*show_loader();*/
                isClickedBilJana = true;
                tblBilJana.ajax.reload();
            })
        });
        ...
        $("#categoryFilterBilJana").change(function (e) {
            var selectedItem = $('#categoryFilterBilJana').val()
            if (selectedItem == "6" && selectedItem !== "") {
                $('#divDatePickerBilDijana').addClass("d-flex").removeClass("d-none");
                $('#txtTarikhStartBilJana').val("")
                $('#txtTarikhEndBilJana').val("")
            }
            else {
        ...
        async function setValueToRow(row, orderDetail) {
            ...
            //console.log(jumlah_)
            if (jumlah_ !== null) {
                Jumlah.html(FormatPrice(orderDetail.Jumlah));
            } else {
                Jumlah.html(orderDetail.Jumlah);
            }
            no.html(orderDetail.No_Invois);
            Penghutang.html(orderDetail.Nama_Penghutang);
            TkhMula.html(dateStrFromSQl(orderDetail.Tkh_Mula));
            TkhTamat.html(dateStrFromSQl(orderDetail.Tkh_Tamat));
            JnsUrusNiaga.html(orderDetail.UrusNiaga);
            Tujuan.html(orderDetail.Tujuan);
            TkhMohon.html(dateStrFromSQl(orderDetail.TKHMOHON));
        ...
        async function setValueToRow_HdrJurnal(orderDetail) {
            ...
            $('#tkhBil').val(moment(orderDetail.Tkh_Bil).format('DD/MM/YYYY'))
            $('#tkhMula').val(moment(orderDetail.Tkh_Mula).format('DD/MM/YYYY'))
            $('#tkhTamat').val(moment(orderDetail.Tkh_Tamat).format('DD/MM/YYYY'))
            $('#tempoh').val(orderDetail.Tempoh_Kontrak)
            //$('#rdKontrak').val(orderDetail.Kontrak)
            $('#txtJenTempoh').val(orderDetail.JenisTempoh)
            $('#lblJenTempoh').val(orderDetail.Jenis_Tempoh)
            ...
            var ddlJenTempoh = $('#ddlJenTempoh');
            var ddlSearch = $('#ddlJenTempoh');
            var ddlText = $('#ddlJenTempoh');
            /*ddlJenTempoh.empty()*/
            var selectObj_JenTempoh = $('#ddlJenTempoh');
            $(ddlJenTempoh).dropdown('set selected', orderDetail.KodJenTempoh);
            selectObj_JenTempoh.append("<option value = '" + orderDetail.KodJenTempoh + "'>" + orderDetail.ButiranJenTempoh + "</option>");
            //console.log(orderDetail.KodJenTempoh)
            //console.log(orderDetail.ButiranJenTempoh)
            //console.log("Data ddlJenTempoh: ", $('#ddlJenTempoh').val());
