...
Public Class ParamProses
    ...
    Private Function fCreateDtKW() As DataTable
        ...
        Try
            ...
            dt.Columns.Add("Id_Hid", GetType(String))
            ...
            Dim Id_Hid As String

            Dim strSql As String = $"select nama, type, jenis, Kategori, kadar, ISNULL(CONVERT(varchar, Tarikh_Mula, 120), '-') Tarikh_Mula, 
                        ISNULL(CONVERT(varchar, Tarikh_Akhir, 120), '-') Tarikh_Akhir, Status , SMKB_Param_ProsesID from SMKB_Param_Proses"
            ...
            For i As Integer = 0 To dsKod.Tables(0).Rows.Count - 1
                ...
                Id_Hid = dsKod.Tables(0).Rows(i)(8).ToString

                dt.Rows.Add(Bil, strNama, strType, strJenis, strKategori, strKadar, strTarikhMula, strTarikhTamat, strStatus, Id_Hid)
            Next
        ...
        Try
            If e.CommandName = "Select" Then
                ...
                Dim strSql As String = $"select Master_Reference_code, Description, source_indicator, status, created_by, created_date 
                            from SMKB_Param_Proses              
                            where SMKB_Param_ProsesID = '{strKod}'"
