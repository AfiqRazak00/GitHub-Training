                            ...
                            <div class="form-group row col-md-6">
                                <div class="row">
                                    <div class="col-sm-3 col-form-label">
                                        <label for="ddlCariModul">Sila pilih Modul:</label>
                                    </div>
                                    <div class="col-sm-9">
                                    ...
                                    <div class="col-sm-3 col-form-label">
                                        <label for="ddlCariSubModul">Sila pilih Sub Modul:</label>
                                    </div>
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            ...
                                            <div style="margin-left:10px" class="input-group-append">
                                                <button id="lbtnCari" runat="server" class="btn btn-outline" type="button"><i class="fa fa-search"></i>Cari</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="box-body" align="center">
                 <asp:GridView ID="gvSubMenu" CssClass="table table-bordered table-striped grid" Width="100%" runat="server"
                    ...
                    <Columns>
                     ...
                     <asp:BoundField DataField="Nama_Sub_Menu" HeaderText="Nama Sub Menu">
                             ...
                             <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="ddlModul">Modul</label>
                                        <asp:DropDownList ID="ddlModul" runat="server" CssClass="form-control" EnableFilterSearch="true" AutoPostBack="true" OnSelectedIndexChanged="idModul_SelectedIndexChanged2" FilterType="StartsWith" style="width:100%; height:calc(1.5em + 0.75rem + 2px); line-height:1.5"></asp:DropDownList>
                                    </div>
                                    <div class="form-group">
                                        <label for="ddlSubModul">Sub Modul</label><br />
                                        <asp:DropDownList ID="ddlSubModul" runat="server" CssClass="form-control" EnableFilterSearch="true" FilterType="StartsWith" style="width:100%; height:calc(1.5em + 0.75rem + 2px); line-height:1.5"></asp:DropDownList> 
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="txtKodSubMenu">Kod Sub Menu</label>
                                                <input id="txtKodSubMenu" runat="server" type="text" class="form-control" enable="true">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="txtNamaSubMenu">Nama Sub Menu</label>
