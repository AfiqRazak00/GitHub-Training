                        ...
                        <div class="form-row justify-content-center">
                            <div class="form-group row col-md-6">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="input-group">
                                        <asp:DropDownList ID="ddlCariTahap" runat="server" DataTextField="Jen_Tahap" DataValueField="Kod_Tahap" EnableFilterSearch="true" FilterType="StartsWith" class="form-control ui fluid search dropdown selection custom-select"></asp:DropDownList>
