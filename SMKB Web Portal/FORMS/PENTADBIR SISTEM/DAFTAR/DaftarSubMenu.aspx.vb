...
Public Class DaftarSubMenu
    ...
    Protected Sub idModul_SelectedIndexChanged(sender As Object, e As EventArgs)
        ...
        fBindSubModul("")
    End Sub
    Protected Sub idModul_SelectedIndexChanged2(sender As Object, e As EventArgs)

        fCariSubModul2()

        If ddlModul.SelectedValue <> "0" Then
            ' Register JavaScript to show the modal
            ClientScript.RegisterStartupScript([GetType](), "ShowModalScript", "ShowPopup('2');", True)
        End If
        ...
        Try
            If e.CommandName = "Select" Then
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    ddlModul.SelectedValue = ddlCariModul.SelectedValue
                    ddlSubModul.SelectedValue = ddlCariSubModul.SelectedValue
    ...
    Private Sub fCariSubModul()
        ...
        End Try
    End Sub
    Private Sub fCariSubModul2()
        Try
            Dim strsql As String

            strsql = $"SELECT Kod_Sub, Nama_Sub, Dis_Sub, Nama_Icon, Urutan, Status
                    FROM SMKB_Sub_Modul
                    WHERE Status = 1 AND Kod_Modul = '" & ddlModul.SelectedValue & "' ORDER BY Urutan"
