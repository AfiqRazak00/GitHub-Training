                        ...
                        <div class="form-row justify-content-center">
                            <div class="form-group row col-md-6">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <asp:DropDownList ID="ddlCariTahapDT" runat="server" DataTextField="Jen_Tahap" DataValueField="Kod_Tahap" EnableFilterSearch="true" FilterType="StartsWith" class="form-control ui fluid search dropdown selection custom-select"></asp:DropDownList>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <asp:DropDownList ID="ddlTahapDT" runat="server" DataTextField="Jen_Tahap" DataValueField="Kod_Tahap" EnableFilterSearch="true" FilterType="StartsWith" class="form-control ui fluid search dropdown selection custom-select"></asp:DropDownList>
                                        </div>
