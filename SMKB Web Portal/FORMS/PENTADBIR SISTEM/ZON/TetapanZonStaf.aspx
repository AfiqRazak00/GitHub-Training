                            ...
                            <div class="form-group row col-md-6">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div style="margin-left:15px" class="input-group-append">
            ...
            <div class="box-body" align="center">
                 <asp:GridView ID="gvKod" CssClass="table table-bordered table-striped grid" Width="100%" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="NamaStaf" HeaderText="Nama Staf" ItemStyle-Width="25%" />
                        <asp:BoundField DataField="Status" HeaderText="Status" ItemStyle-Width="5%"  HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"/>
