<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Perlantikan.aspx.vb" Inherits="SMKB_Web_Portal.Perlantikan" %>
         ...
         <div >
            <div class=" " >
               <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalCenterTitle">Senarai Mesyuarat Perlantikan Sebut Harga / Tender Universiti</h5>
               </div>
               ...
               <div class="modal-body">
                  ...
                  <div class="form-row">
                      <div class="form-group col-md-6">
                        <label class="input-group__label"><u>Senarai Proses Perlantikan</u></label>
                     </div>
                     <br /><br />
                     <div class="col-md-12">
                        <div class="transaction-table table-responsive">
                  ...
                  <div class="form-row">
                     <div class="form-group col-md-6">
                        <label class="input-group__label"><u>Senarai Kehadiran & Pengesahan Perlantikan</u></label>
                     </div>
                     <br /><br />
                     <div class="col-md-12">
                        <div class="transaction-table table-responsive">
         ...
         <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl" style="max-width: 80%;" role="document">
            <div class="modal-content">
               <div class="modal-header modal-header--sticky">
                  ...
                  <h5 class="modal-title">Ringkasan Perlantikan</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                  </button>
               </div>
                              ...
                              <table id="tblSenaraiPetender" class="table table-striped" style="width: 100%">
                                 <thead class="fix-hade">
                                    <tr style="background-color: #FFC83D">
                                       ...
                                       <th style="width: 5%; text-align: center">Keputusan Syor</th>
                                       <th style="width: 10%; text-align: center">Ulasan Pengesyoran</th>
                                       <th style="width: 5%; text-align: center">Peratus Am</th>
                                       <th style="width: 5%; text-align: center">Peratus Teknikal</th>
                                       <th style="width: 5%; text-align: center">Syor Lantik</th>
                                       <th style="text-align: center">Ulasan Lantik</th>
               ...
               <div class="col text-center m-3">
                  <button type="button" class="btn btn-secondary btnSimpanLantik" data-placement="bottom" title="Simpan" id="btnSimpanLantik">Simpan</button>
               </div>
            </div>
         </div>
      </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            tbl = $("#tblKelulusan").DataTable({
                ...
                "ajax": {
                    url: '<%= ResolveClientUrl("~/FORMS/PEROLEHAN/pembuka.asmx/LoadSenaraiLantik")%>',
                    type: 'POST',
        ...
        $(document).ready(function () {
            tblSyor = $("#tblSenaraiPetender").DataTable({
                ...
                stateSave: true,
                "ajax": {
                    "url": '<%= ResolveClientUrl("~/FORMS/PEROLEHAN/pembuka.asmx/GetPenilaian_Perlantikan") %>',
                ...
                "columns": [
                    ...
                    {   //SYOR PSYOR TICK
                        ...
                        "render": function (data, type, row, meta) {
                            ...
                            let checked = (row.Keputusan_Syor === '1') ? 'checked' : '';
                            let disabled = (row.Keputusan_Syor === '1') ? 'disabled' : '';
                            return `<input type = 'checkbox' class = 'chksyorPengesyoran' ${checked} ${disabled}/> `;
                        },
                    },
                    {   //SYOR P ULASAN SYOR
                        "data": "Ulasan_Syor",
                    ...
                    {   //SYOR TICK
                        ...
                        "render": function (data, type, row, meta) {
                            ...
                            return `<input type = 'checkbox' class = 'chkpilihLantik'/> `;
                        },
                    },
                    {   //ULASAN SYOR
                        "data": null,
                        "width": "10%", "className": "text-center smaller-font",
                        "render": function (data, type, row, meta) {
                            if (data !== null && data.Ulasan_Lantik !== null) {
                                return `<textarea rows="3" cols="30" class="txtUlasanLantik" id="txtUlasanLantik" name="txtUlasanLantik">${data.Ulasan_Lantik}</textarea><input class = 'kodPembuka' id='kodPembuka' type="hidden" value='${data.Kod_Pembuka}'/><input class = 'kodSyarikat' id='kodSyarikat' type="hidden" value='${data.Kod_Syarikat}'/><input class = 'noMohonValue' id='noMohonValue' type="hidden" value='${data.No_Mohon}'/>`;
                            } else {
                                return `<textarea rows="3" cols="30" class="txtUlasanLantik" id="txtUlasanLantik" name="txtUlasanLantik"></textarea><input class = 'kodPembuka' id='kodPembuka' type="hidden" value='${data.Kod_Pembuka}'/><input class = 'kodSyarikat' id='kodSyarikat' type="hidden" value='${data.Kod_Syarikat}'/><input class = 'noMohonValue' id='noMohonValue' type="hidden" value='${data.No_Mohon}'/>`;
                            }
                        }
                    },
                    { // BUKU 1
            ...
            $('#tblSenaraiPetender tbody').on('click', 'td:nth-child(18)', function () {
            ...
            $('#tblSenaraiPetender tbody').on('click', 'td:nth-child(19)', function () {
                var rowData = tblSyor.row($(this).closest('tr')).data(); // Get data of the clicked row
        ...
        $('#btnSimpanLantik').click(async function (evt) {
            evt.preventDefault();
            ...
            $('.chkpilihLantik').each(async function (ind, obj) {
                var chkLantik = obj.checked ? '1' : '0'; // Check if obj is checked

                // Retrieve other values
                var kodPembukaValue = $('.kodPembuka').eq(ind).val();
                var ulasanLantikValue = $('.txtUlasanLantik').eq(ind).val();
                ...
                console.log("ulasanLantikValue=,", ulasanLantikValue);

                var newLantikList = {
                    Perolehan_Lantik: {
                        txtUlasanLantik: ulasanLantikValue,
                        noMohonValue: noMohonValueValue,
                        kodPembuka: kodPembukaValue,
                        chkLantik: chkLantik, // Include Keputusan_Syor in the object
                    }
                };

                try {
                    var result = JSON.parse(await beginSaveLantik(newLantikList));
                ...
                //console.log("result111=,", newLantikList)
                //if (result.Status === true) {
        ...
        async function beginSaveLantik(Perolehan_Lantik) {
            return new Promise((resolve, reject) => {
                $.ajax({
                    type: "POST",
                    url: '<%= ResolveClientUrl("~/FORMS/PEROLEHAN/pembuka.asmx/SimpanLantikDetail") %>',
                   contentType: "application/json; charset=utf-8",
                   dataType: "json",
                   data: JSON.stringify(Perolehan_Lantik),
        ...
        async function beginSaveJawatanKuasaListDetail(Perolehan_Mesyuarat_JKD) {
            return new Promise((resolve, reject) => {
                $.ajax({
                    url: '<%= ResolveClientUrl("~/FORMS/PEROLEHAN/pembuka.asmx/SimpanFlag_Perlantikan") %>',
                    method: 'POST',
