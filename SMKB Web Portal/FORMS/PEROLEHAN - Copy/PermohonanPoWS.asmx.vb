...
Public Class PermohonanPoWS
    ...
    Private Function InsertNewOrder(txtNoMohon As String, lblTarikhPO As String, lblStatus1 As String, ddlTahun As String, txtTujuan As String, txtSkop As String, ddlkategoriPO As String, ddlPTJPemohon As String, txtTkh As String, txtAmaun As String, txtJustifikasi As String, ddlListPtj As String, txtTarikh_Mula_Perolehan As String, txtTempoh As String, txtJenis_tempoh As String, txtTarikh_Tamat_Perolehan As String)
        Dim db As New DBKewConn
        Dim query As String = "INSERT INTO SMKB_Perolehan_Permohonan_Hdr (No_Mohon, Tarikh_Mohon, Status_Dok, Tahun_Perolehan, Tujuan, Skop, Jenis_Barang, Kod_Ptj_Mohon, Id_Pemohon, Perolehan_Terdahulu, Justifikasi, Bekal_Kepada,Tarikh_Mula,Tempoh,Jenis_Tempoh,Bekal_Sebelum)
        VALUES(@txtNoMohon, @lblTarikhPO, @lblStatus1, @ddlTahun, @txtTujuan, @txtSkop, @ddlkategoriPO, @ddlPTJPemohon, @txtPemohon, @txtAmaun, @txtJustifikasi, @Bekal_Kepada,@Tarikh_Mula,@Tempoh,@Jenis_Tempoh,@Bekal_Sebelum)"
        Dim param As New List(Of SqlParameter)
    ...
    Private Function Get_SenaraiPerolehan(category_filter As String, tkhMula As DateTime, tkhTamat As DateTime) As DataTable
        ...
        Dim query = "SELECT * FROM (
	        ...
	        where (a.Status_Dok='03' or a.Status_Dok='04' or (a.Status_Dok='29' and a.Flag_PenentuanTeknikal='1') or (a.Status_Dok='30' and a.Flag_PenentuanTeknikal='0')) and c.Kod_Modul='02' and id_pemohon= @idpengguna " & tarikhQuery & " 
        ) mainTbl"
