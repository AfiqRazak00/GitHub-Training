<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="bendahari.aspx.vb" Inherits="SMKB_Web_Portal.bendahari" %>
            ...
            <div>
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalCenterTitle">Individu</h5>
                    </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-xl modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    <div class="modal-header modal-header--sticky">
                        <h5 class="modal-title">Maklumat Permohonan Perolehan</h5>
        ...
        <script type="text/javascript">
            ...
            async function setMohonID() {
                return new Promise((resolve, reject) => {
                    $.ajax({
                        type: 'POST',
                        url: '<%= ResolveClientUrl("~/FORMS/PEROLEHAN/PERTANYAAN/pertanyaan.asmx/SetNoMohon") %>',
            ...
            $(document).ready(function () {
                ...
                tbl = $("#tblSenaraiPerolehan").DataTable({
                    ...
                    "ajax": {
                        url: '<%= ResolveClientUrl("~/FORMS/PEROLEHAN/PERTANYAAN/pertanyaan.asmx/Load_SenaraiPermohonanBendahari") %>',
                        method: 'POST',
                        "contentType": "application/json; charset=utf-8",
                        "dataType": "json",
