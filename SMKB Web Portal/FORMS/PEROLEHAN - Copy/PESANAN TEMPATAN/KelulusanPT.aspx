<%@ Page Title="" Language="vb" Async="true" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="KelulusanPT.aspx.vb" Inherits="SMKB_Web_Portal.KelulusanPT" %>
            ...
            <div>
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalCenterTitle">KELULUSAN BENDAHARI</h5>
                    </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-xl modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    <div class="modal-header modal-header--sticky">
                        <h5 class="modal-title">KELULUSAN BENDAHARI</h5>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                tbl = $("#tblSenaraiPerolehan").DataTable({
                    ...
                    "ajax": {
                        url: '<%= ResolveClientUrl("~/FORMS/PEROLEHAN/PESANAN TEMPATAN/PesananTempatanWS.asmx/Load_LulusPtUniversiti") %>',
                        method: 'POST',
            ...
            $('.btnLulusPt').off('click').on('click', async function () {
                ...
                $('#registerPT').off('click').on('click', async function () {
                    ...
                    try {
                        var result = (await ajaxLulusPesananTempatan(txtNoMohon, NoPt, kPemiutang,rowDataArray));
            ...
            async function ajaxLulusPesananTempatan(txtNoMohon, NoPt, kPemiutang, rowDataArray) {
                return new Promise((resolve, reject) => {
                    $.ajax({
                        "url": '<%= ResolveClientUrl("~/FORMS/PEROLEHAN/PESANAN TEMPATAN/PesananTempatanWS.asmx/UpdateLulusPtOlehBendahari") %>',
                        method: 'POST',
