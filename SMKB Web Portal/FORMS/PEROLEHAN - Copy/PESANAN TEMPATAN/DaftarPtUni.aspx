<%@ Page Title="" Async="true" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="DaftarPtUni.aspx.vb" Inherits="SMKB_Web_Portal.DaftarPtUni" %>
    ...
    <div class="tabcontent" style="display: block">
            ...
            <div class="modal-dialog modal-dialog-centered modal-xl modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    <div class="modal-header modal-header--sticky">
                        <h5 class="modal-title">Daftar Pesanan Tempatan Universiti</h5>
                            ...
                            <div class="col-md-12">
                                <div class="form-row">
                                   <div class="form-group col-md-6">
                                    ...
                                    <input class="" id="idSyarikat" type="hidden" />
                                    <input class="" id="kodSyarikat" type="hidden" />
                                    <input class="" id="kodPemiutang" type="hidden" />
        ...
        <div class="modal fade" id="saveConfirmationModal10" tabindex="-1" role="dialog" aria-labelledby="saveConfirmationModalLabel" aria-hidden="true">
            <div class="modal-dialog " role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="saveConfirmationModalLabel10">Daftar Pesanan Tempatan Universiti</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                tbl = $("#tblSenaraiPerolehan").DataTable({
                    ...
                    "ajax": {
                        url: '<%= ResolveClientUrl("~/FORMS/PEROLEHAN/PESANAN TEMPATAN/PesananTempatanWS.asmx/Load_DaftarPtUni") %>',
                        method: 'POST',
            ...
            $('.btnDaftarPT').off('click').on('click', async function () {
                ...
                tblSpek.rows().every(function () {
                    ...
                    var Kadar_Harga = rowData.Harga_Seunit;
            ...
            async function ajaxSavePesananTempatan(DaftarPt1, idMohonDtlArray) {
                return new Promise((resolve, reject) => {
                    $.ajax({
                        "url": '<%= ResolveClientUrl("~/FORMS/PEROLEHAN/PESANAN TEMPATAN/PesananTempatanWS.asmx/DaftarPtUniversiti") %>',
                        method: 'POST',
