<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="kelulusanptj.aspx.vb" Inherits="SMKB_Web_Portal.kelulusanptj" %>
    ...
    <div class="tabcontent" style="display: block">
            ...
            <div>
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalCenterTitle">Kelulusan Ketua PTJ</h5>
                    </div>
      ...
      <div class="modal fade" id="resultModal11" tabindex="-1" role="dialog" aria-labelledby="resultModalLabel" aria-hidden="true">
        ...
        <script type="text/javascript">
            ...
            var no_mohon = "";
            var ssusrKodPTj = '<%= Session("ssusrKodPTj").substring(0, 2) %>';
            ...
            $(document).ready(function () {
                ...
                tbl = $("#tblSenaraiPerolehan").DataTable({
                    ...
                    "ajax": {
                        url: '<%= ResolveClientUrl("~/FORMS/PEROLEHAN/PermohonanPoWS.asmx/Load_SenaraiKelulusanPtj") %>',
                        method: 'POST',
                        "contentType": "application/json; charset=utf-8",
                        "dataType": "json",
            ...
            async function ajaxLulusPermohonan1(UpdateStatusLulusZon) {
                return new Promise((resolve, reject) => {
                    $.ajax({
                        url: '<%= ResolveClientUrl("~/FORMS/PEROLEHAN/PermohonanPoWS.asmx/PtjLulusPermohonan") %>',
                       method: 'POST',
            ...
            async function ajaxKemaskiniSemakanPTJ(UpdateStatusKemaskiniPTJ) {
                return new Promise((resolve, reject) => {
                    $.ajax({
                        url: '<%= ResolveClientUrl("~/FORMS/PEROLEHAN/PermohonanPoWS.asmx/KemaskiniPTJ") %>',
                        method: 'POST',
