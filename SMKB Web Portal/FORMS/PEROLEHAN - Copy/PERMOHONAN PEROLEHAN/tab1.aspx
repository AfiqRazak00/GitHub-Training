    ...
    <contenttemplate>
        ...
        <div id="PermohonanTab" class="tabcontent" style="display: block">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="bajet-tab" data-toggle="tab" data-target="#bajet-dan-spesifikasi" type="button" role="tab">Maklumat Bajet dan Spesifikasi</button>
                </li>
                <li class="nav-item" role="presentation">
        ...
        <script type="text/javascript">
            ...
            function callData() {
                ...
                if (ddlkategoriPOValue === "K" && tab5DataLength === 0 || tblAMLength === 0 || tblLvlLength === 0 || tab4DataLength === 0 || tab3DataLength === 0 || tblLampiranLength === 0) {
                    btnHantar.disabled = true;
                } else {
                    btnHantar.disabled = false;
                }
