<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="semakanbendahari.aspx.vb" Inherits="SMKB_Web_Portal.semakanbendahari" %>
            ...
            <div>
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalCenterTitle">Semakan Bendahari</h5>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        <input class="input-group__input" name="PTJ" id="ddlListPtj" type="text" readonly style="background-color: #f0f0f0" />
                                        <label class="input-group__label" for="PTJ">Bekal Kepada</label>
                                       <input type="hidden" id="kodPejabat" />
                                    </div>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                tbl = $("#tblSenaraiPerolehan").DataTable({
                    ...
                    "ajax": {
                        url: '<%= ResolveClientUrl("~/FORMS/PEROLEHAN/PermohonanPoWS.asmx/Load_SenaraiKelulusanBendahari") %>',
                        method: 'POST',
                        "contentType": "application/json; charset=utf-8",
                        "dataType": "json",
                    ...
                    "rowCallback": function (row, data) {
                        ...
                        $(row).on("click", function () {
                            ...
                            $("#ddlListPtj").val(data.BekalPTJ);
                            $("#kodPejabat").val(data.Bekal_Kepada);
                ...
                tblSpek = $("#tblDataPerolehanDtl").DataTable({
                    ...
                    footerCallback: function (row, data, start, end, display) {
                        ...
                        if (total < 50000) {
                            $('.btnKemaskini').attr("style", "display:none;")
                            $('.btnLulus').attr("style", "display:none;")
                        } else {
                            $('.btnKemaskini').attr("style", "")
                            $('.btnLulus').attr("style", "")
                        }
                    },
            ...
            $('.btnLulus').off('click').on('click', async function () {
                ...
                $('#confirmSaveButton10').off('click').on('click', async function () {
                    ...
                    var UpdateStatusLulusBendahari = {
                        txtNoMohonR: $('#txtNoMohon').val(),
                        txtKodPejabat: $('#kodPejabat').val(),
                    };

                    try {
                        var result = JSON.parse(await ajaxLulusBendahari(UpdateStatusLulusBendahari));
            ...
            async function ajaxLulusBendahari(UpdateStatusLulusBendahari) {
                return new Promise((resolve, reject) => {
                    $.ajax({
                        url: '<%= ResolveClientUrl("~/FORMS/PEROLEHAN/PermohonanPoWS.asmx/BendahariLulusPermohonan") %>',
                       method: 'POST',
                        data: JSON.stringify(UpdateStatusLulusBendahari),
                       dataType: 'json',
                       contentType: 'application/json; charset=utf-8',
            ...
            $('.btnKemaskini').off('click').on('click', async function () {
                ...
                $('#confirmSaveButton11').off('click').on('click', async function () {
                    ...
                    var UpdateStatusKemaskiniBendahari = {
                        txtNoMohonR: no_mohon,
                        Ulasan: $('#txtUlasan').val(),
                        NoStaff: NomborStaf                    
                    };
                    console.log(UpdateStatusKemaskiniBendahari)
                    try {
                        var result = JSON.parse(await ajaxKemaskiniPermohonan(UpdateStatusKemaskiniBendahari));
                        if (result.Status === true) {
            ...
            async function ajaxKemaskiniPermohonan(UpdateStatusKemaskiniBendahari) {
                return new Promise((resolve, reject) => {
                    $.ajax({
                        url: '<%= ResolveClientUrl("~/FORMS/PEROLEHAN/PermohonanPoWS.asmx/BendahariKemaskiniPermohonan") %>',
                        method: 'POST',
                        data: JSON.stringify(UpdateStatusKemaskiniBendahari),
                        dataType: 'json',
                        contentType: 'application/json; charset=utf-8',
                        success: function (data) {
                            resolve(data.d);
           ...
           function readSessionData() {
               ...
               $.ajax({
                   ...
                   success: function (response) {
                       ...
                       //var table = $("#tblSenaraiPerolehan").DataTable();
                       ...
                       tbl.ajax.reload(function () {
                           ...
                           var matchedRow = tbl.rows().data().filter(function (row) {
