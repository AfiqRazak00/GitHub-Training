<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="NaskahJualanUni.aspx.vb" Inherits="SMKB_Web_Portal.NaskahJualanUni" %>
...
<br />
                    ...
                    <div class="modal fade" id="senaraiNJ" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
<div class="modal-dialog modal-dialog-centered modal-xl" style="min-width: 80%" role="document">                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Senarai Jualan Naskah Sebut Harga / Tender Universiti</h5>
...
<%--        <div class="modal fade" id="transaksi" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    ...
    <script type="text/javascript">
        ...
        function checkInputs() {
            ...
            if (txtHarga_NaskaValue !== '' && txtTempat_HantarValue !== '' && txtTarikh_Mula_IklanValue !== '' && txtTarikh_Mula_PerolehanValue !== '' && txtTarikh_Tamat_PerolehanValue !== '' && txtMasa_Tamat_PerolehanValue !== '' && txtUlasanValue !== '' && KodGred_CIDB !== '') {
