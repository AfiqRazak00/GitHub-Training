...
Public Class Sebut_Harga_Universiti
    ...
    Private Sub fBindDdlStatus()
        Try
            Dim strSql As String = "Select Kod, Butiran from PO_StatusPP Where SubModul='JN' OR Kod='010' ORDER BY Kod"
    ...
    Private Sub fBindGVJualanUniversiti(KodStatus As String)
        Try
...
WHERE PO01_Status='A' AND PO01_Tahun={Date.Now.Year} AND (a.PO01_FlagVendor = 0)
AND (PO01_StatusPP='010' OR PO01_StatusPP='031' OR PO01_StatusPP='032') AND (PO01_JenisDok='P02' OR PO01_JenisDok='P03')
ORDER BY PO01_StatusPP"
            Else
                strSql = $"SELECT a.PO01_NoMohon, PO01_Tujuan, PO01_JenisBrg,PO02_JualanID, PO02_TrkMasaMulaIklan,PO02_TrkMasaTamatPO,PO01_StatusPP, c.Butiran AS ButiranStatus, d.Butiran AS ButiranBrg 
FROM PO01_PPembelian a
LEFT JOIN PO02_NaskahJualan b ON a.PO01_NoMohon = b.PO01_NoMohon
...
LEFT JOIN PO_JenisItem d ON a.PO01_JenisBrg = d.Kod
WHERE PO01_Status='A' AND PO01_Tahun={Date.Now.Year} AND (a.PO01_FlagVendor = 0)
AND PO01_StatusPP='{KodStatus}' AND (PO01_JenisDok='P02' OR PO01_JenisDok='P03')
ORDER BY PO01_StatusPP"
            End If
    ...
    Protected Sub ddlStatus_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ddlStatus.SelectedIndexChanged
        fBindGVJualanUniversiti(ddlStatus.SelectedValue)
    End Sub
    ...
    Protected Sub gvPO_SelectedIndexChanged(sender As Object, e As EventArgs) Handles gvPO.SelectedIndexChanged
        ...
        'Open other page.
        Response.Redirect($"~/FORMS/Perolehan/Jualan Naskah/Naskah_Jualan.aspx?KodSub={KodSub}&KodSubMenu={KodSubMenu}&NoPO={NoPO}&NoNJ={NoNJ}&Jenis=Uni")
    End Sub
End Class