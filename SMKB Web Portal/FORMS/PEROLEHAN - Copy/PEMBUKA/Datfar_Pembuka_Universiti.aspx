<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Datfar_Pembuka_Universiti.aspx.vb" Inherits="SMKB_Web_Portal.Datfar_Pembuka_Universiti" %>
    ...
    <script type="text/javascript">
        ...
        $('#btnSimpanInfo').off('click').on('click', async function () {
            ...
            $('#confirmSaveButton1').off('click').on('click', async function () {
                ...
                var kodSubmanu = "020502"
                var NameSubMenu = "Pembuka"
        ...
        async function beginSaveJawatanKuasaListDetail(Perolehan_Mesyuarat_JKD) {
            return new Promise((resolve, reject) => {
                $.ajax({
                    url: '<%= ResolveClientUrl("~/FORMS/PEROLEHAN/mesyuaratWS.asmx/SavePerolehan_Mesyuarat_JK") %>',
                method: 'POST',
        ...
        async function ajaxSavePerolehan_Mesyuarat_Hdr(Perolehan_Mesyuarat_Header) {
            ...
            return new Promise((resolve, reject) => {
                $.ajax({
                    url: '<%= ResolveClientUrl("~/FORMS/PEROLEHAN/mesyuaratWS.asmx/SavePerolehan_Mesyuarat_Hdr") %>',
                method: 'POST',
        ...
        async function ajaxSavePerolehan_Mesyuarat_Dtl(Perolehan_Mesyuarat_Detail) {
            ...
            return new Promise((resolve, reject) => {
                $.ajax({
                    url: '<%= ResolveClientUrl("~/FORMS/PEROLEHAN/mesyuaratWS.asmx/SavePerolehan_Mesyuarat_Dtl") %>',
                method: 'POST',
        ...
        $(document).ready(async function () {
            ...
            senaraiData.forEach(function (obj) {
                ...
                const itemData = {
                    ...
                    noSebutHarga: obj.No_Sebut_Harga
                ...
                $template.find(".js-no-permohonan").html(obj.No_Sebut_Harga)
            ...
            async function getDataTable() {
                return new Promise((resolve, reject) => {
                    $.ajax({
                        url: '<%= ResolveClientUrl("~/FORMS/PEROLEHAN/mesyuaratWS.asmx/LoadSenarai_Sebut_Harga") %>',
                    type: "POST",
        ...
        $(document).ready(function () {
            ...
            $('#JawatankuasaData').dropdown({
                ...
                fullTextSearch: true,
                apiSettings: {
                    url: '<%= ResolveClientUrl("~/FORMS/PEROLEHAN/mesyuaratWS.asmx/Get_Jawatan_Kuasa_Pembuka?q={query}") %>',
                method: 'POST',
                dataType: "json",
                contentType: 'application/json; charset=utf-8',
                cache: false,
