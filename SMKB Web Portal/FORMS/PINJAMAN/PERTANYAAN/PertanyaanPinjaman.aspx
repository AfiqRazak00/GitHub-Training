<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="PertanyaanPinjaman.aspx.vb" Inherits="SMKB_Web_Portal.PertanyaanPinjaman"%>
   ...
   <style>
    ...
    <div id="PermohonanTab" class="tabcontent" style="display: block">
        <div class="modal-body">
            ...
            <div class="form-group row col-md-12 align-middle">
    <label for="inputEmail3" class="col-md-3 col-form-label" style="text-align: right">Carian :</label>
    <div class="col-md-5 align-middle" style="padding-right: 0;">
        <select class="input-group__select ui search dropdown" placeholder="" name="ddlSenaraiPinj" id="ddlSenaraiPinj" style="margin-right: 0;"></select>
    </div>
    <div class="col-md-1 align-middle" style="padding-left: 0;">
        <button id="btnSearch" runat="server" class="btn btn-outline btnSearch" type="button" style="margin-left: 0;">
    ...
    <div class="form-group row col-md-6 align-middle">
        ...
        <div class="col-sm-5" style="display: inline-block;">
            <div class="input-group" style="display: inline-block;">
                <select class="input-group__select ui search dropdown" placeholder="" name="ddlSenaraiPinj" id="ddlSenaraiPinj" style="display: inline-block; width: 200px;"></select>
                <button id="btnSearch" runat="server" class="btn btn-outline btnSearch" type="button" style="display: inline-block; vertical-align: middle;">
                ...
                <%--<div class="form-row justify-content-center mt-4" id="btnSearchSection" style="">
                    <button id="btnSearch" class="btn btn-primary btnSearch" onclick="" type="button">Lihat Jadual</button>
                </div>--%>
            </div>
            <div class="col-md-13">
      ...
      <script>
          ...
          // ---------------------- UNTUK DROPDOWN NAMA START   -------------

          // ---------------------- UNTUK DROPDOWN NAMA END  ----------------
          // ---------------------- UNTUK TABLE START -----------------------
          var tbl11 = null;
          ...
          $(document).ready(function () {
              ...
              generateDropdown("ddlSenaraiPinj", "PertanyaanPinjaman_WS.asmx/NamaPinjaman", "-- Sila Pilih --", false, null);
              debugger
              tbl = $("#tblPenjamin").DataTable({
                  ...
                  "ajax": {
                      url: 'PertanyaanPinjaman_WS.asmx/LoadSenarai',
                      type: 'POST',
                      ...
                      "data": function () {
                          ...
                          return JSON.stringify({
                              category_filter: $('#ddlSenaraiPinj').val(),
              ...
              //    fullTextSearch: true,
              //    apiSettings: {
              //        url: 'PertanyaanPinjaman_WS.asmx/SkimPinjaman?q={query}',
              //        method: 'POST',
              //        dataType: "json",
              //        contentType: 'application/json; charset=utf-8',
              //        cache: false,
              ...
              //        fullTextSearch: true,
              //        apiSettings: {
              //            url: 'PertanyaanPinjaman_WS.asmx/TempohPinjaman?q={query}',
              //            method: 'POST',
              //            dataType: "json",
              //            contentType: 'application/json; charset=utf-8',
              //            cache: false,
