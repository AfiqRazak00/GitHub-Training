<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="PembatalanBendahari.aspx.vb" Inherits="SMKB_Web_Portal.WebForm2" %>
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                dttable = $("#tblisting").DataTable({
                    ...
                    "rowCallback": function (row, data) {
                        ...
                        $(row).on("click", function () {
                            ajaxPost("PmbtlnBendahariWS.asmx/GetSelectedPermohonan", {TargetId: data.NoPinj}, true, rdatalisting)
                        });
                    },
                    "columns": [
                        {
                ...
                async function loadSenarai() {
                    ...
                    var data = await ajaxPost("PmbtlnBendahariWS.asmx/FetchSenarai", postDt, true);
                ...
                async function rdatalisting(data) {
                    if (data.Status) {
                        ...
                        //Tab 6 - Info Potongan
                        var dttab6 = await ajaxPost("PmbtlnBendahariWS.asmx/Get_SecondTableData", { NoStaf: dt.NoStaf }, false);
                ...
                async function extractInfo(noPinj, katpinj ) {
                    var dttab4 = await ajaxPost("PmbtlnBendahariWS.asmx/GetInfoSpecs", { NoPinj: noPinj, KatPinj: katpinj }, false);
                ...
                $("#confirmSaveButton").off('click').on('click', async function () {
                    ...
                    var data = await ajaxPost("PmbtlnBendahariWS.asmx/BatalPermohonan", { NoPinj: tempPinj, NoStaf: tempNoStaf }, false);
