<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Basikal.aspx.vb" Inherits="SMKB_Web_Portal.Basikal" %>
                  ...
                  <div class="col-md-12">
                     ...
                     <fieldset class="form-group border p-3" style="border-radius: 5px;">
                        ...
                        <div class="form-row">
                           <div class="col-lg-3 col-md-6">
                              <div class="form-group">
                                 <div class="form-group input-group">
                                    ...
                                    <label class="input-group__label" for="ddlJnmaKend">Jenama <span style="color:red">*</span>
                                    </label>
                                 </div>
                              </div>
                           </div>
                           <div class="col-lg-3 col-md-6">
                              <div class="form-group">
                                 <div class="form-group input-group">
                                    ...
                                    <label class="input-group__label" for="ddlMdlKend">Model <span style="color:red">*</span>
                                    </label>
                                 </div>
                              </div>
                           </div>
                           <div class="col-lg-3 col-md-6">
                              <div class="form-group input-group">
                                 <input type="text" class=" input-group__input" placeholder="" id="hrgaBrsih" name="hrgaBrsih" value="" maxlength="10"/>
                                 <label class="input-group__label" for="hrgaBrsih">Harga Bersih (RM) <span style="color:red">*</span>
                                 </label>
                              </div>
                           </div>
                           <div class="col-lg-3 col-md-6 codx">
                              <div class="form-group input-group">
                                 <input type="text" class=" input-group__input" placeholder="" id="noPndftrn" name="noPndftrn" value="" />
                                 <label class="input-group__label" for="noPndftrn">No. Pendaftaran</label>
                              </div>
                           </div>
                           <div class="col-lg-3 col-md-6">
                              <div class="form-group">
                           ...
                           <div class="col-lg-3 col-md-6">
                              <div class="form-group input-group">
                                 <input type="date" class=" input-group__input" placeholder="" id="thnDibuat" name="thnDibuat" value="" />
                                 <label class="input-group__label" for="thnDibuat">Tahun Dibuat</label>
                              </div>
                           </div>
                           <div class="col-lg-3 col-md-6 codx">
                              <div class="form-group input-group">
                                 <input type="text" class=" input-group__input" placeholder="" id="noChasis" name="noChasis" value="" />
                                 <label class="input-group__label" for="noChasis">No. Chasis</label>
                              </div>
                           </div>
                        </div>
                     </fieldset>
                        ...
                        <div class="row">
                           <div class="col-md-12">
                              <div class="form-row">
                                 ...
                                 <div class="col-lg-3 col-md-6">
                                    <div class="form-group input-group">
                                       <input type="text" class="noSykt input-group__input" placeholder="" id="" name="" value="" disabled readonly />
                  ...
                  <div class="col-md-12">
                     <div id="divpenjamin" class="form-row">
                        ...
                        <div class="col-lg-3 col-md-6">
                           <div class="form-group">
                              <div class="form-group input-group">
                                 <select class="input-group__select ui search dropdown" placeholder="" name="ddlPenjamin" id="ddlPenjamin">
                                 </select>
   ...
   <div class="row">
      ...
      <script type="text/javascript">
          $(document).ready(function () {
              ...
              generateDropdown("ddlJnsPnjmn", "BasikalWS.asmx/GetJenisPinjaman", "Pilih Jenis Pembiayaan", false, null, clearDdlTempohJmlhPohon);
              ...
              generateDropdown("ddlJnmaKend", "BasikalWS.asmx/GetJenamaKenderaan", "Pilih Jenama Basikal", false, null, clearDdlModelKend);
              generateDropdown("ddlMdlKend", "GeneralWS.asmx/GetModelKenderaan", "Pilih Model Basikal", true, "ddlJnmaKend");
          ...
          $('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
              var navId = $(e.target).attr('href');
              if (navId == "#tab3") {
                  $("#btn-seterusnya").addClass("codx");
              } else {
                  $("#btn-seterusnya").removeClass("codx");
              }
          });
          $('input[type="file"]').change(function () {
              ...
              if (fileInput[0].files.length > 0) {
                  ...
                  fileInput.hide();
                  deleteButton.show();
                  fileNameLabel.text(fileInput[0].files[0].name).show();
              } else {
          ...
          $('.delete-button').click(function () {
              ...
              fileInput.val(''); // Clear the file input
              fileInput.show(); // Show the "Choose File" button
              fileNameLabel.text('').hide(); // Clear and hide the file name label
          ...
          $('#mdlSenPemohonan').on('shown.bs.modal', function () {
          ...
          function saveTab1() { //Butiran Maklumat Pemohon
              ...
              if (ddlJnsPnjmn && ddlJnmaKend && ddlMdlKend && hrgaBrsih && ddlSyarikat && ddlTmpoByrBalik && ddlJumlahMhn) {
          ...
          function yaSimpan1() {
              ...
              if (canSave) {
                  if (isSet(tempNoPinjaman)) {
                      ...
                      ajaxPost('BasikalWS.asmx/KemaskiniPermohonanKenderaan', postDt, true, kemaskiniPermohonanBerjaya);
                  } else {
                      //Insert Data
                      var postDt = {
                          JenisPinj: viewDt($("#ddlJnsPnjmn").val(), 'text'),
                      ...
                      ajaxPost('BasikalWS.asmx/SubmitPermohonanKenderaan', postDt, true, permohonanBerjaya);
                  }
              }
          }
          ...
          function yaSimpan2() {
              ...
              if (canSave) {
                  ...
                  if (ttlRow > 0) {
                      ...
                      ajaxPost('BasikalWS.asmx/SubmitPenjamin', postDt, true, tmbhPenjaminBerjaya);
                  } else {
                      var postDt = {
                          NoPinjaman: tempNoPinjaman
                      }

                      ajaxPost('BasikalWS.asmx/ClearPenjamin', postDt, true, clearPenjaminBerjaya);
                  }
              }
          }
              ...
              if (canSave) {
                  ...
                  loopPromise.done(async function () {
                      if (withStatus) {
                          ...
                          var rdata = await ajaxPost('BasikalWS.asmx/PermohonanLengkap', postDt, false);
                          console.log(rdata)
                          if (rdata.Status) {
                              close_loader();
          ...
          async function semakKelayakan(param) {
              return new Promise((resolve, reject) => {
                  $.ajax({
                      url: "BasikalWS.asmx/SemakKelayakan",
                      type: "POST",
          ...
          function slctTblRow(e) {
              ...
              ajaxPost('BasikalWS.asmx/FetchSelectedPermohonan', postDt, false, slctdPermohonanProses);
          }
         ...
         async function getSenaraiSemak() {
             ...
             var data = await ajaxPost('BasikalWS.asmx/GetSenaraiSemak', postDt , false);
             if (isSet(data)) {
                 if (data.Status) {
                     arrSenaraiSemak = [];
          ...
          $("#btnyabuang").off('click').on('click', async function () {
              ...
              var result = await ajaxPost('BasikalWS.asmx/PadamSenaraiSemak', postDt, true);
         ...
         $("#hrgaBrsih").keypress(function () {
             if (String.fromCharCode(e.keyCode).match(/[^0-9]/g)) return false;
         });
         
         //NUMERIC INPUT Text
         $("#hrgaBrsih").keyup(function (e) {
         ...
         async function loadSenaraiP() {
             var data = await ajaxPost('<%= ResolveUrl("~/FORMS/PINJAMAN/MOHON/BasikalWS.asmx/fetchSenaraiPermohonan") %>', {}, false);
