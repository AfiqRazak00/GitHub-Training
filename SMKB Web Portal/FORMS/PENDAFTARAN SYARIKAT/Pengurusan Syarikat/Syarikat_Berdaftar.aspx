<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Syarikat_Berdaftar.aspx.vb" Inherits="SMKB_Web_Portal.Syarikat_Berdaftar" %>
                        ...
                        <div class="form-row col-sm-12" style="margin-top: 2%;">
                            ...
                            <div class="col-sm-3">
                                <select id="tindakanFilter" class="custom-select">
                                    <option value="1" selected>Semakan</option>
                                    <option value="2">Kemaskini Status</option>
                                    <option value="3">Penamatan</option>
                                    <option value="4">Digantung</option>
                                </select>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            tblDataSyaDaftar = $("#tblDataSenaraiSyarikatBerdaftar").DataTable({
                ...
                "ajax": {
                    "url": "SyarikatBerdaftar_WS.asmx/LoadList_SyarikatDaftar",
                    "method": 'POST',
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row, meta) {
                            ...
                            var link = `<button id="btnViewDetailVendor" runat="server" class="btn btnViewDetailVendor" value="${data}" type="button" data-toggle="tooltop" data-placement="top" title="Maklumat Vendor" onclick="ShowDetails('${data}', '070101')">
