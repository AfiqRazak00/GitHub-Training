<%@ Page Language="vb" AutoEventWireup="false"  MasterPageFile="~/NestedMasterPage2.master" CodeBehind="PENGESAHAN_STOR.aspx.vb" Inherits="SMKB_Web_Portal.PENGESAHAN_STOR" %>
                     ...
                     <!-- ~~~ TAB 1 START ~~~-->
                        <div id="divpendaftaraninv" runat="server" visible="true">
                            <div class="modal-header modal-header--sticky">
                                <h5 class="modal-title" id="ModalCenterTitle">Pengesahan Info</h5>
                           ...
                           <div class="modal-body" style="overflow-y: auto;">
                                    ...
                                    <div class="col-md-12">
                                       ...
                                       <div class="form-row">
                                          ...
                                          <div class="form-group col-md-4">
                                            ...
                                            <div class="form-group col-md-4">
                                                <input class="input-group__input" name="Tarikh Permohonan" id="tarikhPengesahan" type="text" readonly disabled/>
                                                <label class="input-group__label" for="Tarikh Permohonan">Tarikh Pengesahan</label>
                                             </div>
                                       </div>
                                    </div>
                                 </div>
                              ...
                              <div class="col-md-12">
                                 <div class="transaction-table table-responsive">
                                    ...
                                    <table  id="tblListPengesahan"  class="table table-striped" style="width:100%">
                                       <thead>
                                          <tr>
                                             ...
                                             <th scope="col"  style="width: 25%;">Kuantiti Mohon</th>
                                          </tr>
                                       </thead>
                                       <tbody>
                                           <tr>
...
<%--                                  <button type="button" class="btn btn-danger" data-dismiss="modal" value="23" id="btnTdkSah" title="Tidak Setuju">Tidak Sah</button>--%>
                                   <button type="button" class="btn btn-danger" id="btnTdkSah"
                                      data-toggle="tooltip" data-placement="bottom"
                                      title="Tidak Sah" value="23">
                                   Tidak Sah</button>
                                    <button type="button" class="btn btn-secondary" id="btnSah"
                                       data-toggle="tooltip" data-placement="bottom"
                                       title="Sah" value="05">
                                    Sah</button>
                                </div>
      ...
      <script>
          ...
          var formattedDate =
              ...
              today.getFullYear();
          document.getElementById('tarikhPengesahan').value = formattedDate;
          ...
          $(document).ready(function () {
              ...
              tblListPermohonan = $("#tblListPermohonan").DataTable({
                  ...
                  "ajax": {
                      url: 'PENGESAHAN_STORWS.asmx/LoadSenaraiPermohonan',
                      type: 'POST',
              ...
              $('#tblListPermohonan tbody').on('click', 'tr', function () {
                  ...
                  $.ajax({
                      url: "PENGESAHAN_STORWS.asmx/GetPermohonanDetails",
                      type: "POST",
                      contentType: "application/json; charset=utf-8",
                  ...
                  $.ajax({
                      url: "PENGESAHAN_STORWS.asmx/fetchMaklumatPemohon",
                      type: "POST",
                      contentType: "application/json; charset=utf-8",
                      data: JSON.stringify({ idMohon: idMohon }),
                      dataType: "json",
          ...
          var tblListPengesahan = null;
          function loadListPengesahan(idMohon) {
              ...
              tblListPengesahan = $("#tblListPengesahan").DataTable({
                  ...
                  "ajax":
                  {
                      "url": "PENGESAHAN_STORWS.asmx/loadListPengesahan",
                      type: 'POST',
                      data: function (d) {
          ...
          function btnTidakSah(IdMohon) {
              ...
              show_message_async("Adakah anda pasti untuk tidak mengesahkan permohonan ini?").then(function (confirmed) {
                  if (confirmed) {
                      $.ajax({
                          url: "PENGESAHAN_STORWS.asmx/tidakSahStatusDok",
                          type: "POST",
                          contentType: "application/json; charset=utf-8",
                          ...
                          success: function (response) {
                              var data = JSON.parse(response.d);
                              if (data.Code === "00") {
                                  notification("Pengesahan Berjaya");
                                  $('#NotifyModal').one('hidden.bs.modal', function () {
                                      window.location.reload();
                                  });
                              } else {
                                  notification("Pengesahan Gagal");
                              }
                          },
                          error: function (xhr, status, error) {
          ...
          function btnSah(IdMohon) {
              ...
              show_message_async("Adakah anda pasti untuk mengesahkan permohonan ini?").then(function (confirmed) {
                  if (confirmed) {
                      $.ajax({
                          url: "PENGESAHAN_STORWS.asmx/sahStatusDok",
                          type: "POST",
                          contentType: "application/json; charset=utf-8",
                          data: JSON.stringify(data),
                          dataType: "json",
