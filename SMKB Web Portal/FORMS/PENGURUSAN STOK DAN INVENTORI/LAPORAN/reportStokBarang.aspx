<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="reportStokBarang.aspx.vb" Inherits="SMKB_Web_Portal.reportStokBarang" %>
<%@ Register Src="~/FORMS/PENGURUSAN STOR/LAPORAN/TableStokBarang.ascx" TagPrefix="Vot" TagName="Table" %>
    ...
    <form id="form1" runat="server">
         <div id="masterdiv" class="container">
                ...
                <table> 
                    <tr>
                        ...
                        <td style="width: 30%; text-align: right">
                            ...
                            <span class="ptarikh">Laporan Senarai Barang</span><br />
                    ...
                    <tr>
                        ...
                        <td style="text-align:center">
                            <br/>
                            <p class="pheader3"><strong>Laporan Senarai Barang</strong></p>
                            <asp:Panel runat="server" ID="kategoriPanel">

                                 <p class="pheader3" >Kategori :
                                    <asp:Label runat="server" ID="kategori"></asp:Label></p>
                            </asp:Panel>
                            <asp:Panel runat="server" ID="ptjPanel">
            ...
            <div class="vot-table-content">
                 <Vot:Table runat="server" ID="TableStokBarang" CustomClass="TableStokBarang" />
            </div>
