                        ...
                        <div class="col-md-12">
                           <div class="form-row">
                               <div class="form-group col-md-6">
                                   <%--<input class="input-group__input" id="kodBarang" placeholder="&nbsp;" name="Kod" type="text" readonly style="background-color: #f0f0f0" value="" >--%>
                                   <input class="input-group__input" name="noStaf" id="kodBarang" type="text" readonly style="background-color: #f0f0f0" value="" />
                               ...
                               <div class="form-group col-md-6">
                                 <div class="form-group col-md-6">
                                    <%--<select class="ui search dropdown barangUkuran" name="ukuranBarang" id="ukuranBarang"></select>
                                     ...
                                     <select class="input-group__select ui search dropdown" placeholder="" name="ukuranBarang" id="ukuranBarang">
                                     </select>
                                     <label class="input-group__label" for="ukuranBarang">Ukuran<span style="color: red">*</span></label>
                                 </div>
                               </div>
                           </div>
                        </div>
                           ...
                           <div class="form-row">
                              ...
                              <div class="form-group col-md-6">
                                 <div class="form-group col-md-6">
                                     ...
                                     <label class="input-group__label" for="kategoriBarang">Kategori<span style="color: red">*</span></label>
                                 </div>
                              </div>
                           </div>
                        </div>
                              ...
                              <div class="form-group col-md-6">
                                 <div class="form-group col-md-6">
                                    <%--<select class="ui search dropdown barangUkuran" name="ukuranBarang2" id="ukuranBarang2"></select>--%>
                                     <select class="input-group__select ui search dropdown" placeholder="" name="ukuranBarang2" id="ukuranBarang2">
</select>
<label class="input-group__label" for="ukuranBarang2">Ukuran<span style="color: red">*</span></label>
                                 </div>
                              </div>
                           </div>
                        </div>
                              ...
                              <div class="form-group col-md-6">
                                 <div class="form-group col-md-6">
                                    <%--<select class="ui search dropdown barangKategori" name="kategoriBarang2" id="kategoriBarang2"></select>--%>
                                                                          <select class="input-group__select ui search dropdown" placeholder="" name="kategoriBarang2" id="kategoriBarang2">
</select>
<label class="input-group__label" for="kategoriBarang2">Kategori<span style="color: red">*</span></label>   
                                 </div>
                              </div>
                           </div>
                        </div>
                     ...
                     <table id="tblBarang" class="table table-striped">
                        <thead>
                           <tr style="width: 100%">
                              ...
                              <th scope="col" style="width: 25%">Kategori Stok</th>
      ...
      <script type="text/javascript">
          ...
          $(document).ready(function () {
              tbl11 = $("#tblBarang").DataTable({
                  ...
                  "ajax": {
                      url: 'Barang_WS.asmx/LoadBarangData',
