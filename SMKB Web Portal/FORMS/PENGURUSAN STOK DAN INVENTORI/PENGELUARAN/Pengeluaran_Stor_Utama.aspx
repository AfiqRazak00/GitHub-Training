<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Pengeluaran_Stor_Utama.aspx.vb" Inherits="SMKB_Web_Portal.Pengeluaran_Stor_Utama" %>
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $('#btnYaSubmit').click(function () {
                    ...
                    $.ajax({
                        url: 'PengeluaranWS.asmx/SimpanPengeluaranUtama',
                        type: 'POST',
                ...
                tbl = $("#tblSenaraiPengeluaran").DataTable({
                    ...
                    "ajax": {
                        "url": "PengeluaranWS.asmx/fetchSenaraiPengeluaranUtama",
                        method: 'POST',
                        data: function (d) {
                ...
                $('#tblSenaraiPengeluaran tbody').on('click', 'tr', function () {
                    ...
                    tbl2 = $("#tblBarangan").DataTable({
                        ...
                        "ajax": {
                            "url": "PengeluaranWS.asmx/fetchPengeluaranDetailsUtama",
                            method: 'POST',
                            "contentType": "application/json; charset=utf-8",
                            "dataType": "json",
                            "data": function () {
