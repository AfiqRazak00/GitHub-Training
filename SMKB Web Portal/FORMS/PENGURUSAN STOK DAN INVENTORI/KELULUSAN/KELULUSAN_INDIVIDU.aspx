<%@ Page Language="vb" AutoEventWireup="false"  MasterPageFile="~/NestedMasterPage2.master" CodeBehind="KELULUSAN_INDIVIDU.aspx.vb" Inherits="SMKB_Web_Portal.KELULUSAN_INDIVIDU" %>
                            ...
                            <table id="tblListPermohonan" class="table table-striped" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:10%" >Masa Mohon</th>
                                    ...
                                    <table  id="tblListKelulusan"  class="table table-striped" style="width:100%">
                                       <thead>
                                          <tr>
                                             ...
                                             <th scope="col"  style="width: 20%;">Tujuan Kegunaan</th>
                                             <th scope="col"  style="width: 15%;">Tkt.Minima</th>
                                             <th scope="col"  style="width: 15%;">Tkt.Menokok</th>
                                             <th scope="col"  style="width: 25%;">Baki Stok</th>
                                     ...
                                     <div class="col-md-12">
                                       ...
                                       <legend class="w-auto px-2 h6 font-weight-bold">Maklumat Pemohon</legend>
                                           <div class="form-row">
                                               ...
                                               <div class="form-group col-md-4">
                                                   <input class="input-group__input" name="jawatan" id="jawatanPemohon" type="text" readonly disabled/>
                                                   <label class="input-group__label" for="jawatan">Jawatan</label>
                                               </div>
                                               <div class="form-group col-md-4">
                                                   <input class="input-group__input" name="telefon" id="telefonPemohon" type="text" readonly disabled/>
      ...
      <script>
          ...
          $(document).ready(function () {
              ...
              tblListPermohonan = $("#tblListPermohonan").DataTable({
                  ...
                  "ajax": {
                      url: 'KELULUSAN_INDIVIDUWS.asmx/LoadSenaraiPermohonan',
                      type: 'POST',
              ...
              $('#tblListPermohonan tbody').on('click', 'tr', function () {
                  ...
                  $.ajax({
                      url: "KELULUSAN_INDIVIDUWS.asmx/GetPermohonanDetails",
                      type: "POST",
                      contentType: "application/json; charset=utf-8",
                  ...
                  $.ajax({
                      ...
                      success: function (response) {
                          ...
                          if (Array.isArray(responseData) && responseData.length > 0) {
                              ...
                              $("#telefonPemohon").val(responseData[0].MS01_TelPejabat);
                              $("#jawatanPemohon").val(responseData[0].JawGiliran);
          ...
          function loadListKelulusan(idMohon) {
              ...
              tblListKelulusan = $("#tblListKelulusan").DataTable({
                  ...
                  "ajax":
                  {
                      "url": "KELULUSAN_INDIVIDUWS.asmx/loadListKelulusan",
                      type: 'POST',
                      data: function (d) {
              ...
              function updateKelulusanKuantiti(idMohon) {
                  ...
                  $.ajax({
                      url: "KELULUSAN_INDIVIDUWS.asmx/updateKelulusanKuantiti",
                      type: "POST",
                      contentType: "application/json; charset=utf-8",
                      ...
                      success: function (response) {
                          ...
                          if (data.Code === "00") {
                              ...
                              console.log("Berjaya updade kuantiti lulus!");
                              //window.location.reload();
                          } else {
                              //notification();
                              console.log("Tidak berjaya updade kuantiti lulus!");
              ...
              $(document).ready(function () {
                  ...
                  $('#btnLulus').off('click').on('click', function () {
                      ...
                      show_message_async("Adakah anda pasti untuk meluluskan permohonan ini?")
