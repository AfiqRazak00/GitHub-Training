<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Tambah_Stor_Utama.aspx.vb" Inherits="SMKB_Web_Portal.Tambah_Stor_Utama" %>
                     ...
                     <div class="row">
                         <div class="col-lg-4 col-md-6">
                           <div class="form-group input-group">
                              <input type="text" class="id_ptj input-group__input form-control input-sm" placeholder="" name="" value="" readonly />
       ...
       <script>
           ...
           $(document).ready(function () {
               ...
               tbl = $("#tblSenaraiStok").DataTable({
                   ...
                   "ajax": {
                       "url": "StokTambahWS.asmx/fetchSenaraiStokUtama",
                       method: 'POST',
                       data: function (d) {
           ...
           $(document).ready(function () {
               ...
               $('.btnHapus').click(function () {
                   ...
                   $.ajax({
                       url: "StokTambahWS.asmx/UpdateTambahStokUtama",
                       type: "POST",
                       contentType: "application/json; charset=utf-8",
                       dataType: "json",
               ...
               $.ajax({
                   url: "StokTambahWS.asmx/fetchPtj",
                   type: "POST",
                   contentType: "application/json; charset=utf-8",
                   dataType: "json",
                   success: function (response) {
               ...
               $.ajax({
                   url: "StokTambahWS.asmx/fetchDdlKategoriUtama",
                   type: "POST",
                   contentType: "application/json; charset=utf-8",
                   dataType: "json",
                   success: function (response) {
               ...
               $('#ddlKategori').on('change', function () {
                   ...
                   $.ajax({
                       url: "StokTambahWS.asmx/fetchDdlBekalanUtama",
                       type: "POST",
                       contentType: "application/json; charset=utf-8",
           ...
           function saveData() {
               ...
               var no_rujukan = $(".id_rujukan").val();
                ...
                $.ajax({
                    url: "StokTambahWS.asmx/SimpanTambahStokUtama",
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: JSON.stringify({
           ...
           function loadTblTransaksi() {
               ...
               tblTransaksi = $("#tblTransaksi").DataTable({
                   ...
                   "ajax": {
                       "url": "StokTambahWS.asmx/fetchTransaksiUtama",
                       method: 'POST',
                       "contentType": "application/json; charset=utf-8",
                       "dataType": "json",
                       "data": function () {
