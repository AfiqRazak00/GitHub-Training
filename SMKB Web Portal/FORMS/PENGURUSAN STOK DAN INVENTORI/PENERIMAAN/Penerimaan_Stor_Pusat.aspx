<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Penerimaan_Stor_Pusat.aspx.vb" Inherits="SMKB_Web_Portal.Penerimaan_Stor_Pusat" %>
            ...
            <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalCenterTitle">Senarai Permohonan Untuk Proses Penerimaan</h5>
                            ...
                            <div class="form-row justify-content-center">
                             ...
                             <div class="modal-body">
                               <div class="col-md-13">
                                  <div class="transaction-table table-responsive">
                                     <span style="display: inline-block; height: 100%;"></span>
                                     <table id="tblSenaraiPenerimaan" class="table table-striped" style="width: 100% !important">
                                        <thead>
                                           <tr>
                                               <th>Bil</th>
                                               <th>No. Permohonan</th>
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $('#btnYaSubmit').click(function () {
                    ...
                    var kodPtj = $('#ptj').val().split('-')[0];


                    // Loop through each table row
                    $("#tblBarangan tbody tr").each(function () {
                        ...
                        var KuantitiLulus = parseFloat($(this).find('td:eq(6)').text());

                        formDataArray.push({ IdBarang: IdBarang, KuantitiLulus: KuantitiLulus });

                    });

                    $.ajax({
                        url: 'PenerimaanWS.asmx/SimpanPenerimaan',
                        type: 'POST',
                        contentType: 'application/json',
                        data: JSON.stringify({ NoMohon: NoMohon, formDataArray: formDataArray, kodPtj: kodPtj }),
                ...
                tbl = $("#tblSenaraiPenerimaan").DataTable({
                    "responsive": true,
                    "searching": true,
                    "info": true,
                    ...
                    "ajax": {
                        "url": "PenerimaanWS.asmx/fetchSenaraiPenerimaan",
                        method: 'POST',
                        data: function (d) {
                ...
                $('#tblSenaraiPenerimaan tbody').on('click', 'tr', function () {
                    ...
                    tbl2 = $("#tblBarangan").DataTable({
                        ...
                        "ajax": {
                            "url": "PenerimaanWS.asmx/fetchPenerimaanDetails",
                            method: 'POST',
                            "contentType": "application/json; charset=utf-8",
                            "dataType": "json",
                            "data": function () {
                        ...
                        "columns": [
                            ...
                            },
                            {
                                ...
                                "render": function (data, type, row) {
                                    return row.Kod_Brg + "-" + row.NamaBarang;
                                }
                            },
                            { "data": "Tujuan" },
                            { "data": "Kuantiti_Mohon" },
                    ...
                    $.ajax({
                        url: 'PenerimaanWS.asmx/fetchPengesah',
                        type: 'POST',
                        contentType: 'application/json',
                    ...
                    $.ajax({
                        url: 'PenerimaanWS.asmx/fetchPelulus', 
                        type: 'POST',
                        contentType: 'application/json',
                        data: JSON.stringify({ noMohon: noMohon }), // Include formDataArray and kodPtj
                        success: function (response) {
            ...
            function getPemohonDetails(NoStaf) {
                $.ajax({
                    url: 'PenerimaanWS.asmx/fetchPemohonDetails', // Replace with your web service endpoint
                    type: 'POST',
                    contentType: 'application/json',
