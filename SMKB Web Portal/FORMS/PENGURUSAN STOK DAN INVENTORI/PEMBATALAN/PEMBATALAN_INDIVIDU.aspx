<%@ Page Language="vb" AutoEventWireup="false"  MasterPageFile="~/NestedMasterPage2.master" CodeBehind="PEMBATALAN_INDIVIDU.aspx.vb" Inherits="SMKB_Web_Portal.PEMBATALAN_INDIVIDU" %>
                              ...
                              <div class="col-md-12">
                                    ...
                                    <table  id="tblListPembatalan"  class="table table-striped" style="width:100%">
                                       <thead>
                                          <tr>
                                             ...
                                             <th scope="col"  style="width: 15%;">U.Ukuran</th>
                                ...
                                <div align="right" style="padding-bottom:20px; padding-right:20px;">
                                   <button type="button" class="btn btn-danger" id="btnBatal"
                                      ...
                                      title="Batak Permohonan" value="05">
      ...
      <script>
          ...
          $(document).ready(function () {
              ...
              tblListPermohonan = $("#tblListPermohonan").DataTable({
                  ...
                  "ajax": {
                      url: 'PEMBATALAN_INDIVIDUWS.asmx/LoadSenaraiPermohonan',
                      type: 'POST',
              ...
              $('#tblListPermohonan tbody').on('click', 'tr', function () {
                  ...
                  $.ajax({
                      url: "PEMBATALAN_INDIVIDUWS.asmx/GetPermohonanDetails",
                      type: "POST",
                      contentType: "application/json; charset=utf-8",
          ...
          function loadListPembatalan(idMohon) {
              ...
              tblListPembatalan = $("#tblListPembatalan").DataTable({
                  ...
                  "ajax":
                  {
                      "url": "PEMBATALAN_INDIVIDUWS.asmx/loadListPembatalan",
                      type: 'POST',
                      data: function (d) {
          ...
          function btnBatal(IdMohon) {
              ...
              show_message_async("Adakah anda pasti untuk membatalkan permohonan ini?").then(function (confirmed) {
                  if (confirmed) {
                      $.ajax({
                          url: "PEMBATALAN_INDIVIDUWS.asmx/updatePembatalan",
                          type: "POST",
                          contentType: "application/json; charset=utf-8",
