...
Public Class Akhir_Tahun_WS
    ...
    Private Function InsertNewOrder(orderid As String, Tarikh As String, PTJ As String, Bahagian As String, Unit As String, PTJ_Pusat As String, Dasar As String, Kump_Wang As String, KodKo As String, KodKP As String, Program As String, Justifikasi As String, Jumlah As Decimal)
        Dim db As New DBKewConn
        Dim query As String = "INSERT INTO SMKB_Agihan_Bajet_Hdr (Kod_Korporat , No_Mohon , Kod_Kump_Wang , Kod_Operasi , Kod_Projek , Kod_PTJ , Kod_Bahagian, Kod_Unit, PTJ_Pusat, Program, Justifikasi, Tahun_Bajet , Kod_Dasar, Jumlah_Mohon , Jumlah_KB , Jumlah_Kew , Jumlah_KetuaPTj ,Jumlah_Bendahari , Jumlah_NC, Tkh_Mohon , Created_Date , Created_By  ,Kod_Agih, Status_Dok)
        VALUES(@Kod_Korporat ,@No_Mohon, @KW, @KO, @KP, @Kod_PTj , @Kod_Bahagian, @Kod_Unit, @Kod_Pusat, @Program , @Justifikasi, @TahunBajet, @KodDasar, @JumlahMohon, @JumlahMohon, @JumlahMohon, @JumlahMohon, @JumlahMohon, @JumlahMohon, @TkhMohon, @CreatedDate, @CreatedBy, @KodAgih , @Status_Dok)"
        Dim param As New List(Of SqlParameter)
        ...
        param.Add(New SqlParameter("@KodDasar", Dasar))
        param.Add(New SqlParameter("@JumlahMohon", Jumlah))
        param.Add(New SqlParameter("@TkhMohon", Tarikh))
        param.Add(New SqlParameter("@CreatedDate", Tarikh))
    ...
    Private Function GetOrder_SenaraiTransaksiBajet(category_filter As String, tkhMula As DateTime, tkhTamat As DateTime) As DataTable
        ...
        Dim query As String = "select No_Mohon, Program ,Justifikasi, Jumlah_Mohon, FORMAT (Tkh_Mohon, 'dd-MM-yyyy') as Tkh_Transaksi , 
                                 (select Butiran from SMKB_Kod_Status_Dok where Kod_Modul = '01' and Status = @status and Kod_Status_Dok = SMKB_Agihan_Bajet_Hdr.Status_Dok) as Kod_Status_Dok
                                from SMKB_Agihan_Bajet_Hdr 
                                where Created_By = @userID " & tarikhQuery
    ...
    Private Function GetHdrBajet(id As String) As DataTable
        ...
        Dim query As String = "select No_Mohon, FORMAT(Tkh_Mohon, 'yyyy-MM-dd') as Tkh_Transaksi, Kod_PTJ, 
    ...
    <WebMethod()>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function LoadHdrBajet_Bend(ByVal id As String) As String
        Dim resp As New ResponseRepository

        dt = GetHdrBajet_Bend(id)
        resp.SuccessPayload(dt)

        Return JsonConvert.SerializeObject(resp.GetResult())
    End Function

    Private Function GetHdrBajet_Bend(id As String) As DataTable
        Dim db = New DBKewConn
    ...
    Private Function GetHdrH1(tahun As String, kw As String, ko As String, kp As String, ptj As String, votam As String) As DataTable
        ...
        Dim query As String = " SELECT 
                                ...
                                and a.Status_Dok  in ('03','04','05','06','07','08','09','10','11')
    ...
    Private Function GetOrder_SenaraiMohonTransaksiJurnal_KewPtj(category_filter As String, tkhMula As DateTime, tkhTamat As DateTime) As DataTable
        ...
        Dim query As String = "select No_Mohon, Program ,Justifikasi, Jumlah_KB as Jumlah, FORMAT (Tkh_Mohon, 'dd-MM-yyyy') as Tkh_Transaksi , 
                                 (select Butiran from SMKB_Kod_Status_Dok where Kod_Modul = '01' and Status = @status and Kod_Status_Dok = SMKB_Agihan_Bajet_Hdr.Status_Dok) as Kod_Status_Dok
                                from SMKB_Agihan_Bajet_Hdr 
                                where Status_Dok = '06'  and Kod_PTJ = @Kod_PTJ and Kod_Agih = 'AL' AND Tahun_Bajet ='2025'" & tarikhQuery
    ...
    <WebMethod()>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function LoadRecordBajet_Bend(ByVal id As String) As String
        Dim resp As New ResponseRepository

        dt = GetTransaksiBajet_Bend(id)
        resp.SuccessPayload(dt)

        Return JsonConvert.SerializeObject(resp.GetResult())
    End Function

    Private Function GetTransaksiBajet_Bend(kod As String) As DataTable
        Dim db = New DBKewConn
    ...
    '    If UpdateLulusOrder_Kew(order.OrderID) <> "OK" Then
    ...
    Public Function Lulusorder_Bendahari(order As order_Bajet) As String
        ...
        If UpdateLulusOrder_Bend(order.OrderID) <> "OK" Then
    ...
    <System.Web.Services.WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function Lulusorder_LPU(order As order_Bajet) As String
        Dim resp As New ResponseRepository
        resp.Success("Data telah diluluskan")
        Dim success As Integer = 0
        Dim JumRekod As Integer = 0
        ...
        If UpdateLulusOrder_LPU(order.OrderID) <> "OK" Then
    ...
    Private Function GetOrder_SenaraiMohonTransaksiJurnal_Bendahari(category_filter As String, tkhMula As DateTime, tkhTamat As DateTime) As DataTable
        ...
        Dim query As String = "select No_Mohon, Program ,Justifikasi, Jumlah_KB as Jumlah, FORMAT (Tkh_Mohon, 'dd-MM-yyyy') as Tkh_Transaksi , 
                                 (select Butiran from SMKB_Kod_Status_Dok where Kod_Modul = '01' and Status = @status and Kod_Status_Dok = SMKB_Agihan_Bajet_Hdr.Status_Dok) as Kod_Status_Dok
                                from SMKB_Agihan_Bajet_Hdr 
                                where ID_Staf_KB = @userID  and Status_Dok = '08' " & tarikhQuery
    ...
    Private Function GetOrder_SenaraiMohonTransaksiJurnal_NC(category_filter As String, tkhMula As DateTime, tkhTamat As DateTime) As DataTable
        ...
        Dim query As String = "select No_Mohon, Program ,Justifikasi, Jumlah_KB as Jumlah, FORMAT (Tkh_Mohon, 'dd-MM-yyyy') as Tkh_Transaksi , 
                                 (select Butiran from SMKB_Kod_Status_Dok where Kod_Modul = '01' and Status = @status and Kod_Status_Dok = SMKB_Agihan_Bajet_Hdr.Status_Dok) as Kod_Status_Dok
                                from SMKB_Agihan_Bajet_Hdr 
                                where ID_Staf_KB = @userID  and Status_Dok = '09' " & tarikhQuery
    ...
    <System.Web.Services.WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function LoadOrderRecord_SenaraiMohonBajet_LPU(category_filter As String, isClicked As Boolean, tkhMula As DateTime, tkhTamat As DateTime) As String
        Dim resp As New ResponseRepository
        ...
        dt = GetOrder_SenaraiMohonTransaksiJurnal_LPU(category_filter, tkhMula, tkhTamat)
        'resp.SuccessPayload(dt)
    ...
    <WebMethod()>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Private Function GetOrder_SenaraiMohonTransaksiJurnal_LPU(category_filter As String, tkhMula As DateTime, tkhTamat As DateTime) As DataTable
        Dim db = New DBKewConn
        Dim tarikhQuery As String = ""
        Dim param As List(Of SqlParameter)
        ...
        Dim query As String = "select No_Mohon, Program ,Justifikasi, Jumlah_KB as Jumlah, FORMAT (Tkh_Mohon, 'dd-MM-yyyy') as Tkh_Transaksi , 
                                 (select Butiran from SMKB_Kod_Status_Dok where Kod_Modul = '01' and Status = @status and Kod_Status_Dok = SMKB_Agihan_Bajet_Hdr.Status_Dok) as Kod_Status_Dok
                                from SMKB_Agihan_Bajet_Hdr 
                                where ID_Staf_KB = @userID  and Status_Dok = '10' " & tarikhQuery
    ...
    'Private Function UpdateLulusOrder_Kew(orderid As String)
    '    Dim db As New DBKewConn

    '    Dim kodstatusLulus As String = "08"
    ...
    Private Function UpdateLulusOrder_Bend(orderid As String)
        Dim db As New DBKewConn

        Dim kodstatusLulus As String = "09"
    ...
    Private Function UpdateLulusOrder_NC(orderid As String)
        ...
        Dim kodstatusLulus As String = "10"
    ...
    Private Function UpdateLulusOrder_LPU(orderid As String)
        Dim db As New DBKewConn

        Dim kodstatusLulus As String = "11"
    ...
    Private Function GetOrder_SenaraiSummaryKew(tahun As String, kw As String) As DataTable
        ...
        Dim query As String = "SELECT ROW_NUMBER() OVER(ORDER BY S.Kod_Bahagian) AS Bil, S.Kod_Bahagian,  S.NamaBahagian, Tahun_Bajet , Kod_Kump_Wang , Kod_Operasi , Kod_Projek , Kod_PTJ , 
                                ...
                                and Kod_PTJ = @Kod_PTJ  and a.Status_Dok  in ('06','07','08','09','10','11')
