<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Pengesahan_LPU.aspx.vb" Inherits="SMKB_Web_Portal.Pengesahan_LPU" %>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                tbl_ = $("#tblDataSenarai_trans_").DataTable({
                    ...
                    "ajax": {
                        "url": "Akhir_Tahun_WS.asmx/LoadOrderRecord_SenaraiMohonBajet_LPU",
                        "method": 'POST',
            ...
            async function ajaxSaveOrderLulus(order) {
               // console.log(order)
                return new Promise((resolve, reject) => {
                    $.ajax({
                        url: 'Akhir_Tahun_WS.asmx/Lulusorder_LPU',
                        method: 'POST',
                        data: JSON.stringify(order),
                        dataType: 'json',
                        contentType: 'application/json; charset=utf-8',
