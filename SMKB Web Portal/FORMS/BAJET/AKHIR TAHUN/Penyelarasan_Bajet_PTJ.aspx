<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Penyelarasan_Bajet_PTJ.aspx.vb" Inherits="SMKB_Web_Portal.Penyelarasan_Bajet_PTJ" %>
    ...
    <div id="PermohonanTab" class="tabcontent" style="display: block">
        ...
        <div class="container-fluid">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation"<%-- style="visibility:hidden"--%>><a class="nav-link" data-toggle="tab" id="tab-abm" href="#menu1">Ringkasan ABM</a></li>
            </ul>
                    ...
                    <div class="search-filter">
                                ...
                                <table id="tblDataSenarai_trans" class="table table-striped" style="width: 99%">
                                    <thead>
                                        ...
                                        <tr>                                          
                                            ...
                                            <th scope="col" style="text-align: center;" class="auto-style4" >Kod Bahagian</th>
                        ...
                        <div align="center">
                            <table>
                                <tr>
                                    <td >
                                        <button type="button" class="btn btn-success btnHantar_Kew" id="btnHantar_Kew" name="btnHantar_Kew" data-toggle="tooltip" data-placement="bottom" >Hantar Kepada Ketua PTJ</button>
                                        </td>
                                </tr>
                            </table>
                        </div>
            ...
            <table  id="tblData_mhn"  class="table table-striped">
                        ...
                        <tfoot class="sticky-footer">
                            ...
                            <tr>
                                ...
                                <button type="button" class="btn btn-secondary btnSimpan" data-toggle="tooltip" data-placement="bottom" title="Draft">Simpan</button>
                                <button type="button" class="btn btn-success btnHantar" data-toggle="tooltip" data-placement="bottom" title="Simpan dan Hantar">Hantar</button>--%>
                                <button type="button" class="btn btn-setsemula btnXLulus_mhn" data-toggle="tooltip" data-placement="bottom" >Hapus</button>
                                <button type="button" class="btn btn-success btnLulus_mhn" data-toggle="tooltip" data-placement="bottom" >Simpan</button>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                tbl = $("#tblDataSenarai_trans").DataTable({
                    ...
                    "info": false,
                    "ajax": {
                        "url": "Akhir_Tahun_WS.asmx/LoadSummaryKewPTJ",
                        "method": 'POST',
                    ...
                    "columns": [
                        ...
                        },
                        {
                            ...
                            "render": function (data, type, row) {
                                ...
                                var link = `
                                    <td style="width: 10%" >
                                    <label  data-toggle="tooltip" data-placement="top" title="Vot 20000" style="cursor: pointer; text-align: right;" onclick="rowClickHandlerABM('${valtahun}','${valkw}','${valko}','${valkp}','${valPtj}','${valVotAm}','${KodTab}')">${data}</label>
                                    </td>`;
                                return link;
                            }
                        },
                ...
                async function GetButiranKod(Kod_Bahagian) {
                    ...
                    return new Promise((resolve, reject) => {
                        $.ajax({
                            url: "Akhir_Tahun_WS.asmx/LoadBahagian",
                            method: "POST",
            ...
            $(document).ready(function () {
                ...
                tbl_ = $("#tblDataSenarai_trans_").DataTable({
                    ...
                    "ajax": {
                        "url": "Akhir_Tahun_WS.asmx/LoadOrderRecord_SenaraiMohonBajet_KewPtj",
                        "method": 'POST',
                        "contentType": "application/json; charset=utf-8",
                        "dataType": "json",
                        "dataSrc": function (json) {
            ...
            $(document).ready(function () {
                ...
                $('#categoryKW').dropdown({
                    apiSettings: {
                        url: 'Akhir_Tahun_WS.asmx/GetJenisKW?q={query}',
                        method: 'POST',
                        dataType: "json",
                        contentType: 'application/json; charset=utf-8',
                        cache: false,
            ...
            $('.btnHantar_Kew').click(async function () {
                //console.log("test")
                $('#detailMakluman_Hantar_Submit').html("Anda pasti untuk hantar kelulusan ke PTJ?");
            ...
            async function ajaxSaveOrderLulus_Submit(order) {
                ...
                return new Promise((resolve, reject) => {
                    ...
                    $.ajax({
                        url: 'Akhir_Tahun_WS.asmx/Lulusorder_Kew_Submit',
                        method: 'POST',
            ...
            async function ajaxSaveOrder(order) {
                ...
                return new Promise((resolve, reject) => {
                    $.ajax({
                        url: 'Akhir_Tahun_WS.asmx/Lulusorder',
                        method: 'POST',
                        data: JSON.stringify(order),
                        dataType: 'json',
                        contentType: 'application/json; charset=utf-8',
            ...
            async function ajaxSaveOrderLulus(order) {
              // console.log(order)
                return new Promise((resolve, reject) => {
                    $.ajax({
                        url: 'Akhir_Tahun_WS.asmx/Lulusorder_Kew',
                        method: 'POST',
                        data: JSON.stringify(order),
                        dataType: 'json',
                        contentType: 'application/json; charset=utf-8',
            ...
            async function ajaxSaveOrderXLulus(order) {
                ...
                return new Promise((resolve, reject) => {
                    $.ajax({
                        url: 'Akhir_Tahun_WS.asmx/XLulusorder_Bajet',
                        method: 'POST',
                        data: JSON.stringify(order),
                        dataType: 'json',
                        contentType: 'application/json; charset=utf-8',
            ...
            async function rowClickHandler_Kew(id) {
                ...
                if (id !== "") {
                    ...
                    generateDropdown("ddlBahagian_mhn", "Akhir_Tahun_WS.asmx/GetListBahagian", null, false, null);
                    generateDropdown("ddlKW_mhn", "Akhir_Tahun_WS.asmx/GetListKW", null, false, null);
                    //generateDropdown("ddlPenyokong_mhn", "Akhir_Tahun_WS.asmx/GetListPenyokong", null, false, null);
                    generateDropdown("ddlKO_mhn", "Akhir_Tahun_WS.asmx/GetListKO", null, false, null);
                    generateDropdown("ddlKP_mhn", "Akhir_Tahun_WS.asmx/GetListKP", null, false, null);
                    generateDropdown("ddlDasar_mhn", "Akhir_Tahun_WS.asmx/GetListDasar", null, true, null);
                    generateDropdown("ddlUnit_mhn", "Akhir_Tahun_WS.asmx/GetListUnit", null, true, "ddlBahagian");
                    generateDropdown("ddlPTJPusat_mhn", "Akhir_Tahun_WS.asmx/GetListPTJPusat", null, false, null);
            ...
            function initDDLKW_Kew() {
                $.ajax({
                    url: 'Akhir_Tahun_WS.asmx/GetListKW?q={query}',
                    method: "POST",
                    data: JSON.stringify({
                        q: ''
                    }),
            ...
            function initDDLBahagian_Kew() {
                $.ajax({
                    url: 'Akhir_Tahun_WS.asmx/GetListBahagian?q={query}',
                    method: "POST",
                    data: JSON.stringify({
                        q: ''
                    }),
            ...
            function initDDLKO_Kew() {
                $.ajax({
                    url: 'Akhir_Tahun_WS.asmx/GetListKO?q={query}',
                    method: "POST",
                    data: JSON.stringify({
                        q: ''
                    }),
            ...
            function initDDLDasar_Kew() {
                $.ajax({
                    url: 'Akhir_Tahun_WS.asmx/GetListDasar?q={query}',
                    method: "POST",
                    data: JSON.stringify({
                        q: ''
                    }),
            ...
            async function rowClickHandlerPapar(id) {
                ...
                generateDropdown("ddlBahagian", "Akhir_Tahun_WS.asmx/GetListBahagian", null, false, null);
                generateDropdown("ddlKW", "Akhir_Tahun_WS.asmx/GetListKW", null, false, null);
                //generateDropdown("ddlPenyokong_mhn", "Akhir_Tahun_WS.asmx/GetListPenyokong", null, false, null);
                generateDropdown("ddlKO", "Akhir_Tahun_WS.asmx/GetListKO", null, false, null);
                generateDropdown("ddlKP", "Akhir_Tahun_WS.asmx/GetListKP", null, false, null);
                generateDropdown("ddlDasar", "Akhir_Tahun_WS.asmx/GetListDasar", null, true, null);
                generateDropdown("ddlUnit", "Akhir_Tahun_WS.asmx/GetListUnit", null, true, "ddlBahagian");
                generateDropdown("ddlPTJPusat", "Akhir_Tahun_WS.asmx/GetListPTJPusat", null, false, null);
            ...
            async function AjaxGetRecordBajet(id) {
                ...
                try {
                    ...
                    const response = await fetch('Akhir_Tahun_WS.asmx/LoadRecordBajet_KB', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json'
                        },
            ...
            async function AjaxGetRecordBajet_Kew(id) {
                ...
                try {
                    ...
                    const response = await fetch('Akhir_Tahun_WS.asmx/LoadRecordBajet_Kew', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json'
                        },
            ...
            async function AjaxGetRecordHdrBajet(id) {
                ...
                try {
                    ...
                    const response = await fetch('Akhir_Tahun_WS.asmx/LoadHdrBajet_KB', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json'
                        },
            ...
            async function AjaxGetRecordHdrBajet_Kew(id) {
                ...
                try {
                    ...
                    const response = await fetch('Akhir_Tahun_WS.asmx/LoadHdrBajet_Kew', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json'
                        },
            ...
            function getInfoKW(KodKW) {
                ...
                fetch('Akhir_Tahun_WS.asmx/LoadKW', {
                    method: 'POST',
                    headers: {
                        'Content-Type': "application/json"
                    },
            ...
            function getVotSbg(kodSbg) {
                ...
                fetch('Akhir_Tahun_WS.asmx/LoadSbg', {
                    method: 'POST',
                    headers: {
                        'Content-Type': "application/json"
                    },
            ...
            function getInfoKO(KodKO) {
                ...
                fetch('Akhir_Tahun_WS.asmx/LoadKO', {
                    method: 'POST',
                    headers: {
                        'Content-Type': "application/json"
                    },
            ...
            async function AjaxGetRecordH1(tahun, kw, ko, kp, ptj, votam) {
                ...
                try {
                    ...
                    const response = await fetch('Akhir_Tahun_WS.asmx/LoadHdrH1', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json'
                        },
            ...
            async function AjaxGetRecordH2(tahun, kw, ko, kp, ptj, votam) {
                ...
                try {
                    ...
                    const response = await fetch('Akhir_Tahun_WS.asmx/LoadHdrH2', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json'
                        },
            ...
            function initDDLKP() {
                $.ajax({
                    url: 'Akhir_Tahun_WS.asmx/GetListKP?q={query}',
                    method: "POST",
                    data: JSON.stringify({
                        q: ''
                    }),
            ...
            $('#ddlUnit').dropdown({
                ...
                fullTextSearch: true,
                apiSettings: {
                    url: 'Akhir_Tahun_WS.asmx/GetListUnit?q={query}',
                    method: 'POST',
                    dataType: "json",
                    contentType: 'application/json; charset=utf-8',
                    cache: false,
            ...
            function initDDLPTJPusat() {
                $.ajax({
                    url: 'Akhir_Tahun_WS.asmx/GetListPTJPusat?q={query}',
                    method: "POST",
                    data: JSON.stringify({
                        q: ''
                    }),
            ...
            async function initDropdownObjAm(id) {
                ...
                $('#' + id).dropdown({
                    ...
                    apiSettings: {
                        url: 'Akhir_Tahun_WS.asmx/GetObjAm?q={query}',
                        method: 'POST',
                        dataType: "json",
                        contentType: 'application/json; charset=utf-8',
                        cache: false,
            ...
            function getPTJ_Butiran(val) {
                ...
                fetch('Akhir_Tahun_WS.asmx/ViewPTJ', {
                    method: 'POST',
                    headers: {
                        'Content-Type': "application/json"
                    },
