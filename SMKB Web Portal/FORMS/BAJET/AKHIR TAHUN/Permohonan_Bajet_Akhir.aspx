<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Permohonan_Bajet_Akhir.aspx.vb" Inherits="SMKB_Web_Portal.Permohonan_Bajet_Akhir" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="FormContents" runat="server">
    ...
    <script type="text/javascript">
        ...
        //        $.ajax({
        //            url: 'Akhir_Tahun_WS.asmx/GetListPenyokong?q={query}',
        //            method: "POST",
        //            data: JSON.stringify({
        //                q: ''
        //            }),
        ...
        $(document).ready(function () {
            ...
            generateDropdown("ddlPenyokong", "Akhir_Tahun_WS.asmx/GetListPenyokong", null, false, null);
        ...
        $(document).ready(function () {            
            ...
            tbl = $("#tblDataSenarai_trans").DataTable({
                ...
                "ajax": {
                    "url": "Akhir_Tahun_WS.asmx/LoadOrderRecord_SenaraiTransaksiBajet",
                    "method": 'POST',
                    "contentType": "application/json; charset=utf-8",
                    "dataType": "json",
        ...
        async function ajaxSaveOrder_Hantar(data) {
            ...
            return new Promise((resolve, reject) => {
                $.ajax({
                    "url": "Akhir_Tahun_WS.asmx/HantarPermohonan",
                    method: 'POST',
...
;
        ...
        async function ajaxSaveOrder(order) {
            ...
            return new Promise((resolve, reject) => {
                $.ajax({
                    url: 'Akhir_Tahun_WS.asmx/SaveOrders_Bajet',
                    method: 'POST',
                    data: JSON.stringify(order),
                    dataType: 'json',
                    contentType: 'application/json; charset=utf-8',
        ...
        async function AjaxGetRecordBajet(id) {
            ...
            try {
                ...
                const response = await fetch('Akhir_Tahun_WS.asmx/LoadRecordBajet', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
        ...
        async function AjaxGetRecordHdrBajet(id) {
            ...
            try {
                ...
                const response = await fetch('Akhir_Tahun_WS.asmx/LoadHdrBajet', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
        ...
        function getDateNow() {
            ...
            fetch('Akhir_Tahun_WS.asmx/LoadDateNow', {
                method: 'POST',
                headers: {
                    'Content-Type': "application/json"
                },
        ...
        function getPTJ() {
            ...
            fetch('Akhir_Tahun_WS.asmx/LoadPTJ', {
                method: 'POST',
                headers: {
                    'Content-Type': "application/json"
                },
        ...
        function getKp_Name(KodKP) {
            ...
            fetch('Akhir_Tahun_WS.asmx/LoadKP', {
                method: 'POST',
                headers: {
                    'Content-Type': "application/json"
                },
        ...
        function getDasar_Name(KodDasar) {
            ...
            fetch('Akhir_Tahun_WS.asmx/LoadDasar', {
                method: 'POST',
                headers: {
                    'Content-Type': "application/json"
                },
        ...
        //alert("pusat "+Kod)
            fetch('Akhir_Tahun_WS.asmx/LoadPTJ_Pusat', {
                method: 'POST',
                headers: {
                    'Content-Type': "application/json"
                },
