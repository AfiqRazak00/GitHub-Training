<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Penyelarasan_Bajet_PTJ__0305.aspx.vb" Inherits="SMKB_Web_Portal.Penyelarasan_Bajet_PTJ__0305" %>
            ...
            <table  id="tblData_mhn"  class="table table-striped">
                        ...
                        <tfoot class="sticky-footer">
                            ...
                            <tr>
                                ...
                                <button type="button" class="btn btn-success btnLulus_mhn" data-toggle="tooltip" data-placement="bottom" >Hantar</button>
            ...
            $(document).ready(function () {
                ...
                tbl_ = $("#tblDataSenarai_trans_").DataTable({
                    ...
                    "columns": [
                        ...
                        { "data": "Program" },
                        { "data": "Justifikasi",  "className": "center" },
                        { "data": "Jumlah", "render": function (data) { return parseFloat(data).toLocaleString('en-US', { valute: 'USD', minimumFractionDigits: 2 }); }, "className": "center" },
                        { "data": "Tkh_Transaksi" }//,
                        //{
                        //    "data": "Kod_Status_Dok",
                        //    render: function (data, type, row, meta) {
