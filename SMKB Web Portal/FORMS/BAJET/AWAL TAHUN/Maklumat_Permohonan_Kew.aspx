<%@ Page Title="" Language="vb" AutoEventWireup="false" Async="true" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Maklumat_Permohonan_Kew.aspx.vb" Inherits="SMKB_Web_Portal.Maklumat_Permohonan_Kew" %>
                        ...
                        <div class="container-fluid mt-3">
                            <ul class="nav nav-tabs" id="subTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation" onclick="subTabChange(event)" data-tab="TRK">
                                    <a class="nav-link " tabindex="-1" data-tab="TRK" aria-disabled="true">Butiran Permohonan</a>
                                </li>
                                <li class="nav-item" role="presentation" onclick="subTabChange(event)" data-tab="LJR">
                                    <a class="nav-link " tabindex="-1" data-tab="LJR" aria-disabled="true">Maklumat Lanjut Permohonan</a>
                                </li>
                            </ul>
                        </div>
                                    ...
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group input-group">
                                                ...
                                                <label class="input-group__label">Bahagian</label>
                                            </div>
                                            <div class="form-group input-group">
