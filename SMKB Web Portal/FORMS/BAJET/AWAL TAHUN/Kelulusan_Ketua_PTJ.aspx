<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Kelulusan_Ketua_PTJ.aspx.vb" Inherits="SMKB_Web_Portal.Kelulusan_Ketua_PTJ" %>
                    ...
                    <div class="search-filter">
                        ...
                        <div align="center">
                            <table>
                                <tr>
                                    <td >
                                        <button type="button" class="btn btn-success btnHantar_Kew" id="btnHantar_Kew" name="btnHantar_Kew" data-toggle="tooltip" data-placement="bottom" >Hantar Kepada Bendahari</button>
                                        </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <tbody id="tableID">
                            <tr style="display: none; width: 100%" class="table-list">
                               ...
                               <%--<td style="width: 26%">
                                ...
                                <td style="width: 4%">
                                    <button id="Button1" runat="server" class="btn btnDelete" type="button" style="color: red" visible="false">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                tbl = $("#tblDataSenarai_trans").DataTable({
                    ...
                    "info": false,
                    "ajax": {
                        "url": "Awal_Tahun_WS.asmx/LoadSummaryKetuaPTJ",
                        "method": 'POST',
            ...
            $('.btnHantar_Kew').click(async function () {
                //console.log("test")
                $('#detailMakluman_Hantar_Submit').html("Anda pasti untuk hantar kelulusan ke bendahari?");
            ...
            async function ajaxSaveOrderLulus_Submit(order) {
                ...
                return new Promise((resolve, reject) => {
                    ...
                    $.ajax({
                        url: 'Awal_Tahun_WS.asmx/Lulusorder_Ketua_Submit',
                        method: 'POST',
            ...
            async function ajaxSaveOrderXLulus(order) {
                ...
                return new Promise((resolve, reject) => {
                    $.ajax({
                        url: 'Awal_Tahun_WS.asmx/XLulusorder_Bajet',
                        method: 'POST',
                        data: JSON.stringify(order),
                        dataType: 'json',
                        contentType: 'application/json; charset=utf-8',
