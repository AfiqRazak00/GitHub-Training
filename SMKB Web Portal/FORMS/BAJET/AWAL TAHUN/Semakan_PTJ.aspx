<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Semakan_PTJ.aspx.vb" Inherits="SMKB_Web_Portal.Semakan_PTJ" %>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                tbl_ = $("#tblDataSenarai_trans_").DataTable({
                    ...
                    "ajax": {
                        "url": "Awal_Tahun_WS.asmx/LoadOrderRecord_SenaraiMohonBajet_KewPtj",
                        "method": 'POST',
                        "contentType": "application/json; charset=utf-8",
                        "dataType": "json",
                        "dataSrc": function (json) {
            ...
            async function ajaxSaveOrderLulus_Submit(order) {
                ...
                return new Promise((resolve, reject) => {
                    ...
                    $.ajax({
                        url: 'Awal_Tahun_WS.asmx/Lulusorder_Kew_Submit',
                        method: 'POST',
