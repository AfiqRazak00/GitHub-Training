<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Semakan_Bendaharix.aspx.vb" Inherits="SMKB_Web_Portal.Semakan_Bendaharix" %>
                            ...
                            <div class="transaction-table table-responsive">
                                <table id="tblDataSenarai_trans" class="table table-striped" style="width: 99%">
                                    <thead>
                                        ...
                                        <tr> 
                                            <th scope="col" style="text-align: center;">Kod PTj</th>
                                            <th scope="col" style="text-align: center;" class="auto-style4" >Butiran</th>
                                ...
                                <div class="col-md-12">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <label class="input-group__label">PTj/PBU</label>
                                        </div>
                                    </div>
                                </div>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                tbl = $("#tblDataSenarai_trans").DataTable({
                    ...
                    createdRow: async function (row, data, dataIndex) {
                        var butiranDetail = await GetButiranKod(data.Kod_PTJ);
                        ...
                        $(row).find('.lblNo1').html(butiranDetail[0].Pejabat);
                ...
                async function GetButiranKod(Kod_PTJ) {
                  
                    return new Promise((resolve, reject) => {
                        $.ajax({
                            url: "Awal_Tahun_WS.asmx/ReadPTJ",
                            method: "POST",
            ...
            async function AjaxGetRecordH1(tahun, kw, ko, kp, ptj, votam) {
                ...
                try {
                    ...
                    const response = await fetch('Awal_Tahun_WS.asmx/LoadHdrH1_Bendahari', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json'
                        },
            ...
            async function AjaxGetRecordH2(tahun, kw, ko, kp, ptj, votam) {
                ...
                try {
                    ...
                    const response = await fetch('Awal_Tahun_WS.asmx/LoadHdrH2_Bendahari', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json'
                        },
