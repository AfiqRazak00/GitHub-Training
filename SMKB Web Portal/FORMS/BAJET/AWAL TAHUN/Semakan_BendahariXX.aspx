<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Semakan_BendahariXX.aspx.vb" Inherits="SMKB_Web_Portal.Semakan_BendahariXX" %>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                tbl_ = $("#tblDataSenarai_trans_").DataTable({
                    ...
                    "ajax": {
                        "url": "Awal_Tahun_WS.asmx/LoadOrderRecord_SenaraiMohonBajet_Bendahari",
                        "method": 'POST',
            ...
            async function ajaxSaveOrderLulus(order) {
               // console.log(order)
                return new Promise((resolve, reject) => {
                    $.ajax({
                        url: 'Awal_Tahun_WS.asmx/Lulusorder_Bendahari',
                        method: 'POST',
                        data: JSON.stringify(order),
                        dataType: 'json',
                        contentType: 'application/json; charset=utf-8',
