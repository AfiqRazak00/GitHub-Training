<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Semakan_Bendahari.aspx.vb" Inherits="SMKB_Web_Portal.Semakan_Bendahari" %>
    ...
    <div id="PermohonanTab" class="tabcontent" style="display: block">
        ...
        <div class="container-fluid">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <%--<li class="nav-item active" role="presentation" style="visibility:hidden"><a class="nav-link active" data-toggle="tab" id="tab-pemohon" href="#home">Senarai Permohonan</a></li>
                --%><li class="nav-item active" role="presentation"<%-- style="visibility:hidden"--%>><a class="nav-link" data-toggle="tab" id="tab-abm" href="#menu1">Ringkasan ABM</a></li>
            </ul>
                    ...
                    <asp:Panel ID="Panel1" runat="server">
                        ...
                        <div class="col-md-12">
                            <div class="transaction-table table-responsive">
                                <table id="tblDataSenarai_trans_" class="table table-striped" style="width: 100%">
                                    <thead>
                                        <tr>                                          
                    ...
                    <div class="search-filter">
                        ...
                        <div class="col-md-12">
                            <div class="transaction-table table-responsive">
                                <table id="tblDataSenarai_trans" class="table table-striped" style="width: 99%">
                                    <thead>
                                        <tr>
                                            <th scope="col" colspan ="3" class="auto-style5"></th>
                                            <th scope="col" colspan ="2" style="text-align: center;" class="auto-style5">VOT 10000</th>
                                            <th scope="col" colspan ="2" style="text-align: center;" class="auto-style5">VOT 20000</th>
                                            <th scope="col" colspan ="2" style="text-align: center;" class="auto-style5">VOT 30000</th>
                                            <th scope="col" colspan ="2" style="text-align: center;" class="auto-style5">VOT 40000</th>
                                            <th scope="col" colspan ="3" class="auto-style5"></th>
                                        </tr>
                                        <tr>                                          
                                            <th scope="col" style="text-align: center;">Bil.</th>
                                            <th scope="col" style="text-align: center;" class="auto-style4" >Kod PTJ</th>
                                            <th scope="col" style="text-align: center;" class="auto-style4" >PTJ</th>
                                            <th scope="col" style="text-align: right;">Operasi (RM)</th>
                                            <th scope="col" >Komited (RM)</th>
                                            <th scope="col" >Operasi (RM)</th>
                                            <th scope="col" >Komited (RM)</th>  
                                            <th scope="col" >Operasi (RM)</th>
                                            <th scope="col" >Komited (RM)</th> 
                                            <th scope="col" >Operasi (RM)</th>
                                            <th scope="col" >Komited (RM)</th>
                                            <th scope="col" >Jumlah Operasi (RM)</th> 
                                            <th scope="col" >Jumlah Komited (RM)</th> 
                                            <th scope="col" >Jumlah Permohonan (RM)</th> 
                                        </tr>
                                    </thead>
                                    ...
                                    <tfoot>
                                        <tr>
                                            <th colspan="3" style="text-align: right">Jumlah Besar (RM)</th>
                        ...
                        <div align="center">
                            <table>
                                <tr>
                                    <td >
                                        <button type="button" class="btn btn-success btnHantar_Kew" id="btnHantar_Kew" name="btnHantar_Kew" data-toggle="tooltip" data-placement="bottom" >Hantar Kepada NC</button>
                                        </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div id="ALL" class="modal-sub-tab mt-2">
                            <div  class="modal-body">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-row">
                                         <div class="col-md-2">
                                            <input type="text" class=" input-group__input  form-control input-sm " placeholder="&nbsp;" id="txtKodObjekAm" name="txtKodObjekAm" readonly/>
                                            <label class="input-group__label">Objek Am</label>
                                        </div>
                                        <div class="col-md-2">
                                            <input type="text" class=" input-group__input  form-control input-sm " placeholder="&nbsp;" id="txtJumAmAll" name="txtJumAmAll" />
                                            <label class="input-group__label">Cadangan Jumlah Objek Am</label>
                                        </div>
                                        <div class="col-md-2">
                                             <button type="button" class="btn btn-success btnObjAm" id="btnObjAm" name="btnObjAm" data-toggle="tooltip" data-placement="bottom" >Simpan</button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="modal-body">
                                <div class="col-md-12">                 
                                    ...
                                    <div class="transaction-table table-responsive" >
                                        <table id="tblDataObjekAm" class="table table-striped " border="1" style="width: 99%"  >
                                            <thead style="background-color: #f2f2f2;">
                                                <tr>
                                                    <th scope="col" colspan="1" style="text-align: center; border: 1px solid #000;">Bil.</th>
                                                    <th scope="col" colspan="4" style="text-align: center; border: 1px solid #000;">Vot Sebagai</th>
                                                    <th scope="col" colspan="4" style="text-align: center; border: 1px solid #000;">Mohon (RM)</th>
                                                    <th scope="col" colspan="1" style="text-align: center; border: 1px solid #000;">Papar</th>
                                                </tr>
                                            </thead>
                                            <tbody id="tableID_Senarai_ObjekAm">
                                                <tr style="display: none; width: 100% " >
                                                    <td class="custom-table-1" colspan="1" style="text-align: center; ">
                                                        <label id="RowCountBil" name="RowCountBil" runat="server" class="RowCountBil" style="text-align: left" width="60%" />
                                                    </td>
                                                    <td class="custom-table-1" colspan="4" style="text-align: left; ">
                                                        <label id="ObjSebagai" name="ObjSebagai" runat="server" class="ObjSebagai"  width="60%" />
                                                    </td>
                                                     <td class="custom-table-1" colspan="4" style="text-align: right; ">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <th class="custom-table-1" colspan="5" style="text-align: right; ">Jumlah Besar (RM)</th>
                                                    <th class="custom-table-1"  colspan="4" style="text-align: right; "><label id="JumlahAm" name="JumlahAm" runat="server" class="JumlahAm"  width="60%" /></th>
                                                    <th class="custom-table-1" style=""> </th>
                                                </tr>
                                    ...
                                    <div class="transaction-table table-responsive">
                                        <table id="tblDataPaparPermohonan" class="table table-striped" style="width: 99%"  >
                                            <thead style="background-color: #f2f2f2;">
                                                <tr>
                                                    <th scope="col" colspan="1" style="text-align: center;  border: 1px solid #000;">Bil.</th>
                                                    <th scope="col" colspan="4" style="text-align: center;  border: 1px solid #000;">Program</th>
                                                    <th scope="col" colspan="4" style="text-align: center;  border: 1px solid #000;">Butiran</th>
                                                    <th scope="col" colspan="4" style="text-align: center;  border: 1px solid #000;">Mohon (RM)</th>
                                                    <th scope="col" colspan="1" style="text-align: center;  border: 1px solid #000;">Papar</th>
                                                </tr>
                                            </thead>
                                            <tbody id="tableID_DataPaparPermohonan" class="table table-striped" > 
                                                <tr style="display: none; width: 100%" >                                                   
                                                    <td class="custom-table-1" colspan="1" style="text-align: left;">
                                           ...
                                           <tfoot>
                                                <tr>
                                                    <th class="custom-table-1"  colspan="10" style="text-align: right">Jumlah Besar (RM)</th>
                                                    <th class="custom-table-1"  style="text-align: right"><label id="TotalJumlahSbg" name="TotalJumlahSbg" runat="server" class="TotalJumlahSbg"  width="60%" /></th>
                                                </tr>
                                            </tfoot>
                                        </table>
            ...
            <table  id="tblData"  class="table table-striped">
                        ...
                        <tbody id="tableID">
                            <tr style="display: none; width: 100%" class="table-list">
                                ...
                                <td style="width: 45%">
                                    <input  runat="server" type="text" class="data-id" name="data-id"  hidden/>
            ...
            <table  id="tblData_mhn"  class="table table-striped">
                        ...
                        <tbody id="tableID_mhn">
                            <tr style="display: none; width: 100%" class="table-list">
                                ...
                                <td style="width: 35%">
                                    <input id="Butiran_mhn" name="Butiran_mhn" runat="server"  class="form-control underline-input Butiran_mhn" style="text-align: left" width="60%" />
                                </td>
                           <%--    <td style="width: 30%">
                                ...
                                <td style="width: 4%" >
                                    <button id="lbtnCari" runat="server" class="btn btnDelete" type="button" style="color: red" visible ="false"> 
                                        <i class="fa fa-trash"></i>
                                    </button>
                                </td>
                        ...
                        <tfoot class="sticky-footer">
                            ...
                            <tr>
                                ...
                                <button type="button" class="btn btn-secondary btnSimpan" data-toggle="tooltip" data-placement="bottom" title="Draft">Simpan</button>
                                <button type="button" class="btn btn-success btnHantar" data-toggle="tooltip" data-placement="bottom" title="Simpan dan Hantar">Hantar</button>--%>
                                <button type="button" class="btn btn-setsemula btnXLulus_mhn" data-toggle="tooltip" data-placement="bottom" style="visibility:hidden">Hapus</button>
                                <button type="button" class="btn btn-success btnLulus_mhn" data-toggle="tooltip" data-placement="bottom" style="visibility:hidden">Simpan</button>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-danger"
                                    data-dismiss="modal">Tidak</button>
                                <button type="button" class="btn default-primary btnYa_Hantar_X" runat="server" id="Button2">Ya</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal fade" id="maklumanModalBil_Hantar_X" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <!-- Submit all Confirmation Modal Hantar  -->
                <div class="modal fade" id="confirmationModal_Hantar_Submit" tabindex="-1" role="dialog"
                    aria-labelledby="confirmationModalLabelHantar_Submit" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="confirmationModalLabel_Hantar_Submit">Pengesahan</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <span id="detailMakluman_Submit"></span>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-danger"
                                    data-dismiss="modal">Tidak</button>
                                <button type="button" class="btn default-primary btnYa_Hantar_Submit" runat="server" id="Button3">Ya</button>
                            </div>
                        </div>
                    </div>
                </div>

                      <!-- Submit all   Makluman Modal  -->
                <div class="modal fade" id="maklumanModalBil_Hantar_Submit" tabindex="-1" role="dialog"
                    aria-labelledby="maklumanModalLabelBil_Hantar_Submit" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="maklumanModalLabelBil_Hantar_Submit">Makluman</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <span id="detailMaklumanBil_Hantar_Submit"></span>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn default-primary" id="tutupMaklumanBil_Hantar_Submit"
                                    data-dismiss="modal">Tutup</button>
                            </div>
                        </div>
                    </div>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                tbl = $("#tblDataSenarai_trans").DataTable({
                    ...
                    "info": false,
                    "ajax": {
                        "url": "Awal_Tahun_WS.asmx/LoadSummaryBendahariPTJ",
                        "method": 'POST',
                    ...
                    "columns": [
                        ...
                        { "data": "Kod_Bahagian", "title": "Kod_Bahagian" },
                        {
                            "data": "NamaBahagian",
                            "width": "10%",
                            render: function (data, type, row, meta) {
                        ...
                        },
                        {
                            ...
                            "render": function (data, type, row) {
                                ...
                                //}
                                //return data;
                                var data = parseFloat(data).toLocaleString('en-US', { valute: 'USD', minimumFractionDigits: 2 });
                                ...
                                var link = `
                                <td style="width: 10%; ">
                                    <label data-toggle="tooltip" data-placement="top" title="Vot 10000" style="cursor: pointer; display: block ; text-align: right;" onclick="rowClickHandlerABM('${valtahun}','${valkw}','${valko}','${valkp}','${valPtj}','${valVotAm}','${KodTab}')">${data}</label>
                                </td>`;
                                return link;
                        ...
                        },
                        {
                            ...
                            //"render": function (data) { return parseFloat(data).toLocaleString('en-US', { valute: 'USD', minimumFractionDigits: 2 }); },
                            "width": "5%",
                            "render": function (data, type, row) {
                        ...
                        },
                        {
                            ...
                            "render": function (data, type, row) {
                                ...
                                var link = `
                                    <td style="width: 10%" >
                                    <label  data-toggle="tooltip" data-placement="top" title="Vot 20000" style="cursor: pointer; display: block ; text-align: right;"  onclick="rowClickHandlerABM('${valtahun}','${valkw}','${valko}','${valkp}','${valPtj}','${valVotAm}','${KodTab}')">${data}</label>
                                    </td>`;
                                return link;
                            }
                        },
                        ...
                        },
                        {
                            ...
                            "width": "5%",
                            "render": function (data, type, row) {
                                var sum = parseFloat(row.Operasi_10000) + parseFloat(row.Operasi_20000) + parseFloat(row.Operasi_30000) + parseFloat(row.Operasi_40000);
                                var data = parseFloat(sum).toLocaleString('en-US', { valute: 'USD', minimumFractionDigits: 2 });
                                return data;
                        ...
                        },
                        {
                            ...
                            "width": "5%",
                            "render": function (data, type, row) {
                                var sum = parseFloat(row.Komited_10000) + parseFloat(row.Komited_20000) + parseFloat(row.Komited_30000) + parseFloat(row.Komited_40000);
                                var data = parseFloat(sum).toLocaleString('en-US', { valute: 'USD', minimumFractionDigits: 2 });
                                return data;
                        ...
                        },
                        {
                            ...
                            "render": function (data, type, row) {
                                if (type === 'display' || type === 'filter') {
                                    var sum = parseFloat(row.Operasi_10000) + parseFloat(row.Operasi_20000) + parseFloat(row.Operasi_30000) + parseFloat(row.Operasi_40000) +
                                        parseFloat(row.Komited_10000) + parseFloat(row.Komited_20000) + parseFloat(row.Komited_30000) + parseFloat(row.Komited_40000)

                                    return parseFloat(sum).toLocaleString('en-US', { valute: 'USD', minimumFractionDigits: 2 });
                                }
                                return data;
                            }
                        }
                    ...
                    , footerCallback: function (row, data, start, end, display) {
                        ...
                        let columnsToSum = [];
                        //i merujuk kepada start baca footer column
                        for (let i = 3; i <= 13; i++) {
                            columnsToSum.push(i);
                        }
                        ...
                        columnsToSum.forEach(columnIndex => {
                            ...
                            api.column(columnIndex).footer().innerHTML = parseFloat(columnTotal).toLocaleString('en-US', { valute: 'USD', minimumFractionDigits: 2 }); 
                        });
            ...
            $(document).ready(function () {
                ...
                tbl_ = $("#tblDataSenarai_trans_").DataTable({
                    ...
                    "ajax": {
                        "url": "Awal_Tahun_WS.asmx/LoadOrderRecord_SenaraiMohonBajet_KetuaPtj",
                        "method": 'POST',
                        "contentType": "application/json; charset=utf-8",
                        "dataType": "json",
                        "dataSrc": function (json) {
            ...
            $('.btnHantar_Kew').click(async function () {
                //console.log("test")
                $('#detailMakluman_Hantar_Submit').html("Anda pasti untuk hantar kelulusan ke NC?");
                $('#confirmationModal_Hantar_Submit').modal('toggle');
            ...
            $('.btnObjAm').click(async function () {
                //$('#confirmationModal_Hantar_Submit').modal('hide');
                ...
                var newOrder = {
                    order: {
                        KumpWang: $('#txtKW').val(), //kw
                        KodKO: $('#txtKO').val(), //ko
                        PTJ: $('#txtBahagian').val(), //ptj
                        Jumlah: $('#txtJumAmAll').val(), //jum am
                        Dasar: $('#txtKodObjekAm').val() //kod vot
                       
                    }
                };

                var result = JSON.parse(await ajaxSave_am(newOrder));
                tbl.ajax.reload()
                //if (result.Status !== false) {

                //    $('#maklumanModalBil_Hantar_Submit').modal('toggle');
                //    $('#detailMaklumanBil_Hantar_Submit').html(result.Message);
            ...
            async function ajaxSave_am(order) {

                return new Promise((resolve, reject) => {

                    $.ajax({
                        url: 'Awal_Tahun_WS.asmx/save_objek_am',
                        method: 'POST',
            ...
            $('.btnYa_Hantar_Submit').click(async function () {
                $('#confirmationModal_Hantar_Submit').modal('hide');
                ...
                var result = JSON.parse(await ajaxSaveOrderLulus_Submit(newOrder));
            ...
            async function ajaxSaveOrderLulus_Submit(order) {

                return new Promise((resolve, reject) => {

                    $.ajax({
                        url: 'Awal_Tahun_WS.asmx/Lulusorder_Bendahari_Submit',
                        method: 'POST',
                        data: JSON.stringify(order),
                        dataType: 'json',
                        contentType: 'application/json; charset=utf-8',
            ...
            async function ajaxSaveOrder(order) {
                ...
                return new Promise((resolve, reject) => {
                    $.ajax({
                        url: 'Awal_Tahun_WS.asmx/Lulusorder',
                        method: 'POST',
                        data: JSON.stringify(order),
                        dataType: 'json',
                        contentType: 'application/json; charset=utf-8',
            ...
            async function ajaxSaveOrderLulus(order) {
              // console.log(order)
                return new Promise((resolve, reject) => {
                    $.ajax({
                        url: 'Awal_Tahun_WS.asmx/Lulusorder_Kew',
                        method: 'POST',
                        data: JSON.stringify(order),
                        dataType: 'json',
                        contentType: 'application/json; charset=utf-8',
            ...
            async function ajaxSaveOrderXLulus(order) {
                ...
                return new Promise((resolve, reject) => {
                    $.ajax({
                        url: 'Awal_Tahun_WS.asmx/XLulusorder_Bajet_Bendahari',
                        method: 'POST',
                        data: JSON.stringify(order),
                        dataType: 'json',
                        contentType: 'application/json; charset=utf-8',
            ...
            async function calculateGrandTotal() {
                ...
                //        curTotal_Dt += parseFloat(NumDefault(value));
            ...
            async function rowClickHandler_Kew(id) {
                ...
                if (id !== "") {
                    ...
                    generateDropdown("ddlBahagian_mhn", "Awal_Tahun_WS.asmx/GetListBahagian", null, false, null);
                    generateDropdown("ddlKW_mhn", "Awal_Tahun_WS.asmx/GetListKW", null, false, null);
                    //generateDropdown("ddlPenyokong_mhn", "Awal_Tahun_WS.asmx/GetListPenyokong", null, false, null);
                    generateDropdown("ddlKO_mhn", "Awal_Tahun_WS.asmx/GetListKO", null, false, null);
                    generateDropdown("ddlKP_mhn", "Awal_Tahun_WS.asmx/GetListKP", null, false, null);
                    generateDropdown("ddlDasar_mhn", "Awal_Tahun_WS.asmx/GetListDasar", null, true, null);
                    generateDropdown("ddlUnit_mhn", "Awal_Tahun_WS.asmx/GetListUnit", null, true, "ddlBahagian");
                    generateDropdown("ddlPTJPusat_mhn", "Awal_Tahun_WS.asmx/GetListPTJPusat", null, false, null);
            ...
            async function setValueToRow_HdrBajet(orderDetail) {
               ...
               // console.log("a");
                ...
                buildDdl('ddlBahagian', orderDetail.Kod_Bahagian);
                buildDdl('ddlUnit', orderDetail.Kod_Unit);
                buildDdl('ddlKW', orderDetail.Kod_Kump_Wang);
                buildDdl('ddlKO', orderDetail.Kod_Operasi);
                buildDdl('ddlKP', orderDetail.Kod_Projek);
                buildDdl('ddlDasar', orderDetail.Kod_Dasar);
                buildDdl('ddlPTJPusat', orderDetail.PTJ_Pusat);
            ...
            //    var HiddenBil = $(row).find("td > .data-id-hidden");
            //    HiddenBil.val(orderDetail.Jumlah);
            ...
            async function AjaxGetRecordBajet_Kew(id) {
                ...
                try {
                    ...
                    const response = await fetch('Awal_Tahun_WS.asmx/LoadRecordBajet_Kew', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json'
                        },
            ...
            async function AjaxGetRecordHdrBajet_Kew(id) {
                ...
                try {
                    ...
                    const response = await fetch('Awal_Tahun_WS.asmx/LoadHdrBajet_Kew', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json'
                        },
            ...
            async function rowClickHandlerABM(tahun, kw, ko, kp, ptj, vot, kodTab) {
                ...
                if (kodTab == "1") {
                    ...
                    getObjekAm(tahun, kw, ko, kp, ptj, vot)
            ...
            function getObjekAm(tahun, kw, ko, kp, ptj, vot ) {
                //Cara Pertama

                fetch('Awal_Tahun_WS.asmx/Baca_ObjekAm', {
                    method: 'POST',
                    headers: {
                        'Content-Type': "application/json"
                    },
                    ...
                    .then(data => setObjekAm(data.d))

            }

            function setObjekAm(data) {
                
                data = JSON.parse(data);
                document.getElementById("txtJumAmAll").value = ""
                if (data[0].JumlahBendahari === "") {
                    document.getElementById("txtJumAmAll").value = ""
                }

                else { document.getElementById("txtJumAmAll").value = data[0].JumlahBendahari}
            ...
            async function calculateGrandTotalSbg() {
                ...
                //    alert("index " +index)
                //    curTotal_Dt += NumDefault($(obj).html());
            ...
            async function setValueToRow_HdrH1(row, orderDetail) {
                ...
                Jumlah.html(parseFloat(orderDetail.Jumlah).toLocaleString('en-US', { valute: 'USD', minimumFractionDigits: 2 }))
            ...
            async function setValueToRow_HdrH2(row, orderDetail) {
               ...
               // Jumlah1.html(orderDetail.Jumlah.toFixed(2));
                Jumlah1.html(parseFloat(orderDetail.Jumlah).toLocaleString('en-US', { valute: 'USD', minimumFractionDigits: 2 }))
                //var ObjSebagaiAll = $(row).find("td > .ObjSebagaiAll"); //button
                //console.log(ObjSebagaiAll);
            ...
            async function AjaxGetRecordH1(tahun, kw, ko, kp, ptj, votam) {
                ...
                try {
                    ...
                    const response = await fetch('Awal_Tahun_WS.asmx/LoadHdrH1_Bendahari_new', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json'
                        },
            ...
            async function AjaxObjekAm(tahun, kw, ko, kp, ptj, votam) {

                try {

                    const response = await fetch('Awal_Tahun_WS.asmx/Baca_ObjekAm', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json'
                        },
            ...
            async function AjaxGetRecordH2(tahun, kw, ko, kp, ptj, votam) {
                ...
                try {
                    ...
                    const response = await fetch('Awal_Tahun_WS.asmx/LoadHdrH2_Bend_New', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json'
                        },
            ...
            async function setValueToRow_Transaksi(row, orderDetail) {
                ...
                var HiddenBil = $(row).find("td > .data-id");
                HiddenBil.val(orderDetail.No_Item);
                //var butirptj = $(row).find("td > .label-ptj-list");
                //butirptj.html(orderDetail.ButiranPTJ);
