<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Kelulusan_Ketua_PTJ_xx0305.aspx.vb" Inherits="SMKB_Web_Portal.Kelulusan_Ketua_PTJ_xx0305" %>
            ...
            <table  id="tblData"  class="table table-striped">
                        ...
                        <tfoot class="sticky-footer">
                            ...
                            <tr>
                                ...
                                <button type="button" class="btn btn-setsemula btnXLulus" data-toggle="tooltip" data-placement="bottom" >Tidak Lengkap</button>
   ...
   <h6>Butiran Permohonan</h6>
        ...
        <script type="text/javascript">
            ...
            async function ShowDetails_Sbg(obj) {
               ...
               // location.replace('<%=ResolveClientUrl("~/FORMS/BAJET/AWAL TAHUN/Kelulusan_Ketua_PTJ.aspx")%>?Semakan_PTJ=' + valKodVot);
                        ...
                        },
                        {
                            ...
                            "render": function (data, type, row) {
                                ...
                                <td style="width: 10%; text-align: right;">
                                    <label data-toggle="tooltip" data-placement="top" title="Vot 10000" style="cursor: pointer; display: block;" onclick="rowClickHandlerABM('${valtahun}','${valkw}','${valko}','${valkp}','${valPtj}','${valVotAm}','${KodTab}')">${data}</label>
                                </td>`;
                                return link;
            ...
            async function ajaxSaveOrderLulus(order) {
               // console.log(order)
                return new Promise((resolve, reject) => {
                    $.ajax({
                        url: 'Awal_Tahun_WS.asmx/Lulusorder_Ketua',
                        method: 'POST',
                        data: JSON.stringify(order),
                        dataType: 'json',
                        contentType: 'application/json; charset=utf-8',
