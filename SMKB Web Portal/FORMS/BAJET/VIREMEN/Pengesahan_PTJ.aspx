<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Pengesahan_PTJ.aspx.vb" Inherits="SMKB_Web_Portal.Pengesahan_PTJ" %>
        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <input class="input-group__input" id="lblRujukan" type="text" placeholder="&nbsp;" name="Rujukan Surat Mohon" readonly style="background-color: #f0f0f0"/>
                            <label class="input-group__label" for="Rujukan Surat Mohon">Rujukan Surat Mohon</label>
                        </div>
                        <div class="form-group col-md-6">
                            <input class="input-group__input" style="width: 20%; text-align: right; background-color: #f0f0f0"" id="lblJumlah" name="lblJumlah" type="number" placeholder="&nbsp;" value="0.00" readonly />
                ...
                <div class="col-md-12" style="visibility: hidden">
                    <div class="form-row">
                        <div class="form-group col-md-3">
                            <input class="input-group__input" id="BakiSemasa_Drpd" type="text" placeholder="&nbsp;" name="Baki Semasa (RM)" readonly style="background-color: #f0f0f0" />
                            <label class="input-group__label" for="Baki Semasa (RM)">Baki Semasa (RM)</label>
                        </div>
                        <div class="form-group col-md-3">
                            <input class="input-group__input" id="BakiSlpsVire_Drpd" type="text" placeholder="&nbsp;" name="Baki Selepas Viremen (RM)" readonly style="background-color: #f0f0f0" />
                            <label class="input-group__label" for="Baki Selepas Viremen (RM)">Baki Selepas Viremen (RM)</label>
                        </div>
                        <div class="form-group col-md-3">
                            <input class="input-group__input" id="BakiSemasa_Kpd" type="text" placeholder="&nbsp;" name="Baki Semasa (RM)" readonly style="background-color: #f0f0f0" />
                            <label class="input-group__label" for="Baki Semasa (RM)">Baki Semasa (RM)</label>
                        </div>

                        <div class="form-group col-md-3">
                            <input class="input-group__input" id="BakiSlpsVire_Kpd" type="text" placeholder="&nbsp;" name="Baki Selepas Viremen (RM)" readonly style="background-color: #f0f0f0" />
                            <label class="input-group__label" for="Baki Selepas Viremen (RM)">Baki Selepas Viremen (RM)</label>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            tbl = $("#tblDataSenarai_trans").DataTable({
                ...
                "ajax": {
                    "url": "ViremenWS.asmx/LoadOrderRecord_SenaraiTransaksiViremen_KB",
                    "method": 'POST',
                    "contentType": "application/json; charset=utf-8",
                    "dataType": "json",
        ...
        async function ajaxSaveOrder_Hantar(order) {
            ...
            return new Promise((resolve, reject) => {
                $.ajax({
                    url: 'ViremenWS.asmx/HantarPermohonan_MohonViremen_KB',
                    method: 'POST',
                    data: JSON.stringify(order),
                    dataType: 'json',
                    contentType: 'application/json; charset=utf-8',
