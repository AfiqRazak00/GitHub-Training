...
Public Class order_Viremen
    ...
    Public Property BakiSemasa_Drpd As Decimal
    Public Property BakiSlpsVire_Drpd As Decimal
    ...
    Public Property BakiSemasa_Kpd As Decimal
    Public Property BakiSlpsVire_Kpd As Decimal
    ...
    Public Sub New(orderId_ As String, Tujuan_ As String, Rujukan_ As String, Jumlah_ As String, KW_ As String, KO_ As String, KP_ As String, PTJ_ As String, VOT_ As String,
                   ...
                   KW_Kpd_ As String, KO_Kpd_ As String, KP_Kpd_ As String, Ptj_Kpd_ As String, Vot_Kpd_ As String, BakiSemasa_Drpd_ As Decimal, BakiSlpsVire_Drpd_ As Decimal, BakiSemasa_Kpd_ As Decimal, BakiSlpsVire_Kpd_ As Decimal)
        ...
        Ptj_Drpd = Ptj_Drpd_
        Vot_Drpd = Vot_Drpd_
        BakiSemasa_Drpd = BakiSemasa_Drpd_
        BakiSlpsVire_Drpd = BakiSlpsVire_Drpd_
        ...
        Ptj_Kpd = Ptj_Kpd_
        Vot_Kpd = Vot_Kpd_
        BakiSemasa_Kpd = BakiSemasa_Kpd_
        BakiSlpsVire_Kpd = BakiSlpsVire_Kpd_
