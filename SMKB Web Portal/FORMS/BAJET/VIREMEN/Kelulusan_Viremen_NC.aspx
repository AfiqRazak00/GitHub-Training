<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Kelulusan_Viremen_NC.aspx.vb" Inherits="SMKB_Web_Portal.Kelulusan_Viremen_NC" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            tbl = $("#tblDataSenarai_trans").DataTable({
                ...
                "ajax": {
                    "url": "ViremenWS.asmx/LoadOrderRecord_SenaraiTransaksiViremen_NC",
                    "method": 'POST',
                    "contentType": "application/json; charset=utf-8",
                    "dataType": "json",
        ...
        async function ajaxSaveOrder_Hantar(order) {
            ...
            return new Promise((resolve, reject) => {
                $.ajax({
                    url: 'ViremenWS.asmx/HantarPermohonan_MohonViremen_NC',
                    method: 'POST',
                    data: JSON.stringify(order),
                    dataType: 'json',
                    contentType: 'application/json; charset=utf-8',
