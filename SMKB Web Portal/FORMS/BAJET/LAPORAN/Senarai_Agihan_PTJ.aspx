<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Senarai_Agihan_PTJ.aspx.vb" Inherits="SMKB_Web_Portal.Senarai_Agihan_PTJ" %>
            ...
            <div>
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalCenterTitle">Senarai Agihan Bajet</h5>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                tbl = $("#tblDataSenarai_trans_rpt").DataTable({
                    ...
                    "ajax": {
                        "url": "LaporanBajetWS.asmx/LoadOrderRecord_SenaraiLulusTransaksiAgihanBajet",
                        method: 'POST',
