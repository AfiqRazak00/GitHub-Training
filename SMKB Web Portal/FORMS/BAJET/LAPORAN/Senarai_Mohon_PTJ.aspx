<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Senarai_Mohon_PTJ.aspx.vb" Inherits="SMKB_Web_Portal.Senarai_Mohon_PTJ" %>
            ...
            <div>
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalCenterTitle">Senarai Permohonan Bajet Awal Tahun</h5>
                        ...
                        <div class="col-md-12">
                            <div class="transaction-table table-responsive">
                                <table id="tblDataSenarai_trans_rpt" class="table table-striped" style="width: 100%">
                                    <thead>
                                        <tr>                                          
                                            <th scope="col" style="width: 10%">No. Mohon</th>                                            
                                            <th scope="col" style="width: 30%">Program</th>
                                            <th scope="col" style="width: 30%">Justifikasi</th>
                                            <th scope="col" style="width: 10%">Tarikh Transaksi</th>
                                            <th scope="col" style="width: 10%">Kod Vot</th>     
                                            <th scope="col" style="width: 30%">Butiran</th>
                                            <th scope="col" style="width: 10%">Amaun (RM)</th>
                                        </tr>
                                    </thead>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                tbl = $("#tblDataSenarai_trans_rpt").DataTable({
                    ...
                    "ajax": {
                        "url": "LaporanBajetWS.asmx/LoadOrderRecord_SenaraiLulusTransaksiAwalBajet",
                        method: 'POST',
