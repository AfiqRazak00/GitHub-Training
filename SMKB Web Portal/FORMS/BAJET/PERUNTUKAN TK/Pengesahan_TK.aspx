<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Pengesahan_TK.aspx.vb" Inherits="SMKB_Web_Portal.Pengesahan_TK" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            tbl = $("#tblDataSenarai_trans").DataTable({
                ...
                "ajax": {
                    "url": "TambahKurangWS.asmx/LoadOrderRecord_SenaraiTransaksiTK_Sah",
                    "method": 'POST',
        ...
        async function ajaxSaveOrder_Hantar(order) {
            ...
            return new Promise((resolve, reject) => {
                $.ajax({
                    url: 'TambahKurangWS.asmx/HantarPermohonan_MohonTK_Sah',
                    method: 'POST',
                    data: JSON.stringify(order),
                    dataType: 'json',
                    contentType: 'application/json; charset=utf-8',
