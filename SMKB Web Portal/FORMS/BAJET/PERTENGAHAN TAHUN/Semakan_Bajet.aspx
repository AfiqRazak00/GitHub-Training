<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Semakan_Bajet.aspx.vb" Inherits="SMKB_Web_Portal.Semakan_Bajet" %>
                ...
                <div class="col-md-12">
                    <div class="form-row">
                        ...
                        <div class="input-group-append">
                            <button id="btnSearch" runat="server" class="btn btn-outline btnSearch" type="button" style="width: auto; height: auto">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            tbl = $("#tblDataPerolehanDtl").DataTable({
                ...
                "ajax": {
                    "url": '<%= ResolveClientUrl("~/FORMS/BAJET/PERTENGAHAN TAHUN/Pertengahan_Tahun_WS.asmx/LoadOrderRecord_DataReviewPTJ") %>',
                    ...
                    },
                    {
                        ...
                        "render": function (data, type, row) {
                            ...
                            return `
                                <div class="row">
                                    <div class="col-md-2">
                                        <button type="button" class="btn editBtn" value="${data.KodVot}" data-toggle="tooltip" data-placement="top"  title="Kemaskini" onclick="rowClickVotAm('${data.KodVot}')">
