<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Pindah_Bajet.aspx.vb" Inherits="SMKB_Web_Portal.Pindah_Bajet" %>
            ...
            <div>
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalCenterTitle">Pindah Bajet&nbsp;</h5>
                    ...
                    <div class="search-filter">
                        ...
                        <div class="form-row justify-content-center">
                            <div class="form-group row col-md-6">
                                <label for="kodTahun" class="col-sm-2 col-form-label" style="text-align: right">Tahun :</label>
                                <div class="col-sm-7">
                                    <div class="input-group">
                                        <asp:DropDownList ID="kodTahun" runat="server" DataTextField="Tahun" DataValueField="Tahun" class="ui fluid search dropdown selection custom-select"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    ...
                    <div class="float-right">                       
                        <button type="button" class="btn btn-success btnHantar" data-toggle="tooltip" data-placement="bottom" >Proses</button>
                    </div>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                tbl = $("#tblDataSenarai_trans_rpt").DataTable({
                    ...
                    "ajax":
                    {
                        "url": "PindahBajet_WS.asmx/LoadRecord_BukuVot",
                        type: 'POST',
                        data: function (d) {
                           // console.log($('#MainContent_FormContents_DropDownList1').val()+" text " + $('#txtVotDari').val())
                            return "{ votMula: '" + $('#MainContent_FormContents_txtVotDari').val() + "',votHingga: '" + $('#MainContent_FormContents_txtVotHingga').val() + "',tkhMula: '" + $('#txtTarikhDari').val() + "', tkhHingga: '" + $('#txtTarikhHingga').val() + "', kodkw: '" + $('#MainContent_FormContents_kodkw').val() + "', syarikat: '" + $('#MainContent_FormContents_DropDownList2').val() + "', ptj: '" + $('#MainContent_FormContents_DropDownList1').val() + "'}";
                        },
