...
Public Class Kelulusan_JK_emel
    Inherits System.Web.UI.Page

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        'check if token exist
        ' Dim a = Session("NoRujukan1")
    ...
    '    <WebMethod()>
    '    Public Shared Function GetSessionData() As String
    '        ' Read session data
    '        Dim sessionData As String = HttpContext.Current.Session("NoRujukan1")
