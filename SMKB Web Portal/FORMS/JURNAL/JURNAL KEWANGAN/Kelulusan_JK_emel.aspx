<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedPageEmail.master" CodeBehind="Kelulusan_JK_emel.aspx.vb" Inherits="SMKB_Web_Portal.Kelulusan_JK_emel" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="FormContents" runat="server">
    ...
    <div id="PermohonanTab" class="tabcontent" style="display: block">
        ...
        <!-- Modal -->
        <div id="permohonan" style="visibility:hidden">
            <div >
        ...
        <script type="text/javascript">
            ...
            // Get the value of 'parameterName' from the query string
                //var parameterValue =  getParameterByName('no');
            ...
            function readSessionData() {
                $.ajax({
                    type: "POST",
                    url: "Transaksi_WS.asmx/GetSessionData",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (response) {
                        //console.log("Session data:", response.d);

                        rowClickHandler(response.d);
