                    ...
                    <table  id="tblData"  class="table table-striped" style="width: 100%;">
                        <thead>
                            <tr style="width: 100%; text-align: center">
                                <th scope="col" style="width: 30%">COA</th>                                
                                <th scope="col" style="width: 12%">Kumpulan Wang</th>
                                <th scope="col" style="width: 11%">Operasi</th>
                                <th scope="col" style="width: 11%">Projek</th>
				                <th scope="col" style="width: 12%">PTj</th>
                                <th scope="col" style="width: 10%">Debit (RM)</th>
                                <th scope="col" style="width: 10%">Kredit(RM)</th>
                                <th scope="col" style="width: 4%">Tindakan</th>
                        ...
                        <tfoot class="sticky-footer">
                            ...
                            <button type="button" class="btn btn-success btnHantar" data-toggle="tooltip" data-placement="bottom" title="Simpan dan Hantar">Simpan dan Hantar</button> </td>
                           </tr>
