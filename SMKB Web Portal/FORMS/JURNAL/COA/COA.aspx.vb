...
Public Class COA
    ...
    Private Function fCreateDtKW() As DataTable
        ...
        Try
            ...
            dt.Columns.Add("COA_Index", GetType(String))

            Dim strKodKW, strKodKO, strKodKP, strKodPTJ, strKodVOT As String
            Dim strButirKW, strButirKO, strButirKodKP, strButirPTJ, strCOAIndex As String
            ...
            Dim strSql As String = $"SELECT Kod_Kump_Wang, Kod_Operasi, Kod_Projek, Kod_PTJ, Kod_Vot, Status, COA_Index FROM SMKB_COA_Master where Kod_PTJ = '{searchDDL}'"
            ...
            For i As Integer = 0 To dsKod.Tables(0).Rows.Count - 1
                ...
                strCOAIndex = dsKod.Tables(0).Rows(i)(6).ToString
                ...
                dt.Rows.Add(strKodKW, strKodKO, strKodKP, strKodPTJ, strKodVOT, strStatus, strButirKW, strButirKO, strButirKodKP, strButirPTJ, strCOAIndex)
            Next
            ...
            For Each row As GridViewRow In rows
                ...
                If chk.Checked Then
                    ...
                    If fCheckRec(strSql) = 0 Then
                        ...
                        Dim strButiran As String = strKodkw + " " + fGetKW(strKodkw) + " " + strKodko + " " + fGetKO(strKodko) + " " + strKodkp + " " + fGetKP(strKodkp) + " " + strKodptj + " " + fGetPTJ(strKodptj) + " " + strVot + " " + fGetVot(strVot)

                        strSql = "insert into SMKB_COA_Master (Kod_Kump_Wang, Kod_Operasi, Kod_Projek, Kod_PTJ, Kod_Vot,Status, COA_Index)    
                         values (@KodKW ,@KodKO, @KodKP, @KodPTJ, @KodVOT, @Status , @COA_Index)"
                        ...
                        Dim paramSql() As SqlParameter = {
                            ...
                            New SqlParameter("@COA_Index", strButiran)
                        }
    ...
    Private Sub lbtnKemaskini_Click(sender As Object, e As EventArgs) Handles lbtnKemaskini.ServerClick
        ...
        Try
            ...
            If fCheckRec(strSql) = 0 Then
                ...
                Dim strButiran As String = strKodkw + " " + fGetKW(strKodkw) + " " + strKodko + " " + fGetKO(strKodko) + " " + strKodkp + " " + fGetKP(strKodkp) + " " + strKodptj + " " + fGetPTJ(strKodptj) + " " + strKodvot + " " + fGetVot(strKodvot)
            ...
            Else
                ...
                'UPDATE
                strSql = "update SMKB_COA_Master set Kod_Kump_Wang = @KodKW , Kod_Operasi = @KodKO,  Kod_Projek = @KodKP, Kod_PTJ = @KodPTJ,  Kod_Vot = @KodVOT, Status =@Status , COA_Index =@COA_Index
                             WHERE Kod_Kump_Wang = @KodKW
                                                        AND Kod_Operasi = @KodKO
                                                        AND Kod_Projek = @KodKP
                                                        AND Kod_PTJ = @KodPTJ
