...
Public Class KW
    ...
    Private Sub lbtnSimpan_Click(sender As Object, e As EventArgs) Handles lbtnSimpan.ServerClick
        ...
        Try
            ...
            Dim intStatus As String = rblStatus.SelectedValue
            ...
            If fCheckRec(strSql) = 0 Then
                ...
                strSql = "insert into SMKB_Kump_Wang (Kod_Kump_Wang , Butiran, Kawalan_Bajet, Status) values(@KodKW,@Butiran,@Status,@Status)"
    ...
    Private Sub gvKodKW_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles gvKodKW.RowCommand
        Try
            If e.CommandName = "Select" Then
                ...
                Dim statusAktif = selectedRow.Cells(2).Text.ToString
