            ...
            <div class="form-row justify-content-center">
                <div class="form-group row col-md-6">
                    ...
                    <div class="col-sm-8">
                            ...
                            <asp:DropDownList ID="ddlCari" runat="server" CssClass="form-control" EnableFilterSearch="true" FilterType="StartsWith"></asp:DropDownList>
                    ...
                    <asp:GridView ID="gvKod" CssClass="table table-bordered table-striped grid" Width="100%" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Kod_VOT" HeaderText="Kod Vot" ReadOnly="true">
                             ...
                             <asp:BoundField DataField="COA_Index" HeaderText="COA Index" ReadOnly="true">
                                <ItemStyle Width="15%" HorizontalAlign="Left" />
                            </asp:BoundField>
