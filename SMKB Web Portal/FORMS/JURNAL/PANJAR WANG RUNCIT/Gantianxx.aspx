...
<asp:Content ID="Content1" ContentPlaceHolderID="FormContents" runat="server">
    ...
    <div id="PermohonanTab" class="tabcontent" style="display: block">
        ...
        <div class="form-row">
            ...
            <h6>Maklumat Tambahan</h6>
                                ...
                                <div class="application-table table-responsive">
                                    <table class="table table-striped" id="tblPemeriksaan" sstyle="width:auto">
                                        <thead>
                                            <tr>
                                                    <th scope="col" style="text-align: center;" class="auto-style1">Gantian</th>
                                                    <th scope="col" class="auto-style1">No. Resit</th>
                                                    <th scope="col" class="auto-style1">Butir Perbelanjaan</th>
                                                    <th scope="col" class="auto-style1">Vot</th>
                                                    <th scope="col" class="auto-style1">PTj</th>
                                                    <th scope="col" class="auto-style1">Kumpulan Wang</th>
                                                    <th scope="col" class="auto-style1">Operasi</th>
                                                    <th scope="col" class="auto-style1">Projek</th>
                                                    <th scope="col" class="auto-style1">Jumlah (RM)</th>
        ...
        <div class="form-row">
            <div class="form-group col-md-12" align="right">
               <%-- <button type="button" class="btn btn-danger btnPadam">Padam</button>
                <button type="button" class="btn btn-secondary btnSimpan" data-toggle="tooltip" data-placement="bottom" title="Simpan Draf">Simpan Draf</button>
                --%><button type="button" class="btn btn-success btnHantar" data-toggle="tooltip" data-placement="bottom" title="Simpan">Simpan</button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        $(document).ready(async function () {
            ...
            //    //},
            //    ajax: {
            //        url: "Panjar_WS.asmx/LoadOrderRecord_SenaraiGantian_hdr",
            //        method: 'POST',
            ...
            //            var ptj = $('#lblNoPtj').val();
            //            var kumpulan = $('#ddlKumpulan').val()
        ...
        function getBaki(kumpulan) {

            rowHoverClick_Load(kumpulan);
        }

        async function rowHoverClick_Load(kump) {
        /*    alert("a " +kump)*/
            if (kump !== "") {
                //var recordHdr = await AjaxGetRecordHdr_Load(id);
                //await AddRowHeader_Load(null, recordHdr);

                var record = await AjaxGetRecord_Load(kump);
                //await clearAllRows();
                await AddRow_Load(null, record);
                //PopupSemak(2);

                var record_dtl = await AjaxGetRecord_Dtl(id);
                //await clearAllRows();
                await AddRow(null, rerecord_dtlcord)

            }
        }

        async function AjaxGetRecord_Dtl(id) {

            try {

                const response = await fetch('Panjar_WS.asmx/LoadRecordPermohonan_Gantian', {
                    method: 'POST',
                    headers: {
        ...
        async function AddRow_Load(totalClone, objOrder) {
            var counter = 1;
        ...
        async function AjaxGetRecord_Load(kump) {

            try {

                const response = await fetch('Panjar_WS.asmx/LoadRecordPermohonan_Dtl_Gantian', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
        ...
        async function calculateGrandTotal() {
            ...
            $('#lblJumlah').val(curTotal_Jumlah.toFixed(2));
        }
        ...
        async function setValueToRow_HdrPermohonan(orderMDetail) {
            ...
            $(ddlKumpulan).dropdown('set selected', orderMDetail.Kod_Kumpulan);
        ...
        async function setValueToRow_Permohonan(row, orderMDetail) {
            ...
            balance = baki.val();
            $("#lblBakiSemasa").val(orderMDetail.Baki_Peruntukan);
        ...
        async function AjaxGetAgih_Baki(ptj, kumpulan, tarikh) {
