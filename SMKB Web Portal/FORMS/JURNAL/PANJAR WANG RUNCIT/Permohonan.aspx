...
<asp:Content ID="Content1" ContentPlaceHolderID="FormContents" runat="server">
    ...
    <div id="PermohonanTab" class="tabcontent" style="display: block">
                        ...
                        <tbody id="tableID">
                            <tr style="display: none; width: 100%;" class="table-list">
                                ...
                                <td>
                                    ...
                                    <label id="HidlblPTj" name="HidlblPTj" class="Hid-ptj-list" style="visibility: visible"></label>
                                </td>
                                <td>
                                ...
                                <td style="width: 10%">
                                    <input type="date" name="lblTkhResit" id="lblTkhResit"  runat="server"  class="form-control lblTkhResit" />
                                    <label id="HidlbTkhResit" name="HidlbTkhResit" class="Hid-tkh-resit" style="visibility: hidden"></label>
                                </td>
                                <td style="width: 10%">
        ...
        <div class="form-row">
            <div class="form-group col-md-12" align="right">
                ...
                <button type="button" class="btn btn-success btnHantar" data-toggle="tooltip" data-placement="bottom" title="Simpan dan Hantar">Simpan dan Hantar</button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        async function getBaki(kumpulan) {
            ...
            await AjaxGetAgih_Baki(kumpulan);
        }
        ...
        async function setValueToRow_HdrPermohonan(orderMDetail) {
            ...
            //alert("aa " + orderMDetail.Kod_Kumpulan)
            var selectObj_Kumpulan = $('#ddlKumpulan')
            $(ddlKumpulan).dropdown('set selected', orderMDetail.Kod_Kumpulan);
            selectObj_Kumpulan.append("<option value = '" + orderMDetail.Kod_Kumpulan + "'>" + orderMDetail.ButiranKumpulan + "</option>")
