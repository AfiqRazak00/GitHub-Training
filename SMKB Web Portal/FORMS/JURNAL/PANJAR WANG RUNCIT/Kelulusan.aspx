                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        <input type="text" class="input-group__input" id="lblJumlahMohon" name="Jumlah Mohon" placeholder="&nbsp;" readonly style="background-color: #f0f0f0" value="0.00"/>
                                        <label class="input-group__label" for="Jumlah Mohon">Jumlah Mohon</label>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <input type="text" class="input-group__input" id="lblJumlahTolak" name="lblJumlahTolak" placeholder="&nbsp;" readonly style="background-color: #f0f0f0" value="0.00"/>
                                        <label class="input-group__label" for="Jumlah Tolak">Jumlah Tolak</label>
                                    </div>
                                    <div class="form-group col-md-4">
                            ...
                            <div class="col-md-12">
                                <div class="application-table table-responsive">
                                    <table class="table table-striped" id="tblPemeriksaan">
                                        <thead>
                                            <tr>
                                                    <th scope="col" style="text-align: center;"><input type="checkbox" id="selectAll" onchange="toggleCheckboxes(this)">&nbsp Lulus</th>
                                        ...
                                        <tbody class="tableID">
                                            <tr style="display: none; width: 100%" class="table-list">
                                                 <td class="auto-style1" style="text-align: center;">
                                                    <input type="checkbox" id="chkResit" name="chkResit" class="chkResit" onchange="calculate(this)">
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                tbl = $('#tblDataSenarai_perm').DataTable({
                    ...
                    ajax: {
                        url: "Panjar_WS.asmx/LoadOrderRecord_SenaraiPemeriksaan_Kelulusan",
                        method: 'POST',
