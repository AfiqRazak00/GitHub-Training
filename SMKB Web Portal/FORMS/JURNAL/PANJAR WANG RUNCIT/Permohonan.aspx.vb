...
Public Class OrderM
    ...
    Public Sub New(OrderMId_ As String, Tarikh_ As String, NoPtj_ As String, Kumpulan_ As String, Jumlah_ As String, BakiSemasa_ As String, lOrderMDetails_ As List(Of OrderMDetail))
        OrderMId = OrderMId_
        Tarikh = Tarikh_
        NoPtj = NoPtj_
        Kumpulan = Kumpulan_
