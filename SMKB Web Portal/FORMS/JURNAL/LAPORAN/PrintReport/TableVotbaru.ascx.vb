...
Public Class TableVotbaru
    ...
    Private Sub LoadDataTable(kodVotFrom As String, kodVotTO As String, namaTable As String)
        ...
        If KategoriVot IsNot Nothing Then
            param.Add(New SqlParameter("@kategoriVot", KategoriVot))
        Else
            param.Add(New SqlParameter("@kodVotFrom", kodVotFrom))
            param.Add(New SqlParameter("@kodVotTo", kodVotTO))
        End If
        param.Add(New SqlParameter("@bulan", Session("bulan")))
        param.Add(New SqlParameter("@tahun", Session("tahun")))
        param.Add(New SqlParameter("@ptj", Session("ptj")))

        Dim result = db.Read(query, param)
        BindDataToTableDynamic(result, namaTable)
    End Sub
