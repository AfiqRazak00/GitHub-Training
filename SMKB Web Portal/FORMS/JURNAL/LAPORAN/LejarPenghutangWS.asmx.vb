...
Public Class LejarPenghutangWS
    ...
    Private Function GetOrder_TransaksiLejarAm(tahun As String, syarikat As String, ptj As String, kodjenis As String, kodkw As String) As DataTable
        ...
        param.Add(New SqlParameter("@tahun", tahun))
        param.Add(New SqlParameter("@ptj", ptj))
        param.Add(New SqlParameter("@kodjenis", kodjenis))
        param.Add(New SqlParameter("@kodkw", kodkw))
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function LoadVotDetails(KodVot As String, KodPtj As String, Tahun As String, KodKW As String, KodOperasi As String, KodProjek As String) As DataTable
        Dim db As New DBKewConn
        Dim param As New List(Of SqlParameter)
        ...
        param.Add(New SqlParameter("@Tahun", Tahun))
        param.Add(New SqlParameter("@KodKW", KodKW))
        param.Add(New SqlParameter("@KodOperasi", KodOperasi))
        param.Add(New SqlParameter("@KodProjek", KodProjek))
    ...
    Private Function GetOrder_LV1(bulan As String, tahun As String, syarikat As String, ptj As String, Optional kod As String = "") As DataTable
        ...
        If kod <> "" Then
            param.Add(New SqlParameter("@kodvot", Left(kod, 2)))
        End If
    ...
    Private Function GetOrder_LV2(bulan As String, tahun As String, syarikat As String, ptj As String, Optional kod As String = "") As DataTable
        ...
        If kod <> "" Then
            param.Add(New SqlParameter("@kodvot", kod))
        End If
