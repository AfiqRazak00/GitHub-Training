                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-4 order-md-3">
                                            <div class="form-group">
                                               ...
                                               <%--<input type="text" id="txtVotHingga" name="txtVotHingga"  class="form-control">--%>
                                                <asp:DropDownList ID="txtVotHingga" runat="server"  DataTextField="Butiran" DataValueField="Kod_Vot" class="ui fluid search dropdown selection custom-select"></asp:DropDownList>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 order-md-2">
                                            <div class="form-group">
                                                ...
                                                <asp:DropDownList ID="txtVotDari" runat="server" DataTextField="Butiran" DataValueField="Kod_Vot"  class="ui fluid search dropdown selection custom-select"></asp:DropDownList>
                                            </div>
                                        </div>
