 ...
 <%--                                       <div class="col-md-3 order-md-3">
        ...
        <script type="text/javascript">
            ...
            function setData(data) {
                ...
                $('#lblLebihan').html(parseFloat(data[0].LebihanPendapatan).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")); /*row1*/
                $('#lblLunasGeran').html(data[0].Pelunasan_Geran.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")); /*row2*/
                $('#lblFaedahDiterima').html(data[0].Faedah_Keuntungan.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")); /*row3*/
                $('#lblManfaatP').html(data[0].Manfaat_Pekerja.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")); /*row4*/
                $('#lblSusutNilai').html(data[0].Susut_Nilai.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")); /*row5*/
                $('#lblBPelunasan').html(data[0].Belanja_Penulasan.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")); /*row6*/
                $('#lblBHutangRagu').html(data[0].Belanja_Hutang_Ragu.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ","));; /*row7*/
                $('#lblFaedahPajakan').html(data[0].Faedah_Pajakan.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")); /*row8*/
                $('#lblPPAkaun').html(data[0].Pelarasan_Pengkelasan_Akaun.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")); /*row9*/
                //key in manual(data manual) Pelarasan Pengkelasan Akaun
                //key in manual(data manual)		Pelarasan Hartanah, Loji dan Peralatan
                $('#lblPHartanah').html(data[0].Pelarasan_Hartanah.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")); /*row12*/
                $('#lblKeuntunganAtasPelupusan').html(data[0].Keuntungan_atas_Pelupusan.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")); /*row13*/
                $('#lblKerugianAtasPelupusan').html(data[0].Kerugian_atas_Pelupusan.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")); /*row14*/
                $('#sum1').text(sum1.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ","));  /*row15*/

                $('#lblPPAkaunBelumTerima').text(a.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ","));  /*row15*/
                $('#lblPPPertukaranBelumTerima').text(b.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")); /*row16*/
                $('#lblPPPendahuluan').text(c.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")); /*row17*/
                $('#lblPPendapatanTerakru').html(data[0].Pengurangan_Terakru.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")); /*row18*/
                $('#lblPPAkaunBelumBayar').html(data[0].Pengurangan_Belum_Bayar.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")); /*row19*/
                $('#sum2').text(sum2.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")); /*row20*/

                // $('#lblManfaatPekerjaDibayar'). key in manual (data manual) A - Manfaat Pekerja Dibayar  /*row21*/
                $('#sum3').text(sum3.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ","));  /*row23*/

                $('#lblFKeuntunganDiterima').text(FaedahDiterima.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")); /*row26*/
                $('#lblDividenDiterima').html(data[0].Dividen_Terima.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")); /*row27*/
                $('#lblPelaburanLain').html(data[0].Pelaburan_Lain.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")); /*row28*/
                $('#lblPPinjamanKenderaan').html(data[0].Penerimaan_Pinjaman.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")); /*row30*/
                $('#lblBPKenderaan').html(data[0].Bayaran_Pinjaman.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")); /*row31*/
                $('#lblPHartanahLoji').html(data[0].Pembelian_Hartanah.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")); /*row32*/
                $('#lblPembelianATK').html(data[0].Pembelian_Aset_Tak_Ketara.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")); /*row33*/
                $('#lblTerimaanHPH').html(data[0].Terimaan_Hasil_Pelupusan.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")); /*key in manual(data manual) Terimaan Hasil Pelupusan Hartanah, Loji dan Peralatan*/ /*row34*/
                $('#lblPPembayaranPDK').html(data[0].Pembayaran_Pembinaan.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")); /*row35*/
                $('#sum4').text(sum4.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ","));  /*row36*/

                $('#lblPPajakanKewangan').html(data[0].Pembayaran_Pajakan.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")); /*row39*/
                $('#lblPPelbagaiGK').html(data[0].Penerimaan_Geran_Khusus.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")); /*row42*/
                $('#sum5').text(sum5.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")); /*row43*/


                $('#lblSum3Sum4Sum5').text(Sum345.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")); /*row45*/
                $('#lblTDKAwalTahun').html(data[0].Baki_1_Jan.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ","));  /*row46*/
                $('#sum6').text(sum6.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ",")); /*row47*/

                $('#lblSimpananTetap').html(data[0].Simpanan_Tetap.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ","));  /*row50*/
                $('#lblTunaiTanganBank').html(data[0].Tunai_Di_Tangan.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ","));  /*row51*/
                $('#sum7').text(sum7.toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ","));  /*row52*/
