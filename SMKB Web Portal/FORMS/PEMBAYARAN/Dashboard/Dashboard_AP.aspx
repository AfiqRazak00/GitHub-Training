<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Dashboard_AP.aspx.vb" Inherits="SMKB_Web_Portal.Dashboard_AP" %>
    ...
    <div id="dashboard" class="tabcontent" style="display: block;">
                    ...
                    <div class="card-wrapper">
                        <div class="card gradient-card shadow h-auto py-2" style="background-color: #d0581c;">
                            <div class="gradient-header text-center mx-auto" style="width: 100%;">
                                 <b>BILANGAN INVOIS YANG DIKELUARKAN</b>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="rounded-top-icon">
                            <i class="fas fa-solid fa-file-invoice fa-4x shadow h-auto" style="color: #d0581c"></i>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3" style="z-index: 3;">
                    <div class="card-wrapper">
                        <div class="card gradient-card shadow h-auto py-2" style="background-color: #f1ac88;">
                            <div class="gradient-header text-center mx-auto" style="width: 100%;">
                                <b>JUMLAH INVOIS YANG DIKELUARKAN</b>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="rounded-top-icon">
                            <i class="fas fa-solid fa-file-invoice-dollar fa-4x shadow h-auto" style="color: #f1ac88;"></i>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3" style="z-index: 3;">
                    <div class="card-wrapper">
                        <div class="card gradient-card shadow h-auto py-2" style="background-color: #fbb023;">
                            <div class="gradient-header text-center mx-auto" style="width: 100%;">
                                <b>JUMLAH PEMBAYARAN BAUCAR DENGAN INVOIS</b>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="rounded-top-icon">
                            <i class="fas fa-solid fa-receipt fa-4x shadow h-auto" style="color: #fbb023"></i>
                        </div>
                    </div>
                </div>
                <div class="col-md-3" style="z-index: 3;">
                    <div class="card-wrapper">
                        <div class="card gradient-card shadow h-auto py-2" style="background-color: #5d6d7c;">
                            <div class="gradient-header text-center mx-auto" style="width: 100%;">
                                <b>JUMLAH PEMBAYARAN BAUCAR TANPA INVOIS</b>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="rounded-top-icon">
                            <i class="fas fa-solid fa-receipt fa-4x shadow h-auto" style="color: #5d6d7c;"></i>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xl-6 col-md-6 mb-4">
                    <div class="card shadow">
                        ...
                        <div
                            ...
                            <h6 class="m-0 font-weight-bold " style="color:darkslategrey">Invois yang Dikeluarkan Mengikut Tahun</h6>
                        </div>
                        <!-- Card Body -->
                        <div class="card-body">
                ...
                <div class="col-xl-6 col-md-6 mb-4">
                    <div class="card shadow">
                        ...
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold " style="color:darkslategrey">Invois Mengikut Status</h6>
                        </div>
                        <!-- Card Body -->
                        <div class="card-body">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $.ajax({
                    url: 'DashboardAP_WS.asmx/LoadJum_Bill',
                    method: 'POST',
                    dataType: 'JSON',
                ...
                ////Get data for card
                $.ajax({
                    url: 'DashboardAP_WS.asmx/LoadJumInvois',
                    method: 'POST',
                    dataType: 'JSON',
                    contentType: "application/json; charset=utf-8",
                    data: JSON.stringify({}),
                    success: function (data) {
                        /* sini amik data dekat db macam aku amik column butiran dan baki*/
                        var data = JSON.parse(data.d);
                        TotalTerima = data[0].JUMLAH;
                        var formattedData = parseFloat(data[0].JUMLAH).toLocaleString('en-MY', { style: 'decimal'});
                        $("#jumTerima").html(formattedData);
                        /*TotalTerima = $("#jumTerima").html();*/

                        $.ajax({
                            url: 'DashboardAP_WS.asmx/LoadJumTunggakPeratus',
                            method: 'POST',
                            dataType: 'JSON',
                            contentType: "application/json; charset=utf-8",
                            ...
                            success: function (data) {
                                ...
                                $("#jumTunggakPeratus").html(formattedData);
                                TotalTunggak = $("#jumTunggakPeratus").html();
                            },
                            error: function () {
                                console.log('Error fetching data from the web service.');
                            }
                ...
                $.ajax({
                    url: 'DashboardAP_WS.asmx/LoadJumTunggak',
                    method: 'POST',
                    dataType: 'JSON',
                    contentType: "application/json; charset=utf-8",
                    data: JSON.stringify({}),
                ...
                $.ajax({
                    url: 'DashboardAP_WS.asmx/LoadTunai',
                    method: 'POST',
                    dataType: 'JSON',
                    contentType: "application/json; charset=utf-8",
                    data: JSON.stringify({}),
            ...
            function Pie(index) {
                $.ajax({
                    url: 'DashboardAP_WS.asmx/LoadDataStatusPie',
                    method: 'POST',
                    dataType: 'JSON',
                    contentType: "application/json; charset=utf-8",
                    data: JSON.stringify({}),
                    success: function (data) {
                        ...
                        chartData.forEach(function (item) {
                            values.push(item.DAFTAR_INVOIS);
                            values.push(item.TERIMA_PERMOHONAN_PEMBAYARAN);
                        });
            ...
            function createPieChart(values) {
                ...
                return new Chart(ctx, {
                    type: 'doughnut',
                    data: {
                        labels: ['Daftar Invois', 'Terima Permohonan Pembayaran'],     //category untuk value
                        datasets: [{
            ...
            function bar() {
                $.ajax({
                    url: 'DashboardAP_WS.asmx/LoadJumTerima_Tahunan',
                    method: 'POST',
                    dataType: 'JSON',
                    contentType: "application/json; charset=utf-8",
                    data: JSON.stringify({}),
