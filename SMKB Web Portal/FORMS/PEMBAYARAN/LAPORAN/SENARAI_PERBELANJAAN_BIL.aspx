<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="SENARAI_PERBELANJAAN_BIL.aspx.vb" Inherits="SMKB_Web_Portal.SENARAI_PERBELANJAAN_BIL" %>
                ...
                <div>
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalCenterTitle">SENARAI PERBELANJAAN - PEMIUTANG - PEMBEKAL/STAF JENIS :LAIN - LAIN BAYARAN (BIL / INVOIS)</h5>
                        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            tbl = $("#tblDataSenarai_LejarPemiutangBil").DataTable({
                ...
                buttons: [
                    'csv', 'excel', {
                        ...
                        action: function (e, dt, button, config) {
                            window.open('<%=ResolveClientUrl("~/FORMS/PEMBAYARAN/LAPORAN/PrintReport/report_Senarai_Perbelajaan_Bil.aspx")%>', '_blank');
                ...
                "ajax":
                {
                    "url": "LejarPemiutangWS.asmx/LoadOrderRecord_PembayaranInvoisBil",
                    type: 'POST',
                    data: function (d) {
                        return "{ tahun: '" + $('#MainContent_FormContents_txtyear').val() + "', kod_kw2: '" + $('#MainContent_FormContents_kodkw').val() + "'}"
                    },
