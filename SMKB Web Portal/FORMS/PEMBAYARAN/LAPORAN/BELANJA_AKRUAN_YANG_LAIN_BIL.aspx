<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="BELANJA_AKRUAN_YANG_LAIN_BIL.aspx.vb" Inherits="SMKB_Web_Portal.BELANJA_AKRUAN_YANG_LAIN_BIL" %>
                ...
                <div>
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalCenterTitle">SENARAI PERBELANJAAN - BELANJA AKRUAN YANG LAIN  - JENIS :LAIN - LAIN BAYARAN (BIL / INVOIS)</h5>
                        </div> 
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            tbl = $("#tblDataSenarai_LejarPemiutangBil").DataTable({
                ...
                buttons: [
                    'csv', 'excel', {
                        ...
                        action: function (e, dt, button, config) {
                            window.open('<%=ResolveClientUrl("~/FORMS/PEMBAYARAN/LAPORAN/PrintReport/report_Belanja_Akruan_Yang_Lain_Bil.aspx")%>', '_blank');
                ...
                "ajax":
                {
                    "url": "LejarPemiutangWS.asmx/LoadOrderRecord_BelanjaAkaruanInvoisBil",
                    type: 'POST',
                    data: function (d) {
                        return "{ tahun: '" + $('#MainContent_FormContents_txtyear').val() + "', kod_kw4: '" + $('#MainContent_FormContents_kodkw').val() + "'}"
                    },
