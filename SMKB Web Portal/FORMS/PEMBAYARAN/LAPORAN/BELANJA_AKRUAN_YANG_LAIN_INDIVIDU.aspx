<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="BELANJA_AKRUAN_YANG_LAIN_INDIVIDU.aspx.vb" Inherits="SMKB_Web_Portal.BELANJA_AKRUAN_YANG_LAIN_INDIVIDU" %>
                ...
                <div>
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalCenterTitle">SENARAI PERBELANJAAN - BELANJA AKRUAN YANG LAIN  - JENIS :LAIN - LAIN BAYARAN (INDIVIDU) </h5>
                        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            tbl = $("#tblDataSenarai_LejarPemiutang").DataTable({
                ...
                buttons: [
                    'csv', 'excel', {
                        ...
                        action: function (e, dt, button, config) {
                            window.open('<%=ResolveClientUrl("~/FORMS/PEMBAYARAN/LAPORAN/PrintReport/report_Belanja_Akruan_Yang_Lain_individu.aspx")%>', '_blank');
                ...
                "ajax":
                {
                    "url": "LejarPemiutangWS.asmx/LoadOrderRecord_BelanjaAkaruanInvoisIndividu",
                    type: 'POST',
                    data: function (d) {
                        return "{ tahun: '" + $('#MainContent_FormContents_txtyear').val() + "', kod_kw5: '" + $('#MainContent_FormContents_kodkw').val() + "'}"
                    },
