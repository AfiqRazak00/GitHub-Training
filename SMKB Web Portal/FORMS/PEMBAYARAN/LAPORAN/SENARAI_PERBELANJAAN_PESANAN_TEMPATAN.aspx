<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="SENARAI_PERBELANJAAN_PESANAN_TEMPATAN.aspx.vb" Inherits="SMKB_Web_Portal.SENARAI_PERBELANJAAN_PESANAN_TEMPATAN" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            tbl = $("#tblDataSenarai_LejarPemiutangBil").DataTable({
                ...
                buttons: [
                    'csv', 'excel', {
                        ...
                        action: function (e, dt, button, config) {
                            window.open('<%=ResolveClientUrl("~/FORMS/PEMBAYARAN/LAPORAN/PrintReport/report_Senarai_Perbelajaan_Pesanan_Tempatan.aspx")%>', '_blank');
                ...
                "ajax":
                {
                    "url": "LejarPemiutangWS.asmx/LoadOrderRecord_PembayaranInvoisPesananTempatan",
                    type: 'POST',
                    data: function (d) {
                        return "{ tahun: '" + $('#MainContent_FormContents_txtyear').val() + "', kod_kw3: '" + $('#MainContent_FormContents_kodkw').val() + "'}"
                    },
