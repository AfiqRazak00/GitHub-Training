<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="report_Belanja_Akruan_Yang_Lain_individu.aspx.vb" Inherits="SMKB_Web_Portal.report_Belanja_Akruan_Yang_Lain_individu" %>
             ...
             $(document).ready(function () {
                 ...
                 tbl = $("#tblDataSenarai_LejarPemiutang").DataTable({
                     ...
                     paging:false,
                      "ajax":
                      {
                          "url": "<%=ResolveClientURL("~/FORMS/Pembayaran/LAPORAN/LejarPemiutangWS.asmx/LoadOrderRecord_BelanjaAkaruanInvoisIndividu")%>",
                          type: 'POST',
                          data: function (d) {
                              return "{ kod_kw5: '', tahun: ''}"
                          },
