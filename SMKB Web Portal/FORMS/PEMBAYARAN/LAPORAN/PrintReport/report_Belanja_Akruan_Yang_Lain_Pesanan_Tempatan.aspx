<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="report_Belanja_Akruan_Yang_Lain_Pesanan_Tempatan.aspx.vb" Inherits="SMKB_Web_Portal.report_Belanja_Akruan_Yang_Lain_Pesanan_Tempatan" %>
             ...
             <script type="text/javascript">
                 ...
                 $(document).ready(function () {
                     ...
                     tbl = $("#tblDataSenarai_LejarPemiutangPesananTempatan").DataTable({
                         ...
                         "ajax":
                         {
                             "url": "<%=ResolveClientURL("~/FORMS/Pembayaran/LAPORAN/LejarPemiutangWS.asmx/LoadOrderRecord_BelanjaAkaruanInvoisPesananTempatan")%>",
                             type: 'POST',
                             data: function (d) {
                                 return "{tahun: '', kod_kw6: ''}"
                             },
