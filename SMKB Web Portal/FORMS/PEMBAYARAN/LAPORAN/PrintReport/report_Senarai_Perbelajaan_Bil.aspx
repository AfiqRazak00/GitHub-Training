<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="report_Senarai_Perbelajaan_Bil.aspx.vb" Inherits="SMKB_Web_Portal.report_Senarai_Perbelajaan_Bil" %>
    ...
    <form id="form1" runat="server">
        <div id="masterdiv" class="container">
                    ...
                    <table style="width: 100%"> 
                        ...
                        <tr>
                            ...
                            <td style="text-align:center">
                                ...
                                <p class="pheader3"> JENIS :LAIN - LAIN BAYARAN (BIL / INVOIS) </p>
                            </td>
            ...
            <div  id="printreportcashflow">
               <table id="tblDataSenarai_LejarPemiutangBil" class="table table-custom" >
                          <thead>
             ...
             <script type="text/javascript">
                 ...
                 $(document).ready(function () {
                     ...
                     tbl = $("#tblDataSenarai_LejarPemiutangBil").DataTable({
                         ...
                         "ajax":
                         {
                             "url": "<%=ResolveClientURL("~/FORMS/Pembayaran/LAPORAN/LejarPemiutangWS.asmx/LoadOrderRecord_PembayaranInvoisBil")%>",
                             type: 'POST',
                             data: function (d) {
                                 return "{tahun: '', kod_kw2: ''}"
                             },
                         ...
                         "rowGroup": {
                             ...
                             startRender: function (rows, group) {
                                 var columnTitles = '<tr>' +
                                     ...
                                     '<th style="text-align:center;border-right:1px solid lightgrey;">JUMLAH PENERIMA(RM)</th>' +
                                     '<th style="text-align:center;border-right:1px solid lightgrey;">KW</th>' +
                                     '<th style="text-align:center;border-right:1px solid lightgrey;">PTj</th>' +
                                     '<th style="text-align:center;border-right:1px solid lightgrey;">KOD VOT</th>' +
                                     '<th style="text-align:center;border-right:1px solid lightgrey;">JUMLAH VOT(RM)</th>' +
