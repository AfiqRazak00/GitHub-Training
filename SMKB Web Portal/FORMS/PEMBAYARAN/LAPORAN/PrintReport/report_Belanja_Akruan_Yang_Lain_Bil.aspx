<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="report_Belanja_Akruan_Yang_Lain_Bil.aspx.vb" Inherits="SMKB_Web_Portal.report_Belanja_Akruan_Yang_Lain_Bil" %>
                    ...
                    <table style="width: 100%"> 
                        ...
                        <tr>
                            ...
                            <td style="text-align:center">
                                ...
                                <p class="pheader3">SENARAI PERBELANJAAN  -BELANJA AKRUAN YANG LAIN <asp:label runat="server" id="tahun"></asp:label></p>
             ...
             <script type="text/javascript">
                 ...
                 $(document).ready(function () {
                     ...
                     tbl = $("#tblDataSenarai_LejarPemiutangPesananTempatan").DataTable({
                         ...
                         "ajax":
                         {
                             "url": "<%=ResolveClientURL("~/FORMS/Pembayaran/LAPORAN/LejarPemiutangWS.asmx/LoadOrderRecord_BelanjaAkaruanInvoisBil")%>",
                             type: 'POST',
                             data: function (d) {
                                 return "{tahun: '', kod_kw4: ''}"
                             },
