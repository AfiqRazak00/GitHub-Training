...
<asp:Content ID="Content1" ContentPlaceHolderID="FormContents" runat="server">
    ...
    <style>
        ...
        #permohonan .modal-body {
            max-height: 70vh;
            Adjust height as needed to fit your layout min-height: 70vh;
            overflow-y: scroll;
    ...
    <contenttemplate>
        ...
        <div id="PermohonanTab" class="tabcontent" style="display: block">
            ...
            <div id="divpendaftaraninv" runat="server" visible="true">
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-3 inv-only">
                            <div class="form-group input-group">
                                <select class=" input-group__input ui search dropdown ddlKategoriPemiutang "
                                    name="ddlKategoriPemiutang" id="ddlKategoriPemiutang">
                                </select>
                                <label class="input-group__label">Kategori Pemiutang</label>
                            </div>
                        </div>
                        <div class="col-md-3 inv-only">
                            ...
                            <div class="form-group input-group">
                                ...
                                <label class="input-group__label">Pemiutang</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group input-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group input-group">
                                <select
                                    class=" input-group__input input-sm ui search dropdown"
                        ...
                        <div class="col-md-3">
                            <div class="form-group input-group">
                                <textarea id="txtTujuan" class="input-group__input"
                        ...
                        <div class="col-md-3 inv-only">
                            <div class="form-group input-group">
                                <input type="text"
                                    class="input-group__input input-sm "
                        ...
                        <div class="col-md-3">
                            <div class="form-group input-group">
                                <input type="text"
                                    class=" input-group__input  input-sm "
                                    placeholder="" id="txtidinv" name="txtidinv" disabled="disabled" />
                                    ...
                                    <table class="table table-striped" id="tblData" style="width: 100%;">
                                        <thead>
                                            <tr style="text-align: center">
                                                <th id="theadPenerima">Penerima</th>
                                                <th>COA</th>
                                                <th>Kod PTJ</th>
                                                <th>Kumpulan Wang</th>
                                                <th>Kod Operasi</th>
        ...
        <script type="text/javascript">
            ...
            function initDDLKategoriPemiutang() {
                $('#ddlKategoriPemiutang').dropdown({
                    selectOnKeydown: true,
                    fullTextSearch: true,
                    apiSettings: {
                        url: '<%= ResolveUrl("~/FORMS/PEMBAYARAN/Pembayaran_WS.asmx/getKategoriPemiutang") %>' + '?q={query}',
                        method: 'POST',
                        dataType: "json",
                        ...
                        onSuccess: function (response) {
                            ...
                            listOptions = listOptions.Payload;
                            ...
                            $.each(listOptions, function (index, option) {
                                console.log('hheerree', option)
                                $(objItem).append($('<div class="item" data-value="' + option.Kod_Detail + '">').html(option.Butiran));
                            });
            ...
            function initDDLPemiutang() {
                $("#ddlPemiutang").dropdown({
                    ...
                    fullTextSearch: true,
                    apiSettings: {
                        url: 'Transaksi_InvoisWS.asmx/GetPemiutangListByCategory',
                        method: 'POST',
                        dataType: "json",
                        contentType: 'application/json; charset=utf-8',
                        cache: false,
                        ...
                        beforeSend: function (settings) {
                            ...
                            settings.data = JSON.stringify({
                                ...
                                category: $('#ddlKategoriPemiutang').val()
                            });
                            //searchQuery = settings.urlData.query;
                            return settings;
                        },
            ...
            function addInvoisDetails(data = null) {
                ...
                if (data) {
                    ...
                    newData.Kadar_Harga = newData.Kadar_Harga
                    newData.Amaun_Dicukai = newData.Amaun_Dicukai
            ...
            function calculateHarga(row) {
                ...
                if (rowData.Amaun_Dicukai > 0) {
                    total_cukai = rowData.Amaun_Dicukai * amauncukai
                }
                ...
                calculateGrandTotalFromDT()
                return toNearest5Cents(totalPrice)
            }
            ...
            $(document).ready(function () {
                ...
                tblDetails = $("#tblData").on('draw.dt', async function () {
                    ...
                    "columns":
                        [
                            ...
                            },
                            {
                                "data": "Kadar_Harga",
                                render: function (data, type, row, meta) {
                                    return '   <input type="text"  style="text-align: right" class="form-control nospn underline-input multi price" placeholder="0" min="0" name="Kadar_Harga"   value="' + formatPrice(data) + '" />'
                                }
                            },
                            {
                                "data": "Amaun_Dicukai",
                                render: function (data, type, row, meta) {
                                    return '   <input type="text"  style="text-align: right" class="form-control nospn underline-input multi price" placeholder="0" min="0" name="Amaun_Dicukai"   value="' + formatPrice(data) + '" />'
                                }
                            },
                            {
                                "data": "Cukai",
                    ...
                    createdRow: function (row, data, dataIndex) {
                        //var fixedColumnend = $(row).find('.btnDelete');
                        //var fixedColumnstart = $(row).find('.col-ddl');
