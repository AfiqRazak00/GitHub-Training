...
Public Class PemiutangWS
    ...
    <WebMethod()>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Shared Function GetStaffList(ByVal q As String) As String
        Dim tmpDT As DataTable = GetStaff(q)
        Return JsonConvert.SerializeObject(tmpDT)
    End Function
    Public Shared Function GetStaff(kod As String) As DataTable
        Dim db = New DBSMConn
    ...
    Public Shared Function GeneratePemiutangID() As String
        Dim db As New DBKewConn
    ...
    End Function
    Public Shared Function UpdateNoAkhir(kodModul As String, prefix As String, year As String, ID As String)
        Dim db As New DBKewConn
    ...
    Public Shared Function InsertNoAkhir(kodModul As String, prefix As String, year As String, ID As String)
        Dim db As New DBKewConn
