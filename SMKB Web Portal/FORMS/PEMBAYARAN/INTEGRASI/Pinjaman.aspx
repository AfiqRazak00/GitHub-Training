<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="Pinjaman.aspx.vb" Inherits="SMKB_Web_Portal.Pinjaman" %>
    ...
    <contenttemplate>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            ...
                                            <label for="txtIDRujukan" class="input-group__label">No. Rujukan</label>
                                        </div>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                tbl = $("#tblSenaraiInvois").DataTable({
                    ...
                    columnDefs: [
                        ...
                        { targets: [5, 1], width: '20%' },
                        { targets: [0, 2, 3, 4, 6], width: '10%' }
                    ],
                    "columns": [
                        { "data": "No_Rujukan" },
                        { "data": "Nama_Pemiutang" },
                    ...
                    createdRow: function (row, data, dataIndex) {
                        row.dataset.jenisinvois = data["Kod"];
            ...
            function loadInvoisLists(dateStart, dateEnd) {
                ...
                show_loader()
                $.ajax({
                    url: '<%= ResolveUrl("~/FORMS/PEMBAYARAN/Baucar_WS.asmx/getIntegrationDrafBaucar_Pinjaman") %>',
                    method: "POST",
                    data: JSON.stringify({
                        DateStart: dateStart,
                        DateEnd: dateEnd
      ...
      <%--          "ajax": {
            ...
            function showModalBaucar(e) {
                ...
                let jenisinvois = target.dataset.jenisinvois
                
                $.ajax({
                    url: '<%= ResolveUrl("~/FORMS/PEMBAYARAN/Baucar_WS.asmx/getBaucarByIDRujukan_Integrasi") %>',
                    method: "GET",
                    dataType: "json",
                    data: {
                    ...
                    success: async function (data) {
                        ...
                        let idrujukan_ = idrujukan + '|' + jenisinvois
                        await loadInvoisHdr(idrujukan_)
            ...
            function loadInvoisHdr(idrujukan) {
                return new Promise(function (resolve, reject) {
                    ...
                    $.ajax({
                        url: '<%= ResolveUrl("~/FORMS/PEMBAYARAN/Invois_WS.asmx/getIntegrationHeader") %>',
                        method: "GET",
                        dataType: "json",
                        data: {
                            ID_Rujukan: '"' + idrujukan + '"'
            ...
            function loadBaucarDTLIntoModal(No_Baucar) {
                return new Promise(function (resolve, reject) {
                    ...
                    $.ajax({
                        url: '<%= ResolveUrl("~/FORMS/PEMBAYARAN/Baucar_WS.asmx/getBaucarDtl_Integrasi") %>',
                        method: "POST",
                        data: JSON.stringify({
                            No_Baucar: No_Baucar
                        }),
