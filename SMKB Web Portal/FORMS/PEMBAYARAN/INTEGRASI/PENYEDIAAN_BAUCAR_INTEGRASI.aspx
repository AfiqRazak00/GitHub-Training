<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NestedMasterPage2.master" CodeBehind="PENYEDIAAN_BAUCAR_INTEGRASI.aspx.vb" Inherits="SMKB_Web_Portal.PENYEDIAAN_BAUCAR_INTEGRASI" %>
    ...
    <contenttemplate>
        ...
        <script type="text/javascript">
            ...
            function loadInvoisLists(dateStart, dateEnd) {
                ...
                show_loader()
                $.ajax({
                    url: '<%= ResolveUrl("~/FORMS/PEMBAYARAN/Baucar_WS.asmx/getIntegrationDrafBaucar") %>',
                    method: "POST",
                    data: JSON.stringify({
                        DateStart: dateStart,
                        DateEnd: dateEnd
