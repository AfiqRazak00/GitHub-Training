...
#End Region
    ...
    Private Sub RunQuery(query As Object, param As List(Of SqlParameter), type As CommandType)
        Try
            Using mycon As New SqlConnection()
                mycon.ConnectionString = strConEqcas
                mycon.Open()
    ...
    Private Sub sInitializeConnStr()
        ...
        strDeDBSMPassword = clsCrypto.fDecrypt(strDBEQPassword)

        'syafiqah sila semak smula- pka
        'strDeDBSMPassword = "smkb*pwd"

        ConnectionString = "Server=" & strDbEQServer & ";Database=" & strDbEQName & ";Uid=" & strDBEQUser & ";Pwd=" & strDeDBSMPassword & ";Pooling=False;"
