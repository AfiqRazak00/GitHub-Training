...
Module dbSMKB
    ...
    Public strConEqcas As String = "Data Source=V-SQL14.utem.edu.my\sql_ins04;Initial Catalog=Eqcas;Persist Security Info=True;User ID=smkb;Password=smkb*pwd"
