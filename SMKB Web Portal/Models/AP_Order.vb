...
Public Class AP_Order
    ...
    Public Property details As List(Of AP_Order_Dtl)
    ...
    Public Function InsertCommand() As SqlCommand
        ...
        sql = "INSERT INTO AP_Order_Hdr (Kod_Transaksi,ID_Rujukan,No_Order,Kod_Korporat,Tkh_Transaksi"
        values = "(@Kod_Transaksi,@ID_Rujukan,@No_Order,@Kod_Korporat,getdate()"
