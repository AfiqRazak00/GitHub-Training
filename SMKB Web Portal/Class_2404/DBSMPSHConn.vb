...
#End Region
    ...
    Private Sub RunQuery(query As Object, param As List(Of SqlParameter), type As CommandType)
        Try
            Using mycon As New SqlConnection()
                mycon.ConnectionString = strConSMPSH
                mycon.Open()
    ...
    Private Sub sInitializeConnStr()
        ...
        ConnectionString = "Server=" & strDbSMServer & ";Database=" & strDbSMName & ";Uid=" & strDBSMUser & ";Pwd=" & strDeDBSMPassword & ";"
