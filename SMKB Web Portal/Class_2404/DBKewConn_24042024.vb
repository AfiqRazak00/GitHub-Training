...
#End Region
    ...
    Private Sub RunQuery(query As Object, param As List(Of SqlParameter), type As CommandType)
        Try
            Using mycon As New SqlConnection()
                ...
                'If dbcmd.ExecuteNonQuery().Equals(1) Then 'comment because want to update more than 1 row
                If type = 1 Then
    ...
    Private Sub sInitializeConnStr()
        ...
        ConnectionString = "Server=" & strDbServer & ";Database=" & strDbName & ";Uid=" & strDBUser & ";Pwd=" & strDeDBPassword & ";"
