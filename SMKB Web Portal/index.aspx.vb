...
Public Class index
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If Not Page.IsPostBack Then
                ...
                If dbconnNew.State = ConnectionState.Open Then
                    dbconnNew.Close()
                    dbconnNew.Dispose()
                    '---------------
                End If
    ...
    Protected Sub logoutLink_ServerClick(ByVal sender As Object, ByVal e As EventArgs) Handles logoutLink.ServerClick
        Try
            Session.Clear()
            Session.Abandon()
            ClientScript.RegisterStartupScript(Me.GetType(), "CloseWindowScript", "window.open('', '_self', ''); window.close();", True)
            'ClientScript.RegisterStartupScript(Me.GetType(), "CloseWindowScript", "window.close();", True)
            'Response.Redirect("https://devmis.utem.edu.my/iutem/Main")
        Catch ex As Exception
        End Try
    End Sub
